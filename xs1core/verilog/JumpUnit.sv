...
module JumpUnit(
  ...
  input  [40:0] io_in_bits_ctrl_predictInfo_target,
  ...
  JumpDataModule jumpDataModule (
    ...
    .io_pc      ({{23{io_in_bits_data_pc[40]}}, io_in_bits_data_pc}),
  ...
  assign io_out_bits_res_redirect_bits_cfiUpdate_isMisPred =
    _jumpDataModule_io_target[40:0] != io_in_bits_ctrl_predictInfo_target

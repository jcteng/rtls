  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_req_reg_tag = {_RANDOM[5'h0][31:25], _RANDOM[5'h1][8:0]};
        s1_req_reg_channel = _RANDOM[5'h1][11:9];
        s1_req_reg_opcode = _RANDOM[5'h1][14:12];
        s1_req_reg_param = _RANDOM[5'h1][17:15];
        s1_req_reg_size = _RANDOM[5'h1][20:18];
        s1_req_reg_way = _RANDOM[5'h1][24:21];
        s1_req_reg_off = _RANDOM[5'h1][30:25];
        s1_req_reg_useBypass = _RANDOM[5'h1][31];
        s1_req_reg_bufIdx = _RANDOM[5'h2][3:0];
        s1_req_reg_denied = _RANDOM[5'h2][4];
        s1_req_reg_sinkId = _RANDOM[5'h2][8:5];
        s1_req_reg_bypassPut = _RANDOM[5'h2][9];
        s1_req_reg_dirty = _RANDOM[5'h2][10];
        s1_req_reg_isHit = _RANDOM[5'h2][11];
        s1_counter = _RANDOM[5'h2][12];
        s2_req_sourceId = _RANDOM[5'h2][23:13];
        s2_req_set = {_RANDOM[5'h2][31:24], _RANDOM[5'h3][3:0]};
        s2_req_tag = _RANDOM[5'h3][19:4];
        s2_req_channel = _RANDOM[5'h3][22:20];
        s2_req_opcode = _RANDOM[5'h3][25:23];
        s2_req_param = _RANDOM[5'h3][28:26];
        s2_req_size = _RANDOM[5'h3][31:29];
        s2_req_way = _RANDOM[5'h4][3:0];
        s2_req_off = _RANDOM[5'h4][9:4];
        s2_req_useBypass = _RANDOM[5'h4][10];
        s2_req_bufIdx = _RANDOM[5'h4][14:11];
        s2_req_denied = _RANDOM[5'h4][15];
        s2_req_sinkId = _RANDOM[5'h4][19:16];
        s2_req_bypassPut = _RANDOM[5'h4][20];
        s2_req_dirty = _RANDOM[5'h4][21];
        s2_req_isHit = _RANDOM[5'h4][22];
        s2_needData = _RANDOM[5'h4][23];
        s2_beat = _RANDOM[5'h4][24];
        s2_last = _RANDOM[5'h4][25];
        s2_counter = _RANDOM[5'h4][26];
        s2_full = _RANDOM[5'h4][27];
        s2_need_pb = _RANDOM[5'h4][28];
        s2_need_d = _RANDOM[5'h4][29];
        s2_valid_pb = _RANDOM[5'h4][30];
        pbQueue_io_enq_valid_REG = _RANDOM[5'h4][31];
        s3_queue_io_enq_valid_REG = _RANDOM[5'h5][0];
        s3_queue_io_enq_valid_REG_1 = _RANDOM[5'h5][1];
        s3_queue_io_enq_valid_REG_2 = _RANDOM[5'h5][2];
        s3_queue_io_enq_valid_REG_3 = _RANDOM[5'h5][3];
        s3_queue_io_enq_valid_REG_4 = _RANDOM[5'h5][4];
        s4_req_set = _RANDOM[5'h5][27:16];
        s4_req_way = _RANDOM[5'h6][27:24];
        s4_req_sinkId = _RANDOM[5'h7][11:8];
        s4_rdata =
          {_RANDOM[5'h7][31:15],
           _RANDOM[5'h8],
           _RANDOM[5'h9],
        ...
        s4_pbdata_data =
          {_RANDOM[5'hF][31:15],
           ...
           _RANDOM[5'h16],
           _RANDOM[5'h17][14:0]};
        s4_pbdata_mask = {_RANDOM[5'h17][31:15], _RANDOM[5'h18][14:0]};
        s4_need_pb = _RANDOM[5'h18][16];
        s4_beat = _RANDOM[5'h18][17];
        s4_last = _RANDOM[5'h18][18];
        s4_full = _RANDOM[5'h18][19];
        beatsLeft = _RANDOM[5'h18][20];
        state_0 = _RANDOM[5'h18][21];
        state_1 = _RANDOM[5'h18][22];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        busy = 1'h0;
        s1_block_r = 1'h0;

...
module Queue1_MSHRRequest(
  ...
  assign io_deq_bits_tag = ram[50:35];
  assign io_deq_bits_off = ram[56:51];
  assign io_deq_bits_mask = ram[88:57];
  assign io_deq_bits_bufIdx = ram[92:89];
  assign io_deq_bits_needHint = ram[93];
  assign io_deq_bits_isPrefetch = ram[94];
  assign io_deq_bits_isBop = ram[95];
  assign io_deq_bits_preferCache = ram[96];
  assign io_deq_bits_dirty = ram[97];
  assign io_deq_bits_fromProbeHelper = ram[99];
  assign io_deq_bits_fromCmoHelper = ram[100];
  assign io_deq_bits_needProbeAckData = ram[101];
  assign io_deq_bits_reqSource = ram[105:102];
endmodule

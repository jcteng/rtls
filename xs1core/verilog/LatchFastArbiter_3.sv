  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        out_bits_reg_sourceId = _RANDOM[2'h0][11:1];
        out_bits_reg_set = _RANDOM[2'h0][23:12];
        out_bits_reg_tag = {_RANDOM[2'h0][31:24], _RANDOM[2'h1][7:0]};
        out_bits_reg_channel = _RANDOM[2'h1][10:8];
        out_bits_reg_opcode = _RANDOM[2'h1][13:11];
        out_bits_reg_param = _RANDOM[2'h1][16:14];
        out_bits_reg_size = _RANDOM[2'h1][19:17];
        out_bits_reg_way = _RANDOM[2'h1][23:20];
        out_bits_reg_off = _RANDOM[2'h1][29:24];
        out_bits_reg_useBypass = _RANDOM[2'h1][30];
        out_bits_reg_bufIdx = {_RANDOM[2'h1][31], _RANDOM[2'h2][2:0]};
        out_bits_reg_denied = _RANDOM[2'h2][3];
        out_bits_reg_sinkId = _RANDOM[2'h2][7:4];
        out_bits_reg_bypassPut = _RANDOM[2'h2][8];
        out_bits_reg_dirty = _RANDOM[2'h2][9];
        out_bits_reg_isHit = _RANDOM[2'h2][10];
        chosen_reg = _RANDOM[2'h2][24:11];
        pendingMask = {_RANDOM[2'h2][31:25], _RANDOM[2'h3][6:0]};
        rrGrantMask = _RANDOM[2'h3][20:7];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        out_valid_reg = 1'h0;
        out_bits_reg_sourceId = 11'h0;

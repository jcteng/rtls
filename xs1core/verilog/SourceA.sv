...
module SourceA(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s0_task_tag = _RANDOM[4'h0][17:2];
        s0_task_set = _RANDOM[4'h0][29:18];
        s0_task_off = {_RANDOM[4'h0][31:30], _RANDOM[4'h1][3:0]};
        s0_task_opcode = _RANDOM[4'h2][6:4];
        s0_task_param = _RANDOM[4'h2][9:7];
        s0_task_source = _RANDOM[4'h2][13:10];
        s0_task_bufIdx = _RANDOM[4'h2][17:14];
        s0_task_size = _RANDOM[4'h2][20:18];
        s0_count = _RANDOM[4'h2][27];
        s1_task_tag = {_RANDOM[4'h2][31:29], _RANDOM[4'h3][12:0]};
        s1_task_set = _RANDOM[4'h3][24:13];
        s1_task_off = _RANDOM[4'h3][30:25];
        s1_task_opcode = {_RANDOM[4'h4][31], _RANDOM[4'h5][1:0]};
        s1_task_param = _RANDOM[4'h5][4:2];
        s1_task_source = _RANDOM[4'h5][8:5];
        s1_task_size = _RANDOM[4'h5][15:13];
        s1_pb_latch_REG = _RANDOM[4'h5][22];
        s1_pb_latch_r_data =
          {_RANDOM[4'h5][31:23],
           _RANDOM[4'h6],
           _RANDOM[4'h7],
           ...
           _RANDOM[4'hC],
           _RANDOM[4'hD][22:0]};
        s1_pb_latch_r_mask = {_RANDOM[4'hD][31:23], _RANDOM[4'hE][22:0]};
        beatsLeft = _RANDOM[4'hE][24];
        state_0 = _RANDOM[4'hE][25];
        state_1 = _RANDOM[4'hE][26];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        busy = 1'h0;
        s1_full = 1'h0;
  ...
  assign io_a_bits_opcode =
    (muxState_0 ? s1_task_opcode : 3'h0) | (muxState_1 ? io_task_bits_opcode : 3'h0);
  ...
  assign io_a_bits_address =
    (muxState_0 ? {2'h0, s1_task_tag, s1_task_set, s1_task_off} : 36'h0)
    | (muxState_1 ? {2'h0, io_task_bits_tag, io_task_bits_set, 6'h0} : 36'h0);

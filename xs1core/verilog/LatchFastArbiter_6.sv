  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        out_bits_reg_way = _RANDOM[2'h1][14:11];
        out_bits_reg_bufIdx = _RANDOM[2'h1][24:21];
        out_bits_reg_opcode = _RANDOM[2'h1][27:25];
        out_bits_reg_param = _RANDOM[2'h1][30:28];
        out_bits_reg_source = {_RANDOM[2'h1][31], _RANDOM[2'h2][2:0]};
        out_bits_reg_save = _RANDOM[2'h2][3];
        out_bits_reg_drop = _RANDOM[2'h2][4];
        out_bits_reg_release = _RANDOM[2'h2][5];
        chosen_reg = _RANDOM[2'h2][20:7];
        pendingMask = {_RANDOM[2'h2][31:21], _RANDOM[2'h3][2:0]};
        rrGrantMask = _RANDOM[2'h3][16:3];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        out_valid_reg = 1'h0;
        out_bits_reg_set = 12'h0;

...
module Fence(
  ...
  output [40:0] io_out_bits_res_pc,
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uop_data_pc = {_RANDOM[5'h7][31:9], _RANDOM[5'h8][17:0]};
        io_fenceio_sfence_bits_addr_r =
          {_RANDOM[5'h1A][31:19], _RANDOM[5'h1B], _RANDOM[5'h1C][18:0]};
        io_fenceio_sfence_bits_id_r =
          {_RANDOM[5'h1C][31:19], _RANDOM[5'h1D], _RANDOM[5'h1E][18:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        state = 3'h0;
    end // initial

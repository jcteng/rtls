...
module TLXbar(
  ...
  wire        requestAIO_0_0 =
    {auto_in_a_bits_address[35:32], ~(auto_in_a_bits_address[31])} == 5'h0
    | {auto_in_a_bits_address[35:33], ~(auto_in_a_bits_address[32])} == 4'h0
    | {auto_in_a_bits_address[35:34], ~(auto_in_a_bits_address[33])} == 3'h0
    | {auto_in_a_bits_address[35], ~(auto_in_a_bits_address[34])} == 2'h0
    | auto_in_a_bits_address[35];
  wire        requestAIO_0_1 =
    auto_in_a_bits_address[35:29] == 7'h0
    | {auto_in_a_bits_address[35:30], auto_in_a_bits_address[29:28] ^ 2'h2} == 8'h0
    | {auto_in_a_bits_address[35:30], auto_in_a_bits_address[29:27] ^ 3'h6} == 9'h0
    | {auto_in_a_bits_address[35:31], ~(auto_in_a_bits_address[30])} == 6'h0;
  wire        requestAIO_0_2 =
    {auto_in_a_bits_address[35:30], auto_in_a_bits_address[29:16] ^ 14'h3800} == 20'h0;
  wire        requestAIO_0_3 =
    {auto_in_a_bits_address[35:30], ~(auto_in_a_bits_address[29:26])} == 10'h0;
  wire        requestAIO_0_4 =
    {auto_in_a_bits_address[35:30], auto_in_a_bits_address[29:12] ^ 18'h3A000} == 24'h0;
  wire        requestAIO_0_5 =
    {auto_in_a_bits_address[35:30], auto_in_a_bits_address[29:12] ^ 18'h38020} == 24'h0;
  wire        requestAIO_0_6 =
    {auto_in_a_bits_address[35:30], auto_in_a_bits_address[29:12] ^ 18'h38021} == 24'h0;
  wire        requestAIO_0_7 =
    {auto_in_a_bits_address[35:30], auto_in_a_bits_address[29:16] ^ 14'h3900} == 20'h0;
  reg  [2:0]  beatsLeft;
  ...
  assign auto_in_d_bits_opcode =
    ...
    | (muxState_5 ? auto_out_5_d_bits_opcode : 3'h0)
    | (muxState_6 ? auto_out_6_d_bits_opcode : 3'h0)
    | (muxState_7 ? auto_out_7_d_bits_opcode : 3'h0);

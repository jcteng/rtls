  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_in_r_uop_robIdx_flag = _RANDOM[6'h1F][3];
        s1_in_r_uop_robIdx_value = _RANDOM[6'h1F][11:4];
        s1_in_r_uop_lqIdx_flag = _RANDOM[6'h32][5];
        s1_in_r_uop_lqIdx_value = _RANDOM[6'h32][12:6];
        s1_in_r_uop_sqIdx_flag = _RANDOM[6'h32][13];
        s1_in_r_uop_sqIdx_value = _RANDOM[6'h32][19:14];
        s1_in_r_fof = _RANDOM[6'h32][27];
        s1_in_r_vdIdxInField = _RANDOM[6'h32][30:28];
        s1_in_r_preIsSplit = _RANDOM[6'h36][31];
        s1_in_r_alignedType = _RANDOM[6'h37][6:4];
        s1_in_r_indexVlMaxInVd = _RANDOM[6'h37][14:7];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        s1_valid = 1'h0;
    end // initial

...
module MSHR_64(
  ...
  output [17:0] io_tasks_client_tag_write_bits_tag,
  ...
  input  [17:0] io_dirResult_bits_clients_tag,
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_tag = _RANDOM[4'h1][18:3];
        req_off = _RANDOM[4'h1][24:19];
        req_mask = {_RANDOM[4'h1][31:25], _RANDOM[4'h2][24:0]};
        req_bufIdx = _RANDOM[4'h2][28:25];
        req_needHint = _RANDOM[4'h2][29];
        req_isPrefetch = _RANDOM[4'h2][30];
        req_isBop = _RANDOM[4'h2][31];
        req_preferCache = _RANDOM[4'h3][0];
        req_dirty = _RANDOM[4'h3][1];
        req_fromProbeHelper = _RANDOM[4'h3][3];
        req_fromCmoHelper = _RANDOM[4'h3][4];
        req_needProbeAckData = _RANDOM[4'h3][5];
        req_reqSource = _RANDOM[4'h3][9:6];
        req_valid = _RANDOM[4'h3][10];
        iam = _RANDOM[4'h3][12:11];
        meta_reg_self_dirty = _RANDOM[4'h3][29];
        meta_reg_self_state = _RANDOM[4'h3][31:30];
        meta_reg_self_clientStates_0 = _RANDOM[4'h4][1:0];
        meta_reg_self_prefetch = _RANDOM[4'h4][2];
        meta_reg_self_hit = _RANDOM[4'h4][3];
        meta_reg_self_way = _RANDOM[4'h4][7:4];
        meta_reg_self_tag = _RANDOM[4'h4][23:8];
        meta_reg_self_error = _RANDOM[4'h4][24];
        meta_reg_clients_states_0_state = _RANDOM[4'h4][26:25];
        meta_reg_clients_states_0_hit = _RANDOM[4'h4][27];
        meta_reg_clients_tag = {_RANDOM[4'h4][31:29], _RANDOM[4'h5][14:0]};
        meta_reg_clients_way = _RANDOM[4'h5][18:15];
        meta_reg_clients_error = _RANDOM[4'h5][19];
        meta_valid = _RANDOM[4'h6][21];
        promoteT_safe = _RANDOM[4'h6][23];
        gotT = _RANDOM[4'h6][24];
        a_do_release = _RANDOM[4'h6][26];
        a_do_probe = _RANDOM[4'h6][27];
        probe_dirty = _RANDOM[4'h6][28];
        highest_perm_reg_reg = _RANDOM[4'h6][31:30];
        inv_self_dir = _RANDOM[4'h7][1];
        client_probeack_param_vec_reg_0 = _RANDOM[4'h7][4:2];
        transmit_from_other_client_reg = _RANDOM[4'h7][5];
        releaseThrough = _RANDOM[4'h7][6];
        releaseDrop = _RANDOM[4'h7][7];
        probeAckDataThrough = _RANDOM[4'h7][8];
        probeAckDataDrop = _RANDOM[4'h7][9];
        probeAckDataSave = _RANDOM[4'h7][10];
        someClientHasProbeAckData = _RANDOM[4'h7][11];
        nested_c_hit_reg = _RANDOM[4'h7][12];
        sink = _RANDOM[4'h7][15:13];
        bad_grant = _RANDOM[4'h7][16];
        s_acquire = _RANDOM[4'h7][18];
        s_probe = _RANDOM[4'h7][19];
        s_release = _RANDOM[4'h7][20];
        s_probeack = _RANDOM[4'h7][21];
        s_execute = _RANDOM[4'h7][22];
        s_grantack = _RANDOM[4'h7][23];
        s_wbselfdir = _RANDOM[4'h7][24];
        s_wbselftag = _RANDOM[4'h7][25];
        s_wbclientsdir = _RANDOM[4'h7][26];
        s_wbclientstag = _RANDOM[4'h7][27];
        s_transferput = _RANDOM[4'h7][28];
        s_writerelease = _RANDOM[4'h7][29];
        s_writeprobe = _RANDOM[4'h7][30];
        s_triggerprefetch = _RANDOM[4'h7][31];
        s_prefetchack = _RANDOM[4'h8][0];
        w_probeackfirst = _RANDOM[4'h8][1];
        w_probeacklast = _RANDOM[4'h8][2];
        w_probeack = _RANDOM[4'h8][3];
        w_grantfirst = _RANDOM[4'h8][4];
        w_grantlast = _RANDOM[4'h8][5];
        w_grant = _RANDOM[4'h8][6];
        w_releaseack = _RANDOM[4'h8][7];
        w_grantack = _RANDOM[4'h8][8];
        w_putwritten = _RANDOM[4'h8][9];
        w_sinkcack = _RANDOM[4'h8][10];
        acquire_flag = _RANDOM[4'h8][11];
        nestC_save_flag = _RANDOM[4'h8][12];
        nestC_saveDirty_flag = _RANDOM[4'h8][13];
        bypassPut_latch_reg = _RANDOM[4'h8][14];
        client_dir_conflict = _RANDOM[4'h8][15];
        probe_helper_finish = _RANDOM[4'h8][16];
        probe_clients = _RANDOM[4'h8][18];
        io_tasks_sink_c_bits_bufIdx_r = _RANDOM[4'h8][22:19];
        no_schedule_REG = _RANDOM[4'h8][23];
        preferCache_latch = _RANDOM[4'h8][26];
        transmit_from_other_client_latch = _RANDOM[4'h8][27];
        a_c_through_reg = _RANDOM[4'h8][28];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        req_valid = 1'h0;
        meta_valid = 1'h0;

...
module SliceCtrl(
  ...
  output [17:0]  io_c_tag_w_bits_tag,
  ...
  input  [17:0]  io_dir_result_bits_clients_tag,
    ...
    if (data_wen & ~w_counter) begin
      ...
      if (io_dir_result_valid) begin
        if (req_reg_cmd == 8'h3)
          ...
          req_reg_data_0 <= {46'h0, io_dir_result_bits_clients_tag};
        else if (_GEN)
  ...
  assign io_c_tag_w_bits_tag = req_reg_tag[17:0];

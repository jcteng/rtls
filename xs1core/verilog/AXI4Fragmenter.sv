...
module AXI4Fragmenter(
  ...
  wire [35:0] _deq_q_1_io_deq_bits_addr;
  ...
  wire [35:0] _deq_q_io_deq_bits_addr;
  ...
  wire [35:0] addr = busy ? r_addr : _deq_q_io_deq_bits_addr;
  ...
  wire [35:0] _out_bits_addr_T = ~addr;
  ...
  wire [35:0] addr_1 = busy_1 ? r_addr_1 : _deq_q_1_io_deq_bits_addr;
  ...
  wire [35:0] _out_bits_addr_T_6 = ~addr_1;
  ...
  wire [35:0] _mux_addr_T_1 = ~_deq_q_io_deq_bits_addr;
  wire [8:0]  beats = {beats1, 1'h1} & {1'h1, ~beats1};
  wire [35:0] _inc_addr_T_1 =
    36'(addr + {20'h0, {7'h0, beats} << _deq_q_io_deq_bits_size});
  wire [22:0] _wrapMask_T_3 =
    {7'h0, _deq_q_1_io_deq_bits_len, 8'hFF} << _deq_q_1_io_deq_bits_size;
  wire [35:0] _mux_addr_T_6 = ~_deq_q_1_io_deq_bits_addr;
  wire [35:0] _inc_addr_T_3 =
    36'(addr_1 + {20'h0, {7'h0, w_beats} << _deq_q_1_io_deq_bits_size});
  always @(posedge clock) begin
    if (_GEN_1) begin
      if (fixed)
        ...
        r_addr <=
          {21'h0, _inc_addr_T_1[14:0] & _wrapMask_T_1[22:8]}
          | ~{_mux_addr_T_1[35:15], _mux_addr_T_1[14:0] | _wrapMask_T_1[22:8]};
      else
    ...
    if (_GEN_4) begin
      if (fixed_1)
        ...
        r_addr_1 <=
          {21'h0, _inc_addr_T_3[14:0] & _wrapMask_T_3[22:8]}
          | ~{_mux_addr_T_6[35:15], _mux_addr_T_6[14:0] | _wrapMask_T_3[22:8]};
      else
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        busy = _RANDOM[2'h0][0];
        r_addr = {_RANDOM[2'h0][31:1], _RANDOM[2'h1][4:0]};
        r_len = _RANDOM[2'h1][12:5];
        busy_1 = _RANDOM[2'h1][13];
        r_addr_1 = {_RANDOM[2'h1][31:14], _RANDOM[2'h2][17:0]};
        r_len_1 = _RANDOM[2'h2][25:18];
        wbeats_latched = _RANDOM[2'h2][26];
        w_counter = {_RANDOM[2'h2][31:27], _RANDOM[2'h3][3:0]};
        error_0 = _RANDOM[2'h3][5:4];
        error_1 = _RANDOM[2'h3][7:6];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        busy = 1'h0;
        busy_1 = 1'h0;
  ...
  assign auto_out_aw_bits_addr =
    ~{_out_bits_addr_T_6[35:5], _out_bits_addr_T_6[4:0] | ~(_out_bits_addr_T_7[4:0])};
  ...
  assign auto_out_ar_bits_addr =
    ~{_out_bits_addr_T[35:5], _out_bits_addr_T[4:0] | ~(_out_bits_addr_T_1[4:0])};

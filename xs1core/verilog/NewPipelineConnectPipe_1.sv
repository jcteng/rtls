  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_pc = {_RANDOM[4'h7][31:4], _RANDOM[4'h8][12:0]};
        data_preDecode_valid = _RANDOM[4'h8][13];
        data_preDecode_isRVC = _RANDOM[4'h8][14];
        data_preDecode_brType = _RANDOM[4'h8][16:15];
        data_preDecode_isCall = _RANDOM[4'h8][17];
        data_preDecode_isRet = _RANDOM[4'h8][18];
        data_ftqIdx_flag = _RANDOM[4'h8][19];
        data_ftqIdx_value = _RANDOM[4'h8][25:20];
        data_ftqOffset = _RANDOM[4'h8][29:26];
        data_predictInfo_target =
          {_RANDOM[4'h8][31:30], _RANDOM[4'h9], _RANDOM[4'hA][6:0]};
        data_predictInfo_taken = _RANDOM[4'hA][7];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial

...
module Queue1_AXI4BundleAW(
  ...
  assign io_deq_bits_addr = full ? ram[36:1] : io_enq_bits_addr;
  assign io_deq_bits_len = full ? ram[44:37] : io_enq_bits_len;
  assign io_deq_bits_size = full ? ram[47:45] : io_enq_bits_size;
  assign io_deq_bits_burst = full ? ram[49:48] : io_enq_bits_burst;
  assign io_deq_bits_echo_extra_id = full ? ram[74:62] : io_enq_bits_echo_extra_id;
endmodule

  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        out_bits_reg_clients = _RANDOM[2'h1][0];
        out_bits_reg_needData = _RANDOM[2'h1][1];
        chosen_reg = _RANDOM[2'h1][15:2];
        pendingMask = _RANDOM[2'h1][29:16];
        rrGrantMask = {_RANDOM[2'h1][31:30], _RANDOM[2'h2][11:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        out_valid_reg = 1'h0;
        out_bits_reg_set = 12'h0;

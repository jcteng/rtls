...
module SubDirectory(
  ...
  wire [17:0]       _tagArray_io_r_resp_data_0;
  wire [17:0]       _tagArray_io_r_resp_data_1;
  wire [17:0]       _tagArray_io_r_resp_data_2;
  wire [17:0]       _tagArray_io_r_resp_data_3;
  wire [17:0]       _tagArray_io_r_resp_data_4;
  wire [17:0]       _tagArray_io_r_resp_data_5;
  wire [17:0]       _tagArray_io_r_resp_data_6;
  wire [17:0]       _tagArray_io_r_resp_data_7;
  wire [17:0]       _tagArray_io_r_resp_data_8;
  wire [17:0]       _tagArray_io_r_resp_data_9;
  wire              _ClockGate_Q;
  ...
  wire [17:0]       _syndromeUInt_T = io_tag_w_bits_tag & 18'h2AD5B;
  wire [17:0]       _syndromeUInt_T_3 = io_tag_w_bits_tag & 18'h3366D;
  wire [17:0]       _syndromeUInt_T_6 = io_tag_w_bits_tag & 18'h3C78E;
  wire [17:0]       _syndromeUInt_T_9 = io_tag_w_bits_tag & 18'h7F0;
  wire [17:0]       _syndromeUInt_T_12 = io_tag_w_bits_tag & 18'h3F800;
  wire [5:0]        _GEN =
    {^{^_syndromeUInt_T_12,
       ^_syndromeUInt_T_9,
       ^_syndromeUInt_T_6,
  ...
  reg  [17:0]       tagAll_s2_0;
  reg  [17:0]       tagAll_s2_1;
  reg  [17:0]       tagAll_s2_2;
  reg  [17:0]       tagAll_s2_3;
  reg  [17:0]       tagAll_s2_4;
  reg  [17:0]       tagAll_s2_5;
  reg  [17:0]       tagAll_s2_6;
  reg  [17:0]       tagAll_s2_7;
  reg  [17:0]       tagAll_s2_8;
  reg  [17:0]       tagAll_s2_9;
  reg               errorAll_s2_0;
  reg               errorAll_s2_1;
  reg               errorAll_s2_2;
  reg               errorAll_s2_3;
      ...
      errorAll_s2_0 <=
        ...
        & (|{^({_eccArray_io_r_resp_data_0[4:0], _tagArray_io_r_resp_data_0}
             ...
             ^({_eccArray_io_r_resp_data_0[2:0], _tagArray_io_r_resp_data_0}
               & 21'h13C78E),
             ^({_eccArray_io_r_resp_data_0[1:0], _tagArray_io_r_resp_data_0} & 20'hB366D),
             ^({_eccArray_io_r_resp_data_0[0], _tagArray_io_r_resp_data_0} & 19'h6AD5B)});
      errorAll_s2_1 <=
        ...
        & (|{^({_eccArray_io_r_resp_data_1[4:0], _tagArray_io_r_resp_data_1}
             ...
             ^({_eccArray_io_r_resp_data_1[2:0], _tagArray_io_r_resp_data_1}
               & 21'h13C78E),
             ^({_eccArray_io_r_resp_data_1[1:0], _tagArray_io_r_resp_data_1} & 20'hB366D),
             ^({_eccArray_io_r_resp_data_1[0], _tagArray_io_r_resp_data_1} & 19'h6AD5B)});
      errorAll_s2_2 <=
        ...
        & (|{^({_eccArray_io_r_resp_data_2[4:0], _tagArray_io_r_resp_data_2}
             ...
             ^({_eccArray_io_r_resp_data_2[2:0], _tagArray_io_r_resp_data_2}
               & 21'h13C78E),
             ^({_eccArray_io_r_resp_data_2[1:0], _tagArray_io_r_resp_data_2} & 20'hB366D),
             ^({_eccArray_io_r_resp_data_2[0], _tagArray_io_r_resp_data_2} & 19'h6AD5B)});
      errorAll_s2_3 <=
        ...
        & (|{^({_eccArray_io_r_resp_data_3[4:0], _tagArray_io_r_resp_data_3}
             ...
             ^({_eccArray_io_r_resp_data_3[2:0], _tagArray_io_r_resp_data_3}
               & 21'h13C78E),
             ^({_eccArray_io_r_resp_data_3[1:0], _tagArray_io_r_resp_data_3} & 20'hB366D),
             ^({_eccArray_io_r_resp_data_3[0], _tagArray_io_r_resp_data_3} & 19'h6AD5B)});
      errorAll_s2_4 <=
        ...
        & (|{^({_eccArray_io_r_resp_data_4[4:0], _tagArray_io_r_resp_data_4}
             ...
             ^({_eccArray_io_r_resp_data_4[2:0], _tagArray_io_r_resp_data_4}
               & 21'h13C78E),
             ^({_eccArray_io_r_resp_data_4[1:0], _tagArray_io_r_resp_data_4} & 20'hB366D),
             ^({_eccArray_io_r_resp_data_4[0], _tagArray_io_r_resp_data_4} & 19'h6AD5B)});
      errorAll_s2_5 <=
        ...
        & (|{^({_eccArray_io_r_resp_data_5[4:0], _tagArray_io_r_resp_data_5}
             ...
             ^({_eccArray_io_r_resp_data_5[2:0], _tagArray_io_r_resp_data_5}
               & 21'h13C78E),
             ^({_eccArray_io_r_resp_data_5[1:0], _tagArray_io_r_resp_data_5} & 20'hB366D),
             ^({_eccArray_io_r_resp_data_5[0], _tagArray_io_r_resp_data_5} & 19'h6AD5B)});
      errorAll_s2_6 <=
        ...
        & (|{^({_eccArray_io_r_resp_data_6[4:0], _tagArray_io_r_resp_data_6}
             ...
             ^({_eccArray_io_r_resp_data_6[2:0], _tagArray_io_r_resp_data_6}
               & 21'h13C78E),
             ^({_eccArray_io_r_resp_data_6[1:0], _tagArray_io_r_resp_data_6} & 20'hB366D),
             ^({_eccArray_io_r_resp_data_6[0], _tagArray_io_r_resp_data_6} & 19'h6AD5B)});
      errorAll_s2_7 <=
        ...
        & (|{^({_eccArray_io_r_resp_data_7[4:0], _tagArray_io_r_resp_data_7}
             ...
             ^({_eccArray_io_r_resp_data_7[2:0], _tagArray_io_r_resp_data_7}
               & 21'h13C78E),
             ^({_eccArray_io_r_resp_data_7[1:0], _tagArray_io_r_resp_data_7} & 20'hB366D),
             ^({_eccArray_io_r_resp_data_7[0], _tagArray_io_r_resp_data_7} & 19'h6AD5B)});
      errorAll_s2_8 <=
        ...
        & (|{^({_eccArray_io_r_resp_data_8[4:0], _tagArray_io_r_resp_data_8}
             ...
             ^({_eccArray_io_r_resp_data_8[2:0], _tagArray_io_r_resp_data_8}
               & 21'h13C78E),
             ^({_eccArray_io_r_resp_data_8[1:0], _tagArray_io_r_resp_data_8} & 20'hB366D),
             ^({_eccArray_io_r_resp_data_8[0], _tagArray_io_r_resp_data_8} & 19'h6AD5B)});
      errorAll_s2_9 <=
        ...
        & (|{^({_eccArray_io_r_resp_data_9[4:0], _tagArray_io_r_resp_data_9}
             ...
             ^({_eccArray_io_r_resp_data_9[2:0], _tagArray_io_r_resp_data_9}
               & 21'h13C78E),
             ^({_eccArray_io_r_resp_data_9[1:0], _tagArray_io_r_resp_data_9} & 20'hB366D),
             ^({_eccArray_io_r_resp_data_9[0], _tagArray_io_r_resp_data_9} & 19'h6AD5B)});
    end
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        reqReg_tag = _RANDOM[4'h0][30:13];
        reqValidReg = _RANDOM[4'h1][24];
        reqValidReg_REG = _RANDOM[4'h1][25];
        hit_s2 = _RANDOM[4'h1][26];
        way_s2 = _RANDOM[4'h1][30:27];
        metaAll_s2_0_0_state = {_RANDOM[4'h1][31], _RANDOM[4'h2][0]};
        metaAll_s2_1_0_state = _RANDOM[4'h2][2:1];
        metaAll_s2_2_0_state = _RANDOM[4'h2][4:3];
        metaAll_s2_3_0_state = _RANDOM[4'h2][6:5];
        metaAll_s2_4_0_state = _RANDOM[4'h2][8:7];
        metaAll_s2_5_0_state = _RANDOM[4'h2][10:9];
        metaAll_s2_6_0_state = _RANDOM[4'h2][12:11];
        metaAll_s2_7_0_state = _RANDOM[4'h2][14:13];
        metaAll_s2_8_0_state = _RANDOM[4'h2][16:15];
        metaAll_s2_9_0_state = _RANDOM[4'h2][18:17];
        tagAll_s2_0 = {_RANDOM[4'h2][31:19], _RANDOM[4'h3][4:0]};
        tagAll_s2_1 = _RANDOM[4'h3][22:5];
        tagAll_s2_2 = {_RANDOM[4'h3][31:23], _RANDOM[4'h4][8:0]};
        tagAll_s2_3 = _RANDOM[4'h4][26:9];
        tagAll_s2_4 = {_RANDOM[4'h4][31:27], _RANDOM[4'h5][12:0]};
        tagAll_s2_5 = _RANDOM[4'h5][30:13];
        tagAll_s2_6 = {_RANDOM[4'h5][31], _RANDOM[4'h6][16:0]};
        tagAll_s2_7 = {_RANDOM[4'h6][31:17], _RANDOM[4'h7][2:0]};
        tagAll_s2_8 = _RANDOM[4'h7][20:3];
        tagAll_s2_9 = {_RANDOM[4'h7][31:21], _RANDOM[4'h8][6:0]};
        errorAll_s2_0 = _RANDOM[4'h8][7];
        errorAll_s2_1 = _RANDOM[4'h8][8];
        errorAll_s2_2 = _RANDOM[4'h8][9];
        errorAll_s2_3 = _RANDOM[4'h8][10];
        errorAll_s2_4 = _RANDOM[4'h8][11];
        errorAll_s2_5 = _RANDOM[4'h8][12];
        errorAll_s2_6 = _RANDOM[4'h8][13];
        errorAll_s2_7 = _RANDOM[4'h8][14];
        errorAll_s2_8 = _RANDOM[4'h8][15];
        errorAll_s2_9 = _RANDOM[4'h8][16];
        resetMask = _RANDOM[4'h8][17];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        resetFinish = 1'h0;
        resetIdx = 10'h3FF;

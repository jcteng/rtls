  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        queue_0_pfSource = _RANDOM[6'h1][13:10];
        queue_1_tag = _RANDOM[6'h1][31:14];
        queue_1_set = _RANDOM[6'h2][11:0];
        queue_1_pfSource = _RANDOM[6'h2][27:24];
        queue_2_tag = {_RANDOM[6'h2][31:28], _RANDOM[6'h3][13:0]};
        queue_2_set = _RANDOM[6'h3][25:14];
        queue_2_pfSource = _RANDOM[6'h4][9:6];
        queue_3_tag = _RANDOM[6'h4][27:10];
        queue_3_set = {_RANDOM[6'h4][31:28], _RANDOM[6'h5][7:0]};
        queue_3_pfSource = _RANDOM[6'h5][23:20];
        queue_4_tag = {_RANDOM[6'h5][31:24], _RANDOM[6'h6][9:0]};
        queue_4_set = _RANDOM[6'h6][21:10];
        queue_4_pfSource = _RANDOM[6'h7][5:2];
        queue_5_tag = _RANDOM[6'h7][23:6];
        queue_5_set = {_RANDOM[6'h7][31:24], _RANDOM[6'h8][3:0]};
        queue_5_pfSource = _RANDOM[6'h8][19:16];
        queue_6_tag = {_RANDOM[6'h8][31:20], _RANDOM[6'h9][5:0]};
        queue_6_set = _RANDOM[6'h9][17:6];
        queue_6_pfSource = {_RANDOM[6'h9][31:30], _RANDOM[6'hA][1:0]};
        queue_7_tag = _RANDOM[6'hA][19:2];
        queue_7_set = _RANDOM[6'hA][31:20];
        queue_7_pfSource = _RANDOM[6'hB][15:12];
        queue_8_tag = {_RANDOM[6'hB][31:16], _RANDOM[6'hC][1:0]};
        queue_8_set = _RANDOM[6'hC][13:2];
        queue_8_pfSource = _RANDOM[6'hC][29:26];
        queue_9_tag = {_RANDOM[6'hC][31:30], _RANDOM[6'hD][15:0]};
        queue_9_set = _RANDOM[6'hD][27:16];
        queue_9_pfSource = _RANDOM[6'hE][11:8];
        queue_10_tag = _RANDOM[6'hE][29:12];
        queue_10_set = {_RANDOM[6'hE][31:30], _RANDOM[6'hF][9:0]};
        queue_10_pfSource = _RANDOM[6'hF][25:22];
        queue_11_tag = {_RANDOM[6'hF][31:26], _RANDOM[6'h10][11:0]};
        queue_11_set = _RANDOM[6'h10][23:12];
        queue_11_pfSource = _RANDOM[6'h11][7:4];
        queue_12_tag = _RANDOM[6'h11][25:8];
        queue_12_set = {_RANDOM[6'h11][31:26], _RANDOM[6'h12][5:0]};
        queue_12_pfSource = _RANDOM[6'h12][21:18];
        queue_13_tag = {_RANDOM[6'h12][31:22], _RANDOM[6'h13][7:0]};
        queue_13_set = _RANDOM[6'h13][19:8];
        queue_13_pfSource = _RANDOM[6'h14][3:0];
        queue_14_tag = _RANDOM[6'h14][21:4];
        queue_14_set = {_RANDOM[6'h14][31:22], _RANDOM[6'h15][1:0]};
        queue_14_pfSource = _RANDOM[6'h15][17:14];
        queue_15_tag = {_RANDOM[6'h15][31:18], _RANDOM[6'h16][3:0]};
        queue_15_set = _RANDOM[6'h16][15:4];
        queue_15_pfSource = _RANDOM[6'h16][31:28];
        queue_16_tag = _RANDOM[6'h17][17:0];
        queue_16_set = _RANDOM[6'h17][29:18];
        queue_16_pfSource = _RANDOM[6'h18][13:10];
        queue_17_tag = _RANDOM[6'h18][31:14];
        queue_17_set = _RANDOM[6'h19][11:0];
        queue_17_pfSource = _RANDOM[6'h19][27:24];
        queue_18_tag = {_RANDOM[6'h19][31:28], _RANDOM[6'h1A][13:0]};
        queue_18_set = _RANDOM[6'h1A][25:14];
        queue_18_pfSource = _RANDOM[6'h1B][9:6];
        queue_19_tag = _RANDOM[6'h1B][27:10];
        queue_19_set = {_RANDOM[6'h1B][31:28], _RANDOM[6'h1C][7:0]};
        queue_19_pfSource = _RANDOM[6'h1C][23:20];
        queue_20_tag = {_RANDOM[6'h1C][31:24], _RANDOM[6'h1D][9:0]};
        queue_20_set = _RANDOM[6'h1D][21:10];
        queue_20_pfSource = _RANDOM[6'h1E][5:2];
        queue_21_tag = _RANDOM[6'h1E][23:6];
        queue_21_set = {_RANDOM[6'h1E][31:24], _RANDOM[6'h1F][3:0]};
        queue_21_pfSource = _RANDOM[6'h1F][19:16];
        queue_22_tag = {_RANDOM[6'h1F][31:20], _RANDOM[6'h20][5:0]};
        queue_22_set = _RANDOM[6'h20][17:6];
        queue_22_pfSource = {_RANDOM[6'h20][31:30], _RANDOM[6'h21][1:0]};
        queue_23_tag = _RANDOM[6'h21][19:2];
        queue_23_set = _RANDOM[6'h21][31:20];
        queue_23_pfSource = _RANDOM[6'h22][15:12];
        queue_24_tag = {_RANDOM[6'h22][31:16], _RANDOM[6'h23][1:0]};
        queue_24_set = _RANDOM[6'h23][13:2];
        queue_24_pfSource = _RANDOM[6'h23][29:26];
        queue_25_tag = {_RANDOM[6'h23][31:30], _RANDOM[6'h24][15:0]};
        queue_25_set = _RANDOM[6'h24][27:16];
        queue_25_pfSource = _RANDOM[6'h25][11:8];
        queue_26_tag = _RANDOM[6'h25][29:12];
        queue_26_set = {_RANDOM[6'h25][31:30], _RANDOM[6'h26][9:0]};
        queue_26_pfSource = _RANDOM[6'h26][25:22];
        queue_27_tag = {_RANDOM[6'h26][31:26], _RANDOM[6'h27][11:0]};
        queue_27_set = _RANDOM[6'h27][23:12];
        queue_27_pfSource = _RANDOM[6'h28][7:4];
        queue_28_tag = _RANDOM[6'h28][25:8];
        queue_28_set = {_RANDOM[6'h28][31:26], _RANDOM[6'h29][5:0]};
        queue_28_pfSource = _RANDOM[6'h29][21:18];
        queue_29_tag = {_RANDOM[6'h29][31:22], _RANDOM[6'h2A][7:0]};
        queue_29_set = _RANDOM[6'h2A][19:8];
        queue_29_pfSource = _RANDOM[6'h2B][3:0];
        queue_30_tag = _RANDOM[6'h2B][21:4];
        queue_30_set = {_RANDOM[6'h2B][31:22], _RANDOM[6'h2C][1:0]};
        queue_30_pfSource = _RANDOM[6'h2C][17:14];
        queue_31_tag = {_RANDOM[6'h2C][31:18], _RANDOM[6'h2D][3:0]};
        queue_31_set = _RANDOM[6'h2D][15:4];
        queue_31_pfSource = _RANDOM[6'h2D][31:28];
        valids_31 = _RANDOM[6'h2E][31];
        head = _RANDOM[6'h2F][4:0];
        tail = _RANDOM[6'h2F][9:5];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        queue_0_tag = 18'h0;
        queue_0_set = 12'h0;

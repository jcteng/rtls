...
module EnqEntry_6(
  ...
  wire        enqDelay1WakeupRC_1 =
    (enqDelaySrcWakeUpL1ExuOH_1_0 | enqDelaySrcWakeUpL1ExuOH_1_2
     | enqDelaySrcWakeUpL1ExuOH_1_4 | enqDelaySrcWakeUpL1ExuOH_1_6
     | enqDelaySrcWakeUpL1ExuOH_1_21 | enqDelaySrcWakeUpL1ExuOH_1_22
     | enqDelaySrcWakeUpL1ExuOH_1_23) & entryReg_status_srcStatus_1_srcType[0];
  wire [4:0]  enqDelay1WakeupRCIdx_1 =
    (enqDelaySrcWakeUpL1ExuOH_1_0 ? io_enqDelayIn1_wakeUpFromIQ_0_bits_rcDest : 5'h0)
    | (enqDelaySrcWakeUpL1ExuOH_1_2 ? io_enqDelayIn1_wakeUpFromIQ_1_bits_rcDest : 5'h0)
    | (enqDelaySrcWakeUpL1ExuOH_1_4 ? io_enqDelayIn1_wakeUpFromIQ_2_bits_rcDest : 5'h0)
    | (enqDelaySrcWakeUpL1ExuOH_1_6 ? io_enqDelayIn1_wakeUpFromIQ_3_bits_rcDest : 5'h0)
    | (enqDelaySrcWakeUpL1ExuOH_1_21 ? io_enqDelayIn1_wakeUpFromIQ_4_bits_rcDest : 5'h0)
    | (enqDelaySrcWakeUpL1ExuOH_1_22 ? io_enqDelayIn1_wakeUpFromIQ_5_bits_rcDest : 5'h0)
    | (enqDelaySrcWakeUpL1ExuOH_1_23 ? io_enqDelayIn1_wakeUpFromIQ_6_bits_rcDest : 5'h0);
  ...
  wire        currentStatus_srcStatus_1_useRegCache =
    enqDelayValidReg_last_REG
      ? ~enqDelayOut1_srcCancelByLoad_1
        & (enqDelay1WakeupRC_1
           | ~(io_enqDelayIn1_wakeUpFromIQ_0_bits_rfWen
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        entryReg_status_srcStatus_1_psrc = _RANDOM[6'h3][13:6];
        entryReg_status_srcStatus_1_srcType = _RANDOM[6'h3][17:14];
        entryReg_status_srcStatus_1_srcState = _RANDOM[6'h3][18];
        entryReg_status_srcStatus_1_dataSources_value = _RANDOM[6'h3][22:19];
        entryReg_status_srcStatus_1_srcLoadDependency_0 = _RANDOM[6'h3][24:23];
        entryReg_status_srcStatus_1_srcLoadDependency_1 = _RANDOM[6'h3][26:25];
        entryReg_status_srcStatus_1_srcLoadDependency_2 = _RANDOM[6'h3][28:27];
        entryReg_status_srcStatus_1_srcWakeUpL1ExuOH_0 = _RANDOM[6'h3][29];
        entryReg_status_srcStatus_1_srcWakeUpL1ExuOH_2 = _RANDOM[6'h3][31];
        entryReg_status_srcStatus_1_srcWakeUpL1ExuOH_4 = _RANDOM[6'h4][1];
        entryReg_status_srcStatus_1_srcWakeUpL1ExuOH_6 = _RANDOM[6'h4][3];
        entryReg_status_srcStatus_1_srcWakeUpL1ExuOH_21 = _RANDOM[6'h4][18];
        entryReg_status_srcStatus_1_srcWakeUpL1ExuOH_22 = _RANDOM[6'h4][19];
        entryReg_status_srcStatus_1_srcWakeUpL1ExuOH_23 = _RANDOM[6'h4][20];
        entryReg_status_srcStatus_1_useRegCache = _RANDOM[6'h4][25];
        entryReg_status_srcStatus_1_regCacheIdx = _RANDOM[6'h4][30:26];
        entryReg_status_issued = _RANDOM[6'h5][0];
        entryReg_status_issueTimer = _RANDOM[6'h5][3:2];
        entryReg_status_deqPortIdx = _RANDOM[6'h5][4];
        entryReg_imm = {_RANDOM[6'h5][31:5], _RANDOM[6'h6][4:0]};
        entryReg_payload_preDecodeInfo_valid = _RANDOM[6'hA][1];
        entryReg_payload_preDecodeInfo_isRVC = _RANDOM[6'hA][2];
        entryReg_payload_preDecodeInfo_brType = _RANDOM[6'hA][4:3];
        entryReg_payload_preDecodeInfo_isCall = _RANDOM[6'hA][5];
        entryReg_payload_preDecodeInfo_isRet = _RANDOM[6'hA][6];
        entryReg_payload_ftqPtr_flag = _RANDOM[6'hA][9];
        entryReg_payload_ftqPtr_value = _RANDOM[6'hA][15:10];
        entryReg_payload_ftqOffset = _RANDOM[6'hA][19:16];
        entryReg_payload_fuOpType = _RANDOM[6'hC][25:17];
        entryReg_payload_rfWen = _RANDOM[6'hC][26];
        entryReg_payload_flushPipe = _RANDOM[6'hD][2];
        entryReg_payload_selImm = _RANDOM[6'hD][7:4];
        entryReg_payload_pdest = _RANDOM[6'h18][13:6];
        enqDelayValidReg_last_REG = _RANDOM[6'h2C][18];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        validReg_last_REG = 1'h0;
        enqDelayValidReg_last_REG = 1'h0;
  ...
  assign io_commonOut_srcWakeUpL1ExuOH_0_0 =
    (|_GEN_13) ? wakeupVec_0_0 : currentStatus_srcStatus_0_srcWakeUpL1ExuOH_0;
  assign io_commonOut_srcWakeUpL1ExuOH_0_2 =
    (|_GEN_13) ? wakeupVec_0_1 : currentStatus_srcStatus_0_srcWakeUpL1ExuOH_2;
  assign io_commonOut_srcWakeUpL1ExuOH_0_4 =
    (|_GEN_13) ? wakeupVec_0_2 : currentStatus_srcStatus_0_srcWakeUpL1ExuOH_4;
  assign io_commonOut_srcWakeUpL1ExuOH_0_6 =
    (|_GEN_13) ? wakeupVec_0_3 : currentStatus_srcStatus_0_srcWakeUpL1ExuOH_6;
  assign io_commonOut_srcWakeUpL1ExuOH_0_21 =
    (|_GEN_13) ? wakeupVec_0_4 : currentStatus_srcStatus_0_srcWakeUpL1ExuOH_21;
  assign io_commonOut_srcWakeUpL1ExuOH_0_22 =
    (|_GEN_13) ? wakeupVec_0_5 : currentStatus_srcStatus_0_srcWakeUpL1ExuOH_22;
  assign io_commonOut_srcWakeUpL1ExuOH_0_23 =
    (|_GEN_13) ? wakeupVec_0_6 : currentStatus_srcStatus_0_srcWakeUpL1ExuOH_23;
  assign io_commonOut_srcWakeUpL1ExuOH_1_0 =
    (|_GEN_14) ? wakeupVec_1_0 : currentStatus_srcStatus_1_srcWakeUpL1ExuOH_0;
  assign io_commonOut_srcWakeUpL1ExuOH_1_2 =
    (|_GEN_14) ? wakeupVec_1_1 : currentStatus_srcStatus_1_srcWakeUpL1ExuOH_2;
  assign io_commonOut_srcWakeUpL1ExuOH_1_4 =
    (|_GEN_14) ? wakeupVec_1_2 : currentStatus_srcStatus_1_srcWakeUpL1ExuOH_4;
  assign io_commonOut_srcWakeUpL1ExuOH_1_6 =
    (|_GEN_14) ? wakeupVec_1_3 : currentStatus_srcStatus_1_srcWakeUpL1ExuOH_6;
  assign io_commonOut_srcWakeUpL1ExuOH_1_21 =
    (|_GEN_14) ? wakeupVec_1_4 : currentStatus_srcStatus_1_srcWakeUpL1ExuOH_21;
  assign io_commonOut_srcWakeUpL1ExuOH_1_22 =
    (|_GEN_14) ? wakeupVec_1_5 : currentStatus_srcStatus_1_srcWakeUpL1ExuOH_22;
  assign io_commonOut_srcWakeUpL1ExuOH_1_23 =
    (|_GEN_14) ? wakeupVec_1_6 : currentStatus_srcStatus_1_srcWakeUpL1ExuOH_23;
  ...
  assign io_commonOut_transEntry_bits_status_srcStatus_0_srcLoadDependency_0 =
    (|_wakeupByIQ_T) ? _GEN_7 : common_srcLoadDependencyNext_0_0;
  assign io_commonOut_transEntry_bits_status_srcStatus_0_srcLoadDependency_1 =
    (|_wakeupByIQ_T) ? _GEN_8 : common_srcLoadDependencyNext_0_1;
  assign io_commonOut_transEntry_bits_status_srcStatus_0_srcLoadDependency_2 =
    (|_wakeupByIQ_T) ? _GEN_9 : common_srcLoadDependencyNext_0_2;
  ...
  assign io_commonOut_transEntry_bits_status_srcStatus_1_srcLoadDependency_0 =
    (|_wakeupByIQ_T_1) ? _GEN_10 : common_srcLoadDependencyNext_1_0;
  assign io_commonOut_transEntry_bits_status_srcStatus_1_srcLoadDependency_1 =
    (|_wakeupByIQ_T_1) ? _GEN_11 : common_srcLoadDependencyNext_1_1;
  assign io_commonOut_transEntry_bits_status_srcStatus_1_srcLoadDependency_2 =
    (|_wakeupByIQ_T_1) ? _GEN_12 : common_srcLoadDependencyNext_1_2;

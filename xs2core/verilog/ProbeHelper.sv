...
module ProbeHelper(
  ...
  input  [11:0] io_dirResult_bits_sourceId,
  ...
  output [11:0] io_probe_bits_source,
  ...
  Queue5_MSHRRequest queue (
    ...
    .io_enq_bits_set
      ({io_dirResult_bits_clients_tag[0], io_dirResult_bits_set[10:0]}),
    .io_enq_bits_tag              (io_dirResult_bits_clients_tag[16:1]),

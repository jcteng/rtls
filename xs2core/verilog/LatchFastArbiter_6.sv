  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        out_bits_reg_way = _RANDOM[2'h1][15:12];
        out_bits_reg_bufIdx = _RANDOM[2'h1][25:22];
        out_bits_reg_opcode = _RANDOM[2'h1][28:26];
        out_bits_reg_param = _RANDOM[2'h1][31:29];
        out_bits_reg_source = _RANDOM[2'h2][3:0];
        out_bits_reg_save = _RANDOM[2'h2][4];
        out_bits_reg_drop = _RANDOM[2'h2][5];
        out_bits_reg_release = _RANDOM[2'h2][6];
        chosen_reg = _RANDOM[2'h2][21:8];
        pendingMask = {_RANDOM[2'h2][31:22], _RANDOM[2'h3][3:0]};
        rrGrantMask = _RANDOM[2'h3][17:4];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        out_valid_reg = 1'h0;
        out_bits_reg_set = 12'h0;

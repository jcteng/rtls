...
module AsyncQueueSink_2(
  ...
  reg         valid_reg;
  wire [16:0] _io_deq_bits_deq_bits_reg_io_q;
  ...
  ClockCrossingReg_w17 io_deq_bits_deq_bits_reg (
    .clock (clock),
    .io_d
  ...
  assign io_deq_bits_resumereq = _io_deq_bits_deq_bits_reg_io_q[16];
  assign io_deq_bits_hartsel = _io_deq_bits_deq_bits_reg_io_q[15:6];
  assign io_deq_bits_ackhavereset = _io_deq_bits_deq_bits_reg_io_q[5];
  assign io_deq_bits_hasel = _io_deq_bits_deq_bits_reg_io_q[4];
  assign io_deq_bits_hamask_0 = _io_deq_bits_deq_bits_reg_io_q[2];
  assign io_deq_bits_hamask_1 = _io_deq_bits_deq_bits_reg_io_q[3];

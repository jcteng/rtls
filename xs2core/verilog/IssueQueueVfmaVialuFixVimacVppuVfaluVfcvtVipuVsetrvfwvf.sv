...
module IssueQueueVfmaVialuFixVimacVppuVfaluVfcvtVipuVsetrvfwvf(
  ...
  always @(posedge clock) begin
    ...
    io_deqDelay_1_bits_REG_common_imm <= {17'h0, _entries_io_deqEntry_1_bits_imm};
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        io_deqDelay_1_bits_REG_immType = _RANDOM[7'h3D][18:15];
        ...
        io_deqDelay_1_bits_REG_common_imm = {_RANDOM[7'h52][31], _RANDOM[7'h53][30:0]};
        ...
        io_deqDelay_1_bits_REG_common_rfWen = _RANDOM[7'h54][21];
        io_deqDelay_1_bits_REG_common_fpWen = _RANDOM[7'h54][22];
        io_deqDelay_1_bits_REG_common_vecWen = _RANDOM[7'h54][23];
        io_deqDelay_1_bits_REG_common_v0Wen = _RANDOM[7'h54][24];
        io_deqDelay_1_bits_REG_common_vlWen = _RANDOM[7'h54][25];
        io_deqDelay_1_bits_REG_common_fpu_wflags = _RANDOM[7'h54][30];
        io_deqDelay_1_bits_REG_common_vpu_vma = _RANDOM[7'h55][14];
        io_deqDelay_1_bits_REG_common_vpu_vta = _RANDOM[7'h55][15];
        io_deqDelay_1_bits_REG_common_vpu_vsew = _RANDOM[7'h55][17:16];
        io_deqDelay_1_bits_REG_common_vpu_vlmul = _RANDOM[7'h55][20:18];
        io_deqDelay_1_bits_REG_common_vpu_vm = _RANDOM[7'h55][29];
        io_deqDelay_1_bits_REG_common_vpu_vstart =
          {_RANDOM[7'h55][31:30], _RANDOM[7'h56][5:0]};
        io_deqDelay_1_bits_REG_common_vpu_fpu_isFoldTo1_2 = _RANDOM[7'h56][13];
        io_deqDelay_1_bits_REG_common_vpu_fpu_isFoldTo1_4 = _RANDOM[7'h56][14];
        io_deqDelay_1_bits_REG_common_vpu_fpu_isFoldTo1_8 = _RANDOM[7'h56][15];
        io_deqDelay_1_bits_REG_common_vpu_vuopIdx = _RANDOM[7'h56][24:18];
        io_deqDelay_1_bits_REG_common_vpu_lastUop = _RANDOM[7'h56][25];
        io_deqDelay_1_bits_REG_common_vpu_isNarrow = _RANDOM[7'h5B][9];
        io_deqDelay_1_bits_REG_common_vpu_isDstMask = _RANDOM[7'h5B][10];
        io_deqDelay_1_bits_REG_common_dataSources_0_value = _RANDOM[7'h5B][18:15];
        io_deqDelay_1_bits_REG_common_dataSources_1_value = _RANDOM[7'h5B][22:19];
        io_deqDelay_1_bits_REG_common_dataSources_2_value = _RANDOM[7'h5B][26:23];
        io_deqDelay_1_bits_REG_common_dataSources_3_value = _RANDOM[7'h5B][30:27];
        io_deqDelay_1_bits_REG_common_dataSources_4_value =
          {_RANDOM[7'h5B][31], _RANDOM[7'h5C][2:0]};
      `endif // RANDOMIZE_REG_INIT
    end // initial

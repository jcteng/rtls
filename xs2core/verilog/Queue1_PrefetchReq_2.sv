...
module Queue1_PrefetchReq_2(
  ...
  always @(posedge clock) begin
    if (do_enq)
      ram <= {io_enq_bits_pfSource, 13'h0, io_enq_bits_set, io_enq_bits_tag};
  end // always @(posedge)
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = {_RANDOM[1'h0][31:1], _RANDOM[1'h1][15:0]};
        full = _RANDOM[1'h0][0];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        full = 1'h0;
  ...
  assign io_deq_bits_tag = ram[17:0];
  assign io_deq_bits_set = ram[29:18];
  assign io_deq_bits_needT = ram[30];
  assign io_deq_bits_source = ram[42:31];
  assign io_deq_bits_pfSource = ram[46:43];
endmodule

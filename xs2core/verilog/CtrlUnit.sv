...
module CtrlUnit(
  ...
  input  [3:0]  auto_ctl_in_a_bits_source,
  ...
  output [3:0]  auto_ctl_in_d_bits_source,
  ...
  wire         _out_out_bits_data_T_18 = out_oindex == 7'h0;
  wire         io_ecc_ready_0 = ecc_code == 64'h0;
  wire         out_f_wivalid_19 =
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (out_f_wivalid_19 & ~cmd_in_valid)
      ...
      cmd_in_valid <= out_f_wivalid_19 | ~io_req_ready & cmd_in_valid;
      cmd_out_valid <=
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        cmd_in_valid = _RANDOM[6'h22][0];
        cmd_out_valid = _RANDOM[6'h22][1];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        ctl_tag = 64'h0;
        ctl_set = 64'h0;
  ...
  assign auto_ctl_in_d_bits_data =
    (_out_out_bits_data_T_18 | out_oindex == 7'h10 | out_oindex == 7'h11
     ...
     | out_oindex == 7'h20 | out_oindex == 7'h40 | out_oindex == 7'h41) & (|_GEN_0)
      ? 64'h0
      : _out_out_bits_data_T_18
          ? 64'hA0C1004
          : out_oindex == 7'h10
              ? ctl_tag
              : out_oindex == 7'h11

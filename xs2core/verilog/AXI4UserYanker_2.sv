...
module AXI4UserYanker_2(
  ...
  Queue1_BundleMap_128 Queue1_BundleMap_5 (
    ...
    .io_enq_valid                (_GEN_3 & auto_in_ar_bits_id == 4'h5),
    .io_enq_bits_tl_state_size   (auto_in_ar_bits_echo_tl_state_size),
    .io_enq_bits_tl_state_source (auto_in_ar_bits_echo_tl_state_source),
    .io_deq_ready
      (_GEN_2 & auto_out_r_bits_id == 4'h5 & auto_out_r_bits_last),
  ...
  Queue1_BundleMap_128 Queue1_BundleMap_6 (
    ...
    .io_enq_valid                (_GEN_3 & auto_in_ar_bits_id == 4'h6),
    .io_enq_bits_tl_state_size   (auto_in_ar_bits_echo_tl_state_size),
    .io_enq_bits_tl_state_source (auto_in_ar_bits_echo_tl_state_source),
    .io_deq_ready
      (_GEN_2 & auto_out_r_bits_id == 4'h6 & auto_out_r_bits_last),
  ...
  Queue1_BundleMap_128 Queue1_BundleMap_7 (
    ...
    .io_enq_valid                (_GEN_3 & auto_in_ar_bits_id == 4'h7),
    .io_enq_bits_tl_state_size   (auto_in_ar_bits_echo_tl_state_size),
    .io_enq_bits_tl_state_source (auto_in_ar_bits_echo_tl_state_source),
    .io_deq_ready
      (_GEN_2 & auto_out_r_bits_id == 4'h7 & auto_out_r_bits_last),
  ...
  Queue1_BundleMap_128 Queue1_BundleMap_8 (
    ...
    .io_enq_valid                (_GEN_3 & auto_in_ar_bits_id == 4'h8),
    .io_enq_bits_tl_state_size   (auto_in_ar_bits_echo_tl_state_size),
    .io_enq_bits_tl_state_source (auto_in_ar_bits_echo_tl_state_source),
    .io_deq_ready
      (_GEN_2 & auto_out_r_bits_id == 4'h8 & auto_out_r_bits_last),
  ...
  Queue1_BundleMap_128 Queue1_BundleMap_9 (
    ...
    .io_enq_valid                (_GEN_3 & auto_in_ar_bits_id == 4'h9),
    .io_enq_bits_tl_state_size   (auto_in_ar_bits_echo_tl_state_size),
    .io_enq_bits_tl_state_source (auto_in_ar_bits_echo_tl_state_source),
    .io_deq_ready
      (_GEN_2 & auto_out_r_bits_id == 4'h9 & auto_out_r_bits_last),

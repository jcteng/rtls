...
module TLCacheCork(
  ...
  reg          d_first_counter;
  wire         d_grant = _in_d_bits_T_39 == 3'h5 | _in_d_bits_T_39 == 3'h4;
  ...
  wire [2:0]   d_d_bits_opcode =
    auto_out_d_bits_opcode == 3'h0 & ~(auto_out_d_bits_source[0])
      ? 3'h6
      : _GEN_0 ? 3'h5 : auto_out_d_bits_opcode;
  reg          beatsLeft;
  ...
  assign _in_d_bits_T_39 =
    ...
    | (muxState_1_2 ? _q_1_io_deq_bits_opcode : 3'h0);
  ...
  assign auto_out_a_bits_address =
    (muxState_0 ? auto_in_c_bits_address : 36'h0)
    | (muxState_1 ? auto_in_a_bits_address : 36'h0);

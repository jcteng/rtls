  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        entryReg_payload_pred_taken = _RANDOM[5'hA][7];
        ...
        entryReg_payload_fpWen = _RANDOM[5'hC][27];
        entryReg_payload_vecWen = _RANDOM[5'hC][28];
        entryReg_payload_v0Wen = _RANDOM[5'hC][29];
        entryReg_payload_vlWen = _RANDOM[5'hC][30];
        entryReg_payload_selImm = _RANDOM[5'hD][7:4];
        entryReg_payload_fpu_typeTagOut = _RANDOM[5'hE][10];
        entryReg_payload_fpu_wflags = _RANDOM[5'hE][12];
        entryReg_payload_fpu_typ = _RANDOM[5'hE][20:19];
        entryReg_payload_fpu_rm = _RANDOM[5'hE][26:24];

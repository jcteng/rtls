  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_itlb_exception_0 = _RANDOM[6'h6][16:15];
        s1_itlb_exception_1 = _RANDOM[6'h6][18:17];
        s1_waymasks_0_0 = _RANDOM[6'h6][19];
        s1_waymasks_0_1 = _RANDOM[6'h6][20];
        s1_waymasks_0_2 = _RANDOM[6'h6][21];
        s1_waymasks_0_3 = _RANDOM[6'h6][22];
        s1_waymasks_1_0 = _RANDOM[6'h6][23];
        s1_waymasks_1_1 = _RANDOM[6'h6][24];
        s1_waymasks_1_2 = _RANDOM[6'h6][25];
        s1_waymasks_1_3 = _RANDOM[6'h6][26];
        s1_meta_corrupt_0 = _RANDOM[6'h6][27];
        s1_meta_corrupt_1 = _RANDOM[6'h6][28];
        io_touch_0_valid_REG = _RANDOM[6'h6][29];
        io_touch_1_valid_REG = _RANDOM[6'h6][30];
        s1_hits_REG = _RANDOM[6'h6][31];
        s1_hits_valid = _RANDOM[6'h7][0];
        s1_hits_REG_1 = _RANDOM[6'h7][1];
        s1_hits_valid_1 = _RANDOM[6'h7][2];
        s1_datas_REG = _RANDOM[6'h7][3];
        s1_datas_r = {_RANDOM[6'h7][31:4], _RANDOM[6'h8], _RANDOM[6'h9][3:0]};
        s1_datas_REG_1 = _RANDOM[6'h9][4];
        s1_datas_r_1 = {_RANDOM[6'h9][31:5], _RANDOM[6'hA], _RANDOM[6'hB][4:0]};
        s1_datas_REG_2 = _RANDOM[6'hB][5];
        s1_datas_r_2 = {_RANDOM[6'hB][31:6], _RANDOM[6'hC], _RANDOM[6'hD][5:0]};
        s1_datas_REG_3 = _RANDOM[6'hD][6];
        s1_datas_r_3 = {_RANDOM[6'hD][31:7], _RANDOM[6'hE], _RANDOM[6'hF][6:0]};
        s1_datas_REG_4 = _RANDOM[6'hF][7];
        s1_datas_r_4 = {_RANDOM[6'hF][31:8], _RANDOM[6'h10], _RANDOM[6'h11][7:0]};
        s1_datas_REG_5 = _RANDOM[6'h11][8];
        s1_datas_r_5 = {_RANDOM[6'h11][31:9], _RANDOM[6'h12], _RANDOM[6'h13][8:0]};
        s1_datas_REG_6 = _RANDOM[6'h13][9];
        s1_datas_r_6 = {_RANDOM[6'h13][31:10], _RANDOM[6'h14], _RANDOM[6'h15][9:0]};
        s1_datas_REG_7 = _RANDOM[6'h15][10];
        s1_datas_r_7 = {_RANDOM[6'h15][31:11], _RANDOM[6'h16], _RANDOM[6'h17][10:0]};
        s1_codes_REG = _RANDOM[6'h17][11];
        s1_codes_r_0 = _RANDOM[6'h17][12];
        s1_codes_r_1 = _RANDOM[6'h17][13];
        s1_codes_r_2 = _RANDOM[6'h17][14];
        s1_codes_r_3 = _RANDOM[6'h17][15];
        s1_codes_r_4 = _RANDOM[6'h17][16];
        s1_codes_r_5 = _RANDOM[6'h17][17];
        s1_codes_r_6 = _RANDOM[6'h17][18];
        s1_codes_r_7 = _RANDOM[6'h17][19];
        s2_valid = _RANDOM[6'h17][20];
        s2_req_vaddr_0 = {_RANDOM[6'h17][31:21], _RANDOM[6'h18][29:0]};
        s2_req_vaddr_1 = {_RANDOM[6'h18][31:30], _RANDOM[6'h19], _RANDOM[6'h1A][6:0]};
        s2_req_ptags_0 = _RANDOM[6'h1A][30:7];
        s2_req_ptags_1 = {_RANDOM[6'h1A][31], _RANDOM[6'h1B][22:0]};
        s2_req_gpaddr = {_RANDOM[6'h1B][31:23], _RANDOM[6'h1C]};
        s2_doubleline = _RANDOM[6'h1D][0];
        s2_exception_0 = _RANDOM[6'h1D][2:1];
        s2_exception_1 = _RANDOM[6'h1D][4:3];
        s2_mmio_0 = _RANDOM[6'h1D][5];
        s2_mmio_1 = _RANDOM[6'h1D][6];
        s2_SRAMhits_0 = _RANDOM[6'h1D][7];
        s2_SRAMhits_1 = _RANDOM[6'h1D][8];
        s2_codes_0 = _RANDOM[6'h1D][9];
        s2_codes_1 = _RANDOM[6'h1D][10];
        s2_codes_2 = _RANDOM[6'h1D][11];
        s2_codes_3 = _RANDOM[6'h1D][12];
        s2_codes_4 = _RANDOM[6'h1D][13];
        s2_codes_5 = _RANDOM[6'h1D][14];
        s2_codes_6 = _RANDOM[6'h1D][15];
        s2_codes_7 = _RANDOM[6'h1D][16];
        s2_hits_0 = _RANDOM[6'h1D][17];
        s2_hits_1 = _RANDOM[6'h1D][18];
        s2_datas_0 = {_RANDOM[6'h1D][31:19], _RANDOM[6'h1E], _RANDOM[6'h1F][18:0]};
        s2_datas_1 = {_RANDOM[6'h1F][31:19], _RANDOM[6'h20], _RANDOM[6'h21][18:0]};
        s2_datas_2 = {_RANDOM[6'h21][31:19], _RANDOM[6'h22], _RANDOM[6'h23][18:0]};
        s2_datas_3 = {_RANDOM[6'h23][31:19], _RANDOM[6'h24], _RANDOM[6'h25][18:0]};
        s2_datas_4 = {_RANDOM[6'h25][31:19], _RANDOM[6'h26], _RANDOM[6'h27][18:0]};
        s2_datas_5 = {_RANDOM[6'h27][31:19], _RANDOM[6'h28], _RANDOM[6'h29][18:0]};
        s2_datas_6 = {_RANDOM[6'h29][31:19], _RANDOM[6'h2A], _RANDOM[6'h2B][18:0]};
        s2_datas_7 = {_RANDOM[6'h2B][31:19], _RANDOM[6'h2C], _RANDOM[6'h2D][18:0]};
        s2_meta_corrupt_0 = _RANDOM[6'h2D][19];
        s2_meta_corrupt_1 = _RANDOM[6'h2D][20];
        io_errors_0_valid_REG = _RANDOM[6'h2D][21];
        io_errors_0_bits_report_to_beu_REG = _RANDOM[6'h2D][22];
        io_errors_1_valid_REG = _RANDOM[6'h2D][23];
        io_errors_1_bits_report_to_beu_REG = _RANDOM[6'h2D][24];
        s2_l2_corrupt_0 = _RANDOM[6'h2D][25];
        s2_l2_corrupt_1 = _RANDOM[6'h2D][26];
        has_send_0 = _RANDOM[6'h2D][27];
        has_send_1 = _RANDOM[6'h2D][28];
        REG = _RANDOM[6'h2D][29];
        io_errors_0_bits_paddr_REG =
          {_RANDOM[6'h2D][31:30], _RANDOM[6'h2E], _RANDOM[6'h2F][1:0]};
        REG_1 = _RANDOM[6'h2F][2];
        io_errors_1_bits_paddr_REG = {_RANDOM[6'h2F][31:3], _RANDOM[6'h30][6:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        s1_valid = 1'h0;
        s1_req_vaddr_0 = 41'h0;

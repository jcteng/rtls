...
module Queue1_MSHRRequest(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = {_RANDOM[2'h0][31:1], _RANDOM[2'h1], _RANDOM[2'h2], _RANDOM[2'h3][11:0]};
        full = _RANDOM[2'h0][0];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        full = 1'h0;
  ...
  assign io_deq_bits_source = ram[23:12];
  assign io_deq_bits_set = ram[35:24];
  assign io_deq_bits_tag = ram[51:36];
  assign io_deq_bits_off = ram[57:52];
  assign io_deq_bits_mask = ram[89:58];
  assign io_deq_bits_bufIdx = ram[93:90];
  assign io_deq_bits_needHint = ram[94];
  assign io_deq_bits_isPrefetch = ram[95];
  assign io_deq_bits_isBop = ram[96];
  assign io_deq_bits_preferCache = ram[97];
  assign io_deq_bits_dirty = ram[98];
  assign io_deq_bits_fromProbeHelper = ram[100];
  assign io_deq_bits_fromCmoHelper = ram[101];
  assign io_deq_bits_needProbeAckData = ram[102];
  assign io_deq_bits_reqSource = ram[106:103];
endmodule

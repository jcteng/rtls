...
module Queue1_AXI4BundleARW_1(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = {_RANDOM[2'h0][31:1], _RANDOM[2'h1], _RANDOM[2'h2][5:0]};
        full = _RANDOM[2'h0][0];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        full = 1'h0;
  ...
  assign io_deq_bits_burst = full ? ram[47:46] : 2'h1;
  assign io_deq_bits_lock = full & ram[48];
  assign io_deq_bits_cache = full ? ram[52:49] : 4'h0;
  assign io_deq_bits_prot = full ? ram[55:53] : 3'h1;
  assign io_deq_bits_qos = full ? ram[59:56] : 4'h0;
  assign io_deq_bits_echo_tl_state_size =
    full ? ram[63:60] : io_enq_bits_echo_tl_state_size;
  assign io_deq_bits_echo_tl_state_source =
    full ? ram[67:64] : io_enq_bits_echo_tl_state_source;

...
module CLINT(
  ...
  wire [10:0]      _GEN = {auto_in_a_bits_address[15], auto_in_a_bits_address[13:4]};
  wire             _out_T_7 = _GEN == 11'h0;
  ...
  wire             valids_2_0 = out_woready_19 & auto_in_a_bits_mask[0];
  wire             valids_2_1 = out_woready_19 & auto_in_a_bits_mask[1];
  wire             valids_2_2 = out_woready_19 & auto_in_a_bits_mask[2];
  wire             valids_2_3 = out_woready_19 & auto_in_a_bits_mask[3];
  wire             valids_2_4 = out_woready_19 & auto_in_a_bits_mask[4];
  wire             valids_2_5 = out_woready_19 & auto_in_a_bits_mask[5];
  wire             valids_2_6 = out_woready_19 & auto_in_a_bits_mask[6];
  wire             valids_2_7 = out_woready_19 & auto_in_a_bits_mask[7];
  wire             valids_0 = out_woready_27 & auto_in_a_bits_mask[0];
  wire             valids_1 = out_woready_27 & auto_in_a_bits_mask[1];
  wire             valids_2 = out_woready_27 & auto_in_a_bits_mask[2];
  wire             valids_3 = out_woready_27 & auto_in_a_bits_mask[3];
  wire             valids_4 = out_woready_27 & auto_in_a_bits_mask[4];
  wire             valids_5 = out_woready_27 & auto_in_a_bits_mask[5];
  wire             valids_6 = out_woready_27 & auto_in_a_bits_mask[6];
  wire             valids_7 = out_woready_27 & auto_in_a_bits_mask[7];
  wire [1:0]       out_oindex = {auto_in_a_bits_address[14], auto_in_a_bits_address[3]};
  wire [1:0]       _GEN_0 = {auto_in_a_bits_address[14], auto_in_a_bits_address[3]};
  wire             _out_wofireMux_T_2 = auto_in_a_valid & auto_in_d_ready & ~in_bits_read;
  wire             out_woready_2 = _out_wofireMux_T_2 & _GEN_0 == 2'h0 & _out_T_7;
  assign out_woready_19 = _out_wofireMux_T_2 & _GEN_0 == 2'h1 & (&_GEN);
  assign out_woready_27 = _out_wofireMux_T_2 & _GEN_0 == 2'h2 & _out_T_7;
  assign out_woready_9 = _out_wofireMux_T_2 & (&_GEN_0) & _out_T_7;
  wire [3:0]       _GEN_1 = {{_out_T_7}, {_out_T_7}, {&_GEN}, {_out_T_7}};
  wire [3:0][63:0] _GEN_2 = {{pad_1}, {pad}, {time_0}, {{31'h0, ipi_1, 31'h0, ipi_0}}};
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (valids_2_0 | valids_2_1 | valids_2_2 | valids_2_3 | valids_2_4 | valids_2_5
        ...
        time_0 <=
          {valids_2_7 ? auto_in_a_bits_data[63:56] : time_0[63:56],
           valids_2_6 ? auto_in_a_bits_data[55:48] : time_0[55:48],
           valids_2_5 ? auto_in_a_bits_data[47:40] : time_0[47:40],
           valids_2_4 ? auto_in_a_bits_data[39:32] : time_0[39:32],
           valids_2_3 ? auto_in_a_bits_data[31:24] : time_0[31:24],
           valids_2_2 ? auto_in_a_bits_data[23:16] : time_0[23:16],
           valids_2_1 ? auto_in_a_bits_data[15:8] : time_0[15:8],
           valids_2_0 ? auto_in_a_bits_data[7:0] : time_0[7:0]};
      else if (io_rtcTick)
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        pad_1 = {_RANDOM[3'h4], _RANDOM[3'h5]};
        ipi_0 = _RANDOM[3'h6][0];
        ipi_1 = _RANDOM[3'h6][1];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        time_0 = 64'h0;
        ipi_0 = 1'h0;

...
module FastArbiter_51(
  ...
  assign io_out_bits_tag =
    (chosenOH[0] ? io_in_0_bits_tag : 16'h0) | (chosenOH[1] ? io_in_1_bits_tag : 16'h0)
    | (chosenOH[2] ? io_in_2_bits_tag : 16'h0) | (chosenOH[3] ? io_in_3_bits_tag : 16'h0)
    | (chosenOH[4] ? io_in_4_bits_tag : 16'h0) | (chosenOH[5] ? io_in_5_bits_tag : 16'h0)
    | (chosenOH[6] ? io_in_6_bits_tag : 16'h0) | (chosenOH[7] ? io_in_7_bits_tag : 16'h0)
    | (chosenOH[8] ? io_in_8_bits_tag : 16'h0) | (chosenOH[9] ? io_in_9_bits_tag : 16'h0)

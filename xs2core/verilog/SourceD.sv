...
module SourceD(
  ...
  input          io_task_valid,
  input  [11:0]  io_task_bits_sourceId,
  ...
  wire [11:0]  _pipe_io_out_bits_req_sourceId;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_req_reg_sourceId = _RANDOM[5'h0][13:2];
        s1_req_reg_set = _RANDOM[5'h0][25:14];
        s1_req_reg_tag = {_RANDOM[5'h0][31:26], _RANDOM[5'h1][9:0]};
        s1_req_reg_channel = _RANDOM[5'h1][12:10];
        s1_req_reg_opcode = _RANDOM[5'h1][15:13];
        s1_req_reg_param = _RANDOM[5'h1][18:16];
        s1_req_reg_size = _RANDOM[5'h1][21:19];
        s1_req_reg_way = _RANDOM[5'h1][25:22];
        s1_req_reg_off = _RANDOM[5'h1][31:26];
        s1_req_reg_useBypass = _RANDOM[5'h2][0];
        s1_req_reg_bufIdx = _RANDOM[5'h2][4:1];
        s1_req_reg_denied = _RANDOM[5'h2][5];
        s1_req_reg_sinkId = _RANDOM[5'h2][9:6];
        s1_req_reg_bypassPut = _RANDOM[5'h2][10];
        s1_req_reg_dirty = _RANDOM[5'h2][11];
        s1_req_reg_isHit = _RANDOM[5'h2][12];
        s1_counter = _RANDOM[5'h2][13];
        s2_req_sourceId = _RANDOM[5'h2][25:14];
        s2_req_set = {_RANDOM[5'h2][31:26], _RANDOM[5'h3][5:0]};
        s2_req_tag = _RANDOM[5'h3][21:6];
        s2_req_channel = _RANDOM[5'h3][24:22];
        s2_req_opcode = _RANDOM[5'h3][27:25];
        s2_req_param = _RANDOM[5'h3][30:28];
        s2_req_size = {_RANDOM[5'h3][31], _RANDOM[5'h4][1:0]};
        s2_req_way = _RANDOM[5'h4][5:2];
        s2_req_off = _RANDOM[5'h4][11:6];
        s2_req_useBypass = _RANDOM[5'h4][12];
        s2_req_bufIdx = _RANDOM[5'h4][16:13];
        s2_req_denied = _RANDOM[5'h4][17];
        s2_req_sinkId = _RANDOM[5'h4][21:18];
        s2_req_bypassPut = _RANDOM[5'h4][22];
        s2_req_dirty = _RANDOM[5'h4][23];
        s2_req_isHit = _RANDOM[5'h4][24];
        s2_needData = _RANDOM[5'h4][25];
        s2_beat = _RANDOM[5'h4][26];
        s2_last = _RANDOM[5'h4][27];
        s2_counter = _RANDOM[5'h4][28];
        s2_full = _RANDOM[5'h4][29];
        s2_need_pb = _RANDOM[5'h4][30];
        s2_need_d = _RANDOM[5'h4][31];
        s2_valid_pb = _RANDOM[5'h5][0];
        pbQueue_io_enq_valid_REG = _RANDOM[5'h5][1];
        s3_queue_io_enq_valid_REG = _RANDOM[5'h5][2];
        s3_queue_io_enq_valid_REG_1 = _RANDOM[5'h5][3];
        s3_queue_io_enq_valid_REG_2 = _RANDOM[5'h5][4];
        s3_queue_io_enq_valid_REG_3 = _RANDOM[5'h5][5];
        s3_queue_io_enq_valid_REG_4 = _RANDOM[5'h5][6];
        s4_req_set = _RANDOM[5'h5][30:19];
        s4_req_way = _RANDOM[5'h6][30:27];
        s4_req_sinkId = _RANDOM[5'h7][14:11];
        s4_rdata =
          {_RANDOM[5'h7][31:18],
           _RANDOM[5'h8],
           _RANDOM[5'h9],
        ...
        s4_pbdata_data =
          {_RANDOM[5'hF][31:18],
           ...
           _RANDOM[5'h16],
           _RANDOM[5'h17][17:0]};
        s4_pbdata_mask = {_RANDOM[5'h17][31:18], _RANDOM[5'h18][17:0]};
        s4_need_pb = _RANDOM[5'h18][19];
        s4_beat = _RANDOM[5'h18][20];
        s4_last = _RANDOM[5'h18][21];
        s4_full = _RANDOM[5'h18][22];
        beatsLeft = _RANDOM[5'h18][23];
        state_0 = _RANDOM[5'h18][24];
        state_1 = _RANDOM[5'h18][25];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        busy = 1'h0;
        s1_block_r = 1'h0;
  ...
  assign io_d_bits_source =
    (muxState_0 ? _pipe_io_out_bits_req_sourceId : 12'h0)
    | (muxState_1 ? s2_req_sourceId : 12'h0);

  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        mem_0_hrmask_0 = _RANDOM[/*Zero width*/ 1'b0][15];
        mem_0_hrmask_1 = _RANDOM[/*Zero width*/ 1'b0][16];
        widx_widx_bin = _RANDOM[/*Zero width*/ 1'b0][17];
        ready_reg = _RANDOM[/*Zero width*/ 1'b0][18];
        widx_gray = _RANDOM[/*Zero width*/ 1'b0][19];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        widx_widx_bin = 1'h0;
        ready_reg = 1'h0;

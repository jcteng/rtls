...
module TLToAXI4_1(
  ...
  wire [3:0]       _queue_arw_deq_q_io_deq_bits_id;
  ...
  wire [3:0]       _queue_arw_deq_q_io_deq_bits_echo_tl_state_source;
  ...
  wire             _inc_T_9 = _queue_arw_deq_q_io_enq_ready & out_arw_valid;
  wire             _dec_T_19 = auto_in_d_ready & nodeIn_d_valid;
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      count <=
        1'(1'(count + (_GEN[auto_in_a_bits_source] == 4'h0 & _inc_T_9))
           - (d_sel_shiftAmount == 4'h0 & d_last & _dec_T_19));
      count_1 <=
        1'(1'(count_1 + (_GEN[auto_in_a_bits_source] == 4'h1 & _inc_T_9))
           - (d_sel_shiftAmount == 4'h1 & d_last & _dec_T_19));
      count_2 <=
        1'(1'(count_2 + (_GEN[auto_in_a_bits_source] == 4'h2 & _inc_T_9))
           - (d_sel_shiftAmount == 4'h2 & d_last & _dec_T_19));
      count_3 <=
        1'(1'(count_3 + (_GEN[auto_in_a_bits_source] == 4'h3 & _inc_T_9))
           - (d_sel_shiftAmount == 4'h3 & d_last & _dec_T_19));
      count_4 <=
        1'(1'(count_4 + (_GEN[auto_in_a_bits_source] == 4'h4 & _inc_T_9))
           - (d_sel_shiftAmount == 4'h4 & d_last & _dec_T_19));
      count_5 <=
        1'(1'(count_5 + (_GEN[auto_in_a_bits_source] == 4'h5 & _inc_T_9))
           - (d_sel_shiftAmount == 4'h5 & d_last & _dec_T_19));
      count_6 <=
        1'(1'(count_6 + (_GEN[auto_in_a_bits_source] == 4'h6 & _inc_T_9))
           - (d_sel_shiftAmount == 4'h6 & d_last & _dec_T_19));
      count_7 <=
        1'(1'(count_7 + (_GEN[auto_in_a_bits_source] == 4'h7 & _inc_T_9))
           - (d_sel_shiftAmount == 4'h7 & d_last & _dec_T_19));
      count_8 <=
        1'(1'(count_8 + (_GEN[auto_in_a_bits_source] == 4'h8 & _inc_T_9))
           - (d_sel_shiftAmount == 4'h8 & d_last & _dec_T_19));
      count_9 <=
        1'(1'(count_9 + (_GEN[auto_in_a_bits_source] == 4'h9 & _inc_T_9))
           - (d_sel_shiftAmount == 4'h9 & d_last & _dec_T_19));
    end
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        count_5 = _RANDOM[/*Zero width*/ 1'b0][19];
        count_6 = _RANDOM[/*Zero width*/ 1'b0][21];
        count_7 = _RANDOM[/*Zero width*/ 1'b0][23];
        count_8 = _RANDOM[/*Zero width*/ 1'b0][25];
        count_9 = _RANDOM[/*Zero width*/ 1'b0][27];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        r_counter = 2'h0;
        doneAW = 1'h0;

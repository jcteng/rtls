...
module TLDebugModuleInner(
  ...
  reg           hamaskReg_0;
  reg           hamaskReg_1;
  wire          _GEN = selectedHartReg < 6'h2;
  wire          hamaskFull_0 = _GEN & ~(selectedHartReg[0]) | hamaskReg_0;
  wire          hamaskFull_1 = _GEN & selectedHartReg[0] | hamaskReg_1;
  wire          hamaskWrSel_0 =
  ...
  wire          DMSTATUSRdData_allnonexistent =
    (|(selectedHartReg[5:1])) & ~(hamaskFull_0 | hamaskFull_1);
  wire          _GEN_0 = ~DMSTATUSRdData_allnonexistent & ~(|(selectedHartReg[5:1]));
  ...
  assign resumeAcks =
    resumereq ? ~resumeReqRegs & ~{hamaskWrSel_1, hamaskWrSel_0} : ~resumeReqRegs;
  ...
  wire [7:0]    _GEN_1 = {auto_tl_in_a_bits_address[11], auto_tl_in_a_bits_address[9:3]};
  wire          _out_wofireMux_T_262 =
    auto_tl_in_a_valid & auto_tl_in_d_ready & ~in_1_bits_read;
  assign out_woready_1_191 =
    _out_wofireMux_T_262 & _GEN_1 == 8'h20 & ~(auto_tl_in_a_bits_address[10]);
  wire          out_woready_1_140 =
    _out_wofireMux_T_262 & _GEN_1 == 8'h21 & ~(auto_tl_in_a_bits_address[10]);
  wire          out_woready_1_74 =
    _out_wofireMux_T_262 & _GEN_1 == 8'h68 & ~(auto_tl_in_a_bits_address[10]);
  wire          out_woready_1_181 =
    _out_wofireMux_T_262 & _GEN_1 == 8'h69 & ~(auto_tl_in_a_bits_address[10]);
  wire          out_woready_1_32 =
    _out_wofireMux_T_262 & _GEN_1 == 8'h6A & ~(auto_tl_in_a_bits_address[10]);
  wire          out_woready_1_241 =
    _out_wofireMux_T_262 & _GEN_1 == 8'h6B & ~(auto_tl_in_a_bits_address[10]);
  wire          out_woready_1_209 =
    _out_wofireMux_T_262 & _GEN_1 == 8'h6C & ~(auto_tl_in_a_bits_address[10]);
  wire          out_woready_1_149 =
    _out_wofireMux_T_262 & _GEN_1 == 8'h6D & ~(auto_tl_in_a_bits_address[10]);
  wire          out_woready_1_9 =
    _out_wofireMux_T_262 & _GEN_1 == 8'h6E & ~(auto_tl_in_a_bits_address[10]);
  wire          out_woready_1_99 =
    _out_wofireMux_T_262 & _GEN_1 == 8'h6F & ~(auto_tl_in_a_bits_address[10]);
  wire          out_woready_1_58 =
    _out_wofireMux_T_262 & _GEN_1 == 8'h70 & ~(auto_tl_in_a_bits_address[10]);
  ...
  wire [5:0]    _hartHalted_T = {4'h0, haltedBitRegs} >> selectedHartReg;
  ...
  wire          commandRegIsUnsupported = ~commandRegIsAccessRegister | ~_GEN_3;
  wire          commandRegBadHaltResume =
    commandRegIsAccessRegister & _GEN_3 & ~(_hartHalted_T[0]);
  ...
  wire [1:0]    _resumeReqRegs_T_10 =
    {_hartIsInResetSync_1_debug_hartReset_1_io_q,
     _hartIsInResetSync_0_debug_hartReset_0_io_q};
  wire [1023:0] _GEN_6 = {1014'h0, auto_tl_in_a_bits_data[9:0]};
  wire [1023:0] hartResumingIdIndex = 1024'h1 << _GEN_6;
  ...
  wire [1023:0] hartHaltedIdIndex = 1024'h1 << _GEN_6;
  ...
  always @(posedge clock) begin
    if (io_dmactive) begin
      if (hartHaltedWrEn)
        ...
        haltedBitRegs <=
          ~(hartResumingIdIndex[1:0]) & haltedBitRegs & ~_resumeReqRegs_T_10;
      else
        haltedBitRegs <= haltedBitRegs & ~_resumeReqRegs_T_10;
      if (resumereq)
        resumeReqRegs <=
          (resumeReqRegs | {hamaskWrSel_1, hamaskWrSel_0}) & ~_resumeReqRegs_T_10;
      else if (hartResumingWrEn)
        resumeReqRegs <=
          ~(hartResumingIdIndex[1:0]) & resumeReqRegs & ~_resumeReqRegs_T_10;
      else
      ...
      else if (~(COMMANDWrEnLegal | _GEN_4) & _GEN_8 & hartExceptionWrEn)
      ...
      else if (~COMMANDWrEnLegal & _GEN_4 & ~commandRegIsUnsupported
  ...
  wire          _GEN_10 = auto_dmi_in_a_bits_data[6:2] < 5'h2;
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      hgParticipateHart_0 <=
        io_dmactive
        & (_GEN_9 & hamaskFull_0 & _GEN_10
             ? auto_dmi_in_a_bits_data[2]
             : hgParticipateHart_0);
      hgParticipateHart_1 <=
        io_dmactive
        & (_GEN_9 & hamaskFull_1 & _GEN_10
             ? auto_dmi_in_a_bits_data[2]
             : hgParticipateHart_1);
      hgFired_1 <=
        io_dmactive
        & (~hgFired_1 & hartHaltedWrEn & ~(_hgHartFiring_1_T[0])
           & (auto_tl_in_a_bits_data[0] ? hgParticipateHart_1 : hgParticipateHart_0)
           | ~(hgFired_1 & (haltedBitRegs[0] | ~hgParticipateHart_0)
               & (haltedBitRegs[1] | ~hgParticipateHart_1)) & hgFired_1);
    end
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        haltedBitRegs = _RANDOM[6'h0][1:0];
        resumeReqRegs = _RANDOM[6'h0][3:2];
        haveResetBitRegs = _RANDOM[6'h0][5:4];
        selectedHartReg = _RANDOM[6'h0][11:6];
        hamaskReg_0 = _RANDOM[6'h0][12];
        hamaskReg_1 = _RANDOM[6'h0][13];
        hrmaskReg_0 = _RANDOM[6'h0][14];
        hrmaskReg_1 = _RANDOM[6'h0][15];
        hrDebugIntReg_0 = _RANDOM[6'h0][16];
        hrDebugIntReg_1 = _RANDOM[6'h0][17];
        hgParticipateHart_0 = _RANDOM[6'h0][18];
        hgParticipateHart_1 = _RANDOM[6'h0][19];
        hgFired_1 = _RANDOM[6'h0][21];
        ABSTRACTCSReg_cmderr = _RANDOM[6'h1][13:11];
        ABSTRACTAUTOReg_autoexecprogbuf = {_RANDOM[6'h1][31:22], _RANDOM[6'h2][5:0]};
        ABSTRACTAUTOReg_autoexecdata = _RANDOM[6'h2][21:10];
        COMMANDReg_cmdtype = _RANDOM[6'h2][29:22];
        COMMANDReg_control = {_RANDOM[6'h2][31:30], _RANDOM[6'h3][21:0]};
        abstractDataMem_0 = _RANDOM[6'h3][29:22];
        abstractDataMem_1 = {_RANDOM[6'h3][31:30], _RANDOM[6'h4][5:0]};
        abstractDataMem_2 = _RANDOM[6'h4][13:6];
        abstractDataMem_3 = _RANDOM[6'h4][21:14];
        abstractDataMem_4 = _RANDOM[6'h4][29:22];
        abstractDataMem_5 = {_RANDOM[6'h4][31:30], _RANDOM[6'h5][5:0]};
        abstractDataMem_6 = _RANDOM[6'h5][13:6];
        abstractDataMem_7 = _RANDOM[6'h5][21:14];
        programBufferMem_0 = _RANDOM[6'h5][29:22];
        programBufferMem_1 = {_RANDOM[6'h5][31:30], _RANDOM[6'h6][5:0]};
        programBufferMem_2 = _RANDOM[6'h6][13:6];
        programBufferMem_3 = _RANDOM[6'h6][21:14];
        programBufferMem_4 = _RANDOM[6'h6][29:22];
        programBufferMem_5 = {_RANDOM[6'h6][31:30], _RANDOM[6'h7][5:0]};
        programBufferMem_6 = _RANDOM[6'h7][13:6];
        programBufferMem_7 = _RANDOM[6'h7][21:14];
        programBufferMem_8 = _RANDOM[6'h7][29:22];
        programBufferMem_9 = {_RANDOM[6'h7][31:30], _RANDOM[6'h8][5:0]};
        programBufferMem_10 = _RANDOM[6'h8][13:6];
        programBufferMem_11 = _RANDOM[6'h8][21:14];
        programBufferMem_12 = _RANDOM[6'h8][29:22];
        programBufferMem_13 = {_RANDOM[6'h8][31:30], _RANDOM[6'h9][5:0]};
        programBufferMem_14 = _RANDOM[6'h9][13:6];
        programBufferMem_15 = _RANDOM[6'h9][21:14];
        programBufferMem_16 = _RANDOM[6'h9][29:22];
        programBufferMem_17 = {_RANDOM[6'h9][31:30], _RANDOM[6'hA][5:0]};
        programBufferMem_18 = _RANDOM[6'hA][13:6];
        programBufferMem_19 = _RANDOM[6'hA][21:14];
        programBufferMem_20 = _RANDOM[6'hA][29:22];
        programBufferMem_21 = {_RANDOM[6'hA][31:30], _RANDOM[6'hB][5:0]};
        programBufferMem_22 = _RANDOM[6'hB][13:6];
        programBufferMem_23 = _RANDOM[6'hB][21:14];
        programBufferMem_24 = _RANDOM[6'hB][29:22];
        programBufferMem_25 = {_RANDOM[6'hB][31:30], _RANDOM[6'hC][5:0]};
        programBufferMem_26 = _RANDOM[6'hC][13:6];
        programBufferMem_27 = _RANDOM[6'hC][21:14];
        programBufferMem_28 = _RANDOM[6'hC][29:22];
        programBufferMem_29 = {_RANDOM[6'hC][31:30], _RANDOM[6'hD][5:0]};
        programBufferMem_30 = _RANDOM[6'hD][13:6];
        programBufferMem_31 = _RANDOM[6'hD][21:14];
        programBufferMem_32 = _RANDOM[6'hD][29:22];
        programBufferMem_33 = {_RANDOM[6'hD][31:30], _RANDOM[6'hE][5:0]};
        programBufferMem_34 = _RANDOM[6'hE][13:6];
        programBufferMem_35 = _RANDOM[6'hE][21:14];
        programBufferMem_36 = _RANDOM[6'hE][29:22];
        programBufferMem_37 = {_RANDOM[6'hE][31:30], _RANDOM[6'hF][5:0]};
        programBufferMem_38 = _RANDOM[6'hF][13:6];
        programBufferMem_39 = _RANDOM[6'hF][21:14];
        programBufferMem_40 = _RANDOM[6'hF][29:22];
        programBufferMem_41 = {_RANDOM[6'hF][31:30], _RANDOM[6'h10][5:0]};
        programBufferMem_42 = _RANDOM[6'h10][13:6];
        programBufferMem_43 = _RANDOM[6'h10][21:14];
        programBufferMem_44 = _RANDOM[6'h10][29:22];
        programBufferMem_45 = {_RANDOM[6'h10][31:30], _RANDOM[6'h11][5:0]};
        programBufferMem_46 = _RANDOM[6'h11][13:6];
        programBufferMem_47 = _RANDOM[6'h11][21:14];
        programBufferMem_48 = _RANDOM[6'h11][29:22];
        programBufferMem_49 = {_RANDOM[6'h11][31:30], _RANDOM[6'h12][5:0]};
        programBufferMem_50 = _RANDOM[6'h12][13:6];
        programBufferMem_51 = _RANDOM[6'h12][21:14];
        programBufferMem_52 = _RANDOM[6'h12][29:22];
        programBufferMem_53 = {_RANDOM[6'h12][31:30], _RANDOM[6'h13][5:0]};
        programBufferMem_54 = _RANDOM[6'h13][13:6];
        programBufferMem_55 = _RANDOM[6'h13][21:14];
        programBufferMem_56 = _RANDOM[6'h13][29:22];
        programBufferMem_57 = {_RANDOM[6'h13][31:30], _RANDOM[6'h14][5:0]};
        programBufferMem_58 = _RANDOM[6'h14][13:6];
        programBufferMem_59 = _RANDOM[6'h14][21:14];
        programBufferMem_60 = _RANDOM[6'h14][29:22];
        programBufferMem_61 = {_RANDOM[6'h14][31:30], _RANDOM[6'h15][5:0]};
        programBufferMem_62 = _RANDOM[6'h15][13:6];
        programBufferMem_63 = _RANDOM[6'h15][21:14];
        SBCSFieldsReg_sbbusyerror = _RANDOM[6'h15][31];
        SBCSFieldsReg_sbbusy = _RANDOM[6'h16][0];
        SBCSFieldsReg_sbreadonaddr = _RANDOM[6'h16][1];
        SBCSFieldsReg_sbaccess = _RANDOM[6'h16][4:2];
        SBCSFieldsReg_sbautoincrement = _RANDOM[6'h16][5];
        SBCSFieldsReg_sbreadondata = _RANDOM[6'h16][6];
        SBADDRESSFieldsReg_0 = {_RANDOM[6'h16][31:22], _RANDOM[6'h17][21:0]};
        SBADDRESSFieldsReg_1 = {_RANDOM[6'h17][31:22], _RANDOM[6'h18][21:0]};
        SBDATAFieldsReg_0_0 = _RANDOM[6'h1A][29:22];
        SBDATAFieldsReg_0_1 = {_RANDOM[6'h1A][31:30], _RANDOM[6'h1B][5:0]};
        SBDATAFieldsReg_0_2 = _RANDOM[6'h1B][13:6];
        SBDATAFieldsReg_0_3 = _RANDOM[6'h1B][21:14];
        SBDATAFieldsReg_1_0 = _RANDOM[6'h1B][29:22];
        SBDATAFieldsReg_1_1 = {_RANDOM[6'h1B][31:30], _RANDOM[6'h1C][5:0]};
        SBDATAFieldsReg_1_2 = _RANDOM[6'h1C][13:6];
        SBDATAFieldsReg_1_3 = _RANDOM[6'h1C][21:14];
        sbErrorReg_0 = _RANDOM[6'h1E][22];
        sbErrorReg_1 = _RANDOM[6'h1E][23];
        sbErrorReg_2 = _RANDOM[6'h1E][24];
        goReg = _RANDOM[6'h1E][26];
        abstractGeneratedMem_0 = {_RANDOM[6'h1E][31:27], _RANDOM[6'h1F][26:0]};
        abstractGeneratedMem_1 = {_RANDOM[6'h1F][31:27], _RANDOM[6'h20][26:0]};
        abstractGeneratedMem_2 = {_RANDOM[6'h20][31:27], _RANDOM[6'h21][26:0]};
        abstractGeneratedMem_3 = {_RANDOM[6'h21][31:27], _RANDOM[6'h22][26:0]};
        abstractGeneratedMem_4 = {_RANDOM[6'h22][31:27], _RANDOM[6'h23][26:0]};
        ctrlStateReg = _RANDOM[6'h23][28:27];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        hrmaskReg_0 = 1'h0;
        hrmaskReg_1 = 1'h0;
                   ...
                   : auto_dmi_in_a_bits_address[7:2] == 6'h11
                       ? {12'h0,
                          _GEN_0 & (haveResetBitRegs[0] | ~hamaskFull_0)
                            & (haveResetBitRegs[1] | ~hamaskFull_1),
                          ~DMSTATUSRdData_allnonexistent
                            & (haveResetBitRegs[0] & hamaskFull_0 | haveResetBitRegs[1]
                               & hamaskFull_1),
                          _GEN_0 & (resumeAcks[0] | ~hamaskFull_0)
                            & (resumeAcks[1] | ~hamaskFull_1),
                          ~DMSTATUSRdData_allnonexistent
                            & (resumeAcks[0] & hamaskFull_0 | resumeAcks[1]
                               & hamaskFull_1),
                          DMSTATUSRdData_allnonexistent,
                          |(selectedHartReg[5:1]),
                          _GEN_0 & ~hamaskFull_0 & ~hamaskFull_1,
                          1'h0,
                          _GEN_0 & (~(haltedBitRegs[0]) | ~hamaskFull_0)
                            & (~(haltedBitRegs[1]) | ~hamaskFull_1),
                          ~DMSTATUSRdData_allnonexistent
                            & (~(haltedBitRegs[0]) & hamaskFull_0 | ~(haltedBitRegs[1])
                               & hamaskFull_1),
                          _GEN_0 & (haltedBitRegs[0] | ~hamaskFull_0)
                            & (haltedBitRegs[1] | ~hamaskFull_1),
                          ~DMSTATUSRdData_allnonexistent

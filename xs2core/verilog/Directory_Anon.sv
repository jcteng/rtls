...
module Directory_Anon(
  ...
  wire [15:0]       _GEN_8 =
    {{errorAll_s2_15},
     ...
     {errorAll_s2_1},
     {errorAll_s2_0}};
  wire              _GEN_9 = resetFinish & io_dir_w_bits_dir_dirty;
  wire [1:0]        _GEN_10 = resetFinish ? io_dir_w_bits_dir_state : 2'h0;
  wire [1:0]        _GEN_11 = resetFinish ? io_dir_w_bits_dir_clientStates_0 : 2'h0;
  wire [1:0]        _GEN_12 = resetFinish ? io_dir_w_bits_dir_clientStates_1 : 2'h0;
  wire              _GEN_13 = resetFinish & io_dir_w_bits_dir_prefetch;
  reg               resetMask;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        metaAll_s2_0_prefetch = _RANDOM[5'h4][2];
        metaAll_s2_1_dirty = _RANDOM[5'h4][3];
        metaAll_s2_1_state = _RANDOM[5'h4][5:4];
        metaAll_s2_1_clientStates_0 = _RANDOM[5'h4][7:6];
        metaAll_s2_1_clientStates_1 = _RANDOM[5'h4][9:8];
        metaAll_s2_1_prefetch = _RANDOM[5'h4][10];
        metaAll_s2_2_dirty = _RANDOM[5'h4][11];
        metaAll_s2_2_state = _RANDOM[5'h4][13:12];
        metaAll_s2_2_clientStates_0 = _RANDOM[5'h4][15:14];
        metaAll_s2_2_clientStates_1 = _RANDOM[5'h4][17:16];
        metaAll_s2_2_prefetch = _RANDOM[5'h4][18];
        metaAll_s2_3_dirty = _RANDOM[5'h4][19];
        metaAll_s2_3_state = _RANDOM[5'h4][21:20];
        metaAll_s2_3_clientStates_0 = _RANDOM[5'h4][23:22];
        metaAll_s2_3_clientStates_1 = _RANDOM[5'h4][25:24];
        metaAll_s2_3_prefetch = _RANDOM[5'h4][26];
        metaAll_s2_4_dirty = _RANDOM[5'h4][27];
        metaAll_s2_4_state = _RANDOM[5'h4][29:28];
        metaAll_s2_4_clientStates_0 = _RANDOM[5'h4][31:30];
        metaAll_s2_4_clientStates_1 = _RANDOM[5'h5][1:0];
        metaAll_s2_4_prefetch = _RANDOM[5'h5][2];
        metaAll_s2_5_dirty = _RANDOM[5'h5][3];
        metaAll_s2_5_state = _RANDOM[5'h5][5:4];
        metaAll_s2_5_clientStates_0 = _RANDOM[5'h5][7:6];
        metaAll_s2_5_clientStates_1 = _RANDOM[5'h5][9:8];
        ...
        metaAll_s2_6_clientStates_1 = _RANDOM[5'h5][17:16];
        metaAll_s2_6_prefetch = _RANDOM[5'h5][18];
        metaAll_s2_7_dirty = _RANDOM[5'h5][19];
        metaAll_s2_7_state = _RANDOM[5'h5][21:20];
        metaAll_s2_7_clientStates_0 = _RANDOM[5'h5][23:22];
        metaAll_s2_7_clientStates_1 = _RANDOM[5'h5][25:24];
        metaAll_s2_7_prefetch = _RANDOM[5'h5][26];
        metaAll_s2_8_dirty = _RANDOM[5'h5][27];
        metaAll_s2_8_state = _RANDOM[5'h5][29:28];
        metaAll_s2_8_clientStates_0 = _RANDOM[5'h5][31:30];
        metaAll_s2_8_clientStates_1 = _RANDOM[5'h6][1:0];
        metaAll_s2_8_prefetch = _RANDOM[5'h6][2];
        metaAll_s2_9_dirty = _RANDOM[5'h6][3];
        metaAll_s2_9_state = _RANDOM[5'h6][5:4];
        metaAll_s2_9_clientStates_0 = _RANDOM[5'h6][7:6];
        metaAll_s2_9_clientStates_1 = _RANDOM[5'h6][9:8];
        metaAll_s2_9_prefetch = _RANDOM[5'h6][10];
        metaAll_s2_10_dirty = _RANDOM[5'h6][11];
        metaAll_s2_10_state = _RANDOM[5'h6][13:12];
        metaAll_s2_10_clientStates_0 = _RANDOM[5'h6][15:14];
        metaAll_s2_10_clientStates_1 = _RANDOM[5'h6][17:16];
        metaAll_s2_10_prefetch = _RANDOM[5'h6][18];
        metaAll_s2_11_dirty = _RANDOM[5'h6][19];
        metaAll_s2_11_state = _RANDOM[5'h6][21:20];
        metaAll_s2_11_clientStates_0 = _RANDOM[5'h6][23:22];
        metaAll_s2_11_clientStates_1 = _RANDOM[5'h6][25:24];
        metaAll_s2_11_prefetch = _RANDOM[5'h6][26];
        metaAll_s2_12_dirty = _RANDOM[5'h6][27];
        metaAll_s2_12_state = _RANDOM[5'h6][29:28];
        metaAll_s2_12_clientStates_0 = _RANDOM[5'h6][31:30];
        metaAll_s2_12_clientStates_1 = _RANDOM[5'h7][1:0];
        metaAll_s2_12_prefetch = _RANDOM[5'h7][2];
        metaAll_s2_13_dirty = _RANDOM[5'h7][3];
        metaAll_s2_13_state = _RANDOM[5'h7][5:4];
        metaAll_s2_13_clientStates_0 = _RANDOM[5'h7][7:6];
        metaAll_s2_13_clientStates_1 = _RANDOM[5'h7][9:8];
        metaAll_s2_13_prefetch = _RANDOM[5'h7][10];
        metaAll_s2_14_dirty = _RANDOM[5'h7][11];
        metaAll_s2_14_state = _RANDOM[5'h7][13:12];
        metaAll_s2_14_clientStates_0 = _RANDOM[5'h7][15:14];
        metaAll_s2_14_clientStates_1 = _RANDOM[5'h7][17:16];
        metaAll_s2_14_prefetch = _RANDOM[5'h7][18];
        metaAll_s2_15_dirty = _RANDOM[5'h7][19];
        metaAll_s2_15_state = _RANDOM[5'h7][21:20];
        metaAll_s2_15_clientStates_0 = _RANDOM[5'h7][23:22];
        metaAll_s2_15_clientStates_1 = _RANDOM[5'h7][25:24];
        metaAll_s2_15_prefetch = _RANDOM[5'h7][26];
        tagAll_s2_0 = {_RANDOM[5'h7][31:27], _RANDOM[5'h8][10:0]};
        tagAll_s2_1 = _RANDOM[5'h8][26:11];
        tagAll_s2_2 = {_RANDOM[5'h8][31:27], _RANDOM[5'h9][10:0]};
        tagAll_s2_3 = _RANDOM[5'h9][26:11];
        tagAll_s2_4 = {_RANDOM[5'h9][31:27], _RANDOM[5'hA][10:0]};
        tagAll_s2_5 = _RANDOM[5'hA][26:11];
        tagAll_s2_6 = {_RANDOM[5'hA][31:27], _RANDOM[5'hB][10:0]};
        tagAll_s2_7 = _RANDOM[5'hB][26:11];
        tagAll_s2_8 = {_RANDOM[5'hB][31:27], _RANDOM[5'hC][10:0]};
        tagAll_s2_9 = _RANDOM[5'hC][26:11];
        tagAll_s2_10 = {_RANDOM[5'hC][31:27], _RANDOM[5'hD][10:0]};
        tagAll_s2_11 = _RANDOM[5'hD][26:11];
        tagAll_s2_12 = {_RANDOM[5'hD][31:27], _RANDOM[5'hE][10:0]};
        tagAll_s2_13 = _RANDOM[5'hE][26:11];
        tagAll_s2_14 = {_RANDOM[5'hE][31:27], _RANDOM[5'hF][10:0]};
        tagAll_s2_15 = _RANDOM[5'hF][26:11];
        errorAll_s2_0 = _RANDOM[5'hF][27];
        errorAll_s2_1 = _RANDOM[5'hF][28];
        errorAll_s2_2 = _RANDOM[5'hF][29];
        errorAll_s2_3 = _RANDOM[5'hF][30];
        errorAll_s2_4 = _RANDOM[5'hF][31];
        errorAll_s2_5 = _RANDOM[5'h10][0];
        errorAll_s2_6 = _RANDOM[5'h10][1];
        errorAll_s2_7 = _RANDOM[5'h10][2];
        errorAll_s2_8 = _RANDOM[5'h10][3];
        errorAll_s2_9 = _RANDOM[5'h10][4];
        errorAll_s2_10 = _RANDOM[5'h10][5];
        errorAll_s2_11 = _RANDOM[5'h10][6];
        errorAll_s2_12 = _RANDOM[5'h10][7];
        errorAll_s2_13 = _RANDOM[5'h10][8];
        errorAll_s2_14 = _RANDOM[5'h10][9];
        errorAll_s2_15 = _RANDOM[5'h10][10];
        resetMask = _RANDOM[5'h10][11];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        resetFinish = 1'h0;
        resetIdx = 12'hFFF;
  ...
  ClkDiv2SRAMTemplate_43 metaArray (
    ...
    .io_w_req_bits_data_0_dirty           (_GEN_9),
    .io_w_req_bits_data_0_state           (_GEN_10),
    .io_w_req_bits_data_0_clientStates_0  (_GEN_11),
    .io_w_req_bits_data_0_clientStates_1  (_GEN_12),
    .io_w_req_bits_data_0_prefetch        (_GEN_13),
    .io_w_req_bits_data_1_dirty           (_GEN_9),
    .io_w_req_bits_data_1_state           (_GEN_10),
    .io_w_req_bits_data_1_clientStates_0  (_GEN_11),
    .io_w_req_bits_data_1_clientStates_1  (_GEN_12),
    .io_w_req_bits_data_1_prefetch        (_GEN_13),
    .io_w_req_bits_data_2_dirty           (_GEN_9),
    .io_w_req_bits_data_2_state           (_GEN_10),
    .io_w_req_bits_data_2_clientStates_0  (_GEN_11),
    .io_w_req_bits_data_2_clientStates_1  (_GEN_12),
    .io_w_req_bits_data_2_prefetch        (_GEN_13),
    .io_w_req_bits_data_3_dirty           (_GEN_9),
    .io_w_req_bits_data_3_state           (_GEN_10),
    .io_w_req_bits_data_3_clientStates_0  (_GEN_11),
    .io_w_req_bits_data_3_clientStates_1  (_GEN_12),
    .io_w_req_bits_data_3_prefetch        (_GEN_13),
    .io_w_req_bits_data_4_dirty           (_GEN_9),
    .io_w_req_bits_data_4_state           (_GEN_10),
    .io_w_req_bits_data_4_clientStates_0  (_GEN_11),
    .io_w_req_bits_data_4_clientStates_1  (_GEN_12),
    .io_w_req_bits_data_4_prefetch        (_GEN_13),
    .io_w_req_bits_data_5_dirty           (_GEN_9),
    .io_w_req_bits_data_5_state           (_GEN_10),
    .io_w_req_bits_data_5_clientStates_0  (_GEN_11),
    .io_w_req_bits_data_5_clientStates_1  (_GEN_12),
    .io_w_req_bits_data_5_prefetch        (_GEN_13),
    .io_w_req_bits_data_6_dirty           (_GEN_9),
    .io_w_req_bits_data_6_state           (_GEN_10),
    .io_w_req_bits_data_6_clientStates_0  (_GEN_11),
    .io_w_req_bits_data_6_clientStates_1  (_GEN_12),
    .io_w_req_bits_data_6_prefetch        (_GEN_13),
    .io_w_req_bits_data_7_dirty           (_GEN_9),
    .io_w_req_bits_data_7_state           (_GEN_10),
    .io_w_req_bits_data_7_clientStates_0  (_GEN_11),
    .io_w_req_bits_data_7_clientStates_1  (_GEN_12),
    .io_w_req_bits_data_7_prefetch        (_GEN_13),
    .io_w_req_bits_data_8_dirty           (_GEN_9),
    .io_w_req_bits_data_8_state           (_GEN_10),
    .io_w_req_bits_data_8_clientStates_0  (_GEN_11),
    .io_w_req_bits_data_8_clientStates_1  (_GEN_12),
    .io_w_req_bits_data_8_prefetch        (_GEN_13),
    .io_w_req_bits_data_9_dirty           (_GEN_9),
    .io_w_req_bits_data_9_state           (_GEN_10),
    .io_w_req_bits_data_9_clientStates_0  (_GEN_11),
    .io_w_req_bits_data_9_clientStates_1  (_GEN_12),
    .io_w_req_bits_data_9_prefetch        (_GEN_13),
    .io_w_req_bits_data_10_dirty          (_GEN_9),
    .io_w_req_bits_data_10_state          (_GEN_10),
    .io_w_req_bits_data_10_clientStates_0 (_GEN_11),
    .io_w_req_bits_data_10_clientStates_1 (_GEN_12),
    .io_w_req_bits_data_10_prefetch       (_GEN_13),
    .io_w_req_bits_data_11_dirty          (_GEN_9),
    .io_w_req_bits_data_11_state          (_GEN_10),
    .io_w_req_bits_data_11_clientStates_0 (_GEN_11),
    .io_w_req_bits_data_11_clientStates_1 (_GEN_12),
    .io_w_req_bits_data_11_prefetch       (_GEN_13),
    .io_w_req_bits_data_12_dirty          (_GEN_9),
    .io_w_req_bits_data_12_state          (_GEN_10),
    .io_w_req_bits_data_12_clientStates_0 (_GEN_11),
    .io_w_req_bits_data_12_clientStates_1 (_GEN_12),
    .io_w_req_bits_data_12_prefetch       (_GEN_13),
    .io_w_req_bits_data_13_dirty          (_GEN_9),
    .io_w_req_bits_data_13_state          (_GEN_10),
    .io_w_req_bits_data_13_clientStates_0 (_GEN_11),
    .io_w_req_bits_data_13_clientStates_1 (_GEN_12),
    .io_w_req_bits_data_13_prefetch       (_GEN_13),
    .io_w_req_bits_data_14_dirty          (_GEN_9),
    .io_w_req_bits_data_14_state          (_GEN_10),
    .io_w_req_bits_data_14_clientStates_0 (_GEN_11),
    .io_w_req_bits_data_14_clientStates_1 (_GEN_12),
    .io_w_req_bits_data_14_prefetch       (_GEN_13),
    .io_w_req_bits_data_15_dirty          (_GEN_9),
    .io_w_req_bits_data_15_state          (_GEN_10),
    .io_w_req_bits_data_15_clientStates_0 (_GEN_11),
    .io_w_req_bits_data_15_clientStates_1 (_GEN_12),
    .io_w_req_bits_data_15_prefetch       (_GEN_13),
  ...
  SRAMTemplate_321 repl_state_replacer_sram (
    .clock                (clock),
    .reset                (reset),
    .io_r_req_valid       (_metas_T),
    .io_r_req_bits_setIdx (io_read_bits_set),
  ...
  assign io_resp_bits_tag = _GEN_7[way_s2];
  ...
  assign io_resp_bits_dir_prefetch = _GEN_6[way_s2];
  assign io_resp_bits_error = hit_s2 & _GEN_8[way_s2];
endmodule

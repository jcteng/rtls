...
module Directory_8(
  ...
  input  [11:0] io_read_bits_source,
  ...
  output [16:0] io_result_bits_clients_tag,
  output [3:0]  io_result_bits_clients_way,
  output        io_result_bits_clients_error,
  output [11:0] io_result_bits_sourceId,
  ...
  input  [10:0] io_clientDirWReq_bits_set,
  ...
  input  [10:0] io_clientTagWreq_bits_set,
  input  [3:0]  io_clientTagWreq_bits_way,
  input  [16:0] io_clientTagWreq_bits_tag
);
  ...
  reg         reqValidReg;
  reg  [15:0] reqIdOHReg;
  reg  [11:0] sourceIdReg_r;
  reg  [11:0] sourceIdReg;
  reg  [11:0] setReg_r;
  reg  [11:0] setReg;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        sourceIdReg_r = _RANDOM[3'h2][29:18];
        sourceIdReg = {_RANDOM[3'h2][31:30], _RANDOM[3'h3][9:0]};
        setReg_r = _RANDOM[3'h3][21:10];
        setReg = {_RANDOM[3'h3][31:22], _RANDOM[3'h4][1:0]};
        replacerInfoReg_r_channel = _RANDOM[3'h4][4:2];
        replacerInfoReg_r_opcode = _RANDOM[3'h4][7:5];
        replacerInfoReg_channel = _RANDOM[3'h4][14:12];
        replacerInfoReg_opcode = _RANDOM[3'h4][17:15];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        readyMask = 1'h0;
        reqValidReg = 1'h0;
  ...
  SubDirectory clientDir (
    ...
    .io_read_bits_tag          ({io_read_bits_tag, io_read_bits_set[11]}),
    .io_read_bits_set          (io_read_bits_set[10:0]),
  ...
  assign io_result_bits_clients_error =
    (|{io_result_bits_clients_states_0_hit_0, io_result_bits_clients_states_1_hit_0})
    & _clientDir_io_resp_bits_error;

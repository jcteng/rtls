...
module SliceCtrl(
  ...
  output [10:0]  io_c_dir_w_bits_set,
  ...
  output [10:0]  io_c_tag_w_bits_set,
  output [3:0]   io_c_tag_w_bits_way,
  output [16:0]  io_c_tag_w_bits_tag,
  ...
  input  [16:0]  io_dir_result_bits_clients_tag,
  ...
  always @(posedge clock) begin
    ...
    if (data_wen & ~w_counter) begin
      ...
      if (io_dir_result_valid) begin
        if (req_reg_cmd == 8'h3)
          req_reg_data_0 <=
            {56'h0, io_dir_result_bits_self_tag[6:0], io_dir_result_bits_self_error};
          ...
          req_reg_data_0 <= {47'h0, io_dir_result_bits_clients_tag};
        else if (_GEN)
  ...
  assign io_s_dir_w_bits_data_dirty = req_reg_dir[7];
  assign io_s_dir_w_bits_data_state = req_reg_dir[6:5];
  ...
  assign io_c_dir_w_bits_set = req_reg_set[10:0];
  ...
  assign io_c_tag_w_bits_set = req_reg_set[10:0];
  assign io_c_tag_w_bits_way = req_reg_way[3:0];
  assign io_c_tag_w_bits_tag = req_reg_tag[16:0];

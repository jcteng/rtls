...
module Queue1_RegMapperInput(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = {_RANDOM[2'h0][31:1], _RANDOM[2'h1], _RANDOM[2'h2], _RANDOM[2'h3][6:0]};
        full = _RANDOM[2'h0][0];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        full = 1'h0;
  ...
  assign io_deq_bits_extra_tlrr_extra_source = ram[99:96];
  assign io_deq_bits_extra_tlrr_extra_size = ram[101:100];
endmodule

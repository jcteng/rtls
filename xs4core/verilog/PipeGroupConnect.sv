  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        dataVec_0_robIdx_flag = _RANDOM[8'h12][27];
        dataVec_0_robIdx_value = {_RANDOM[8'h12][31:28], _RANDOM[8'h13][3:0]};
        dataVec_0_instrSize = _RANDOM[8'h13][6:4];
        dataVec_0_dirtyFs = _RANDOM[8'h13][7];
        dataVec_0_dirtyVs = _RANDOM[8'h13][8];
        dataVec_0_eliminatedMove = _RANDOM[8'h13][9];
        dataVec_0_snapshot = _RANDOM[8'h13][10];
        dataVec_0_storeSetHit = _RANDOM[8'h25][12];
        dataVec_0_loadWaitStrict = _RANDOM[8'h25][23];
        dataVec_0_ssid = _RANDOM[8'h25][28:24];
        dataVec_0_numLsElem = _RANDOM[8'h26][18:14];
        dataVec_1_instr = {_RANDOM[8'h26][31:19], _RANDOM[8'h27][18:0]};
        dataVec_1_exceptionVec_0 = _RANDOM[8'h29][6];
        dataVec_1_exceptionVec_1 = _RANDOM[8'h29][7];
        dataVec_1_exceptionVec_2 = _RANDOM[8'h29][8];
        dataVec_1_exceptionVec_3 = _RANDOM[8'h29][9];
        dataVec_1_exceptionVec_4 = _RANDOM[8'h29][10];
        dataVec_1_exceptionVec_5 = _RANDOM[8'h29][11];
        dataVec_1_exceptionVec_6 = _RANDOM[8'h29][12];
        dataVec_1_exceptionVec_7 = _RANDOM[8'h29][13];
        dataVec_1_exceptionVec_8 = _RANDOM[8'h29][14];
        dataVec_1_exceptionVec_9 = _RANDOM[8'h29][15];
        dataVec_1_exceptionVec_10 = _RANDOM[8'h29][16];
        dataVec_1_exceptionVec_11 = _RANDOM[8'h29][17];
        dataVec_1_exceptionVec_12 = _RANDOM[8'h29][18];
        dataVec_1_exceptionVec_13 = _RANDOM[8'h29][19];
        dataVec_1_exceptionVec_14 = _RANDOM[8'h29][20];
        dataVec_1_exceptionVec_15 = _RANDOM[8'h29][21];
        dataVec_1_exceptionVec_16 = _RANDOM[8'h29][22];
        dataVec_1_exceptionVec_17 = _RANDOM[8'h29][23];
        dataVec_1_exceptionVec_18 = _RANDOM[8'h29][24];
        dataVec_1_exceptionVec_19 = _RANDOM[8'h29][25];
        dataVec_1_exceptionVec_20 = _RANDOM[8'h29][26];
        dataVec_1_exceptionVec_21 = _RANDOM[8'h29][27];
        dataVec_1_exceptionVec_22 = _RANDOM[8'h29][28];
        dataVec_1_exceptionVec_23 = _RANDOM[8'h29][29];
        dataVec_1_hasException = _RANDOM[8'h29][30];
        dataVec_1_trigger_frontendHit_0 = _RANDOM[8'h29][31];
        dataVec_1_trigger_frontendHit_1 = _RANDOM[8'h2A][0];
        dataVec_1_trigger_frontendHit_2 = _RANDOM[8'h2A][1];
        dataVec_1_trigger_frontendHit_3 = _RANDOM[8'h2A][2];
        dataVec_1_trigger_frontendCanFire_0 = _RANDOM[8'h2A][3];
        dataVec_1_trigger_frontendCanFire_1 = _RANDOM[8'h2A][4];
        dataVec_1_trigger_frontendCanFire_2 = _RANDOM[8'h2A][5];
        dataVec_1_trigger_frontendCanFire_3 = _RANDOM[8'h2A][6];
        dataVec_1_preDecodeInfo_valid = _RANDOM[8'h2A][15];
        dataVec_1_preDecodeInfo_isRVC = _RANDOM[8'h2A][16];
        dataVec_1_preDecodeInfo_brType = _RANDOM[8'h2A][18:17];
        dataVec_1_preDecodeInfo_isCall = _RANDOM[8'h2A][19];
        dataVec_1_preDecodeInfo_isRet = _RANDOM[8'h2A][20];
        dataVec_1_pred_taken = _RANDOM[8'h2A][21];
        dataVec_1_crossPageIPFFix = _RANDOM[8'h2A][22];
        dataVec_1_ftqPtr_flag = _RANDOM[8'h2A][23];
        dataVec_1_ftqPtr_value = _RANDOM[8'h2A][29:24];
        dataVec_1_ftqOffset = {_RANDOM[8'h2A][31:30], _RANDOM[8'h2B][1:0]};
        dataVec_1_srcType_0 = _RANDOM[8'h2B][5:2];
        dataVec_1_srcType_1 = _RANDOM[8'h2B][9:6];
        dataVec_1_srcType_2 = _RANDOM[8'h2B][13:10];
        dataVec_1_srcType_3 = _RANDOM[8'h2B][17:14];
        dataVec_1_srcType_4 = _RANDOM[8'h2B][21:18];
        dataVec_1_ldest = _RANDOM[8'h2B][27:22];
        dataVec_1_fuType = {_RANDOM[8'h2B][31:28], _RANDOM[8'h2C][30:0]};
        dataVec_1_fuOpType = {_RANDOM[8'h2C][31], _RANDOM[8'h2D][7:0]};
        dataVec_1_rfWen = _RANDOM[8'h2D][8];
        dataVec_1_fpWen = _RANDOM[8'h2D][9];
        dataVec_1_vecWen = _RANDOM[8'h2D][10];
        dataVec_1_v0Wen = _RANDOM[8'h2D][11];
        dataVec_1_vlWen = _RANDOM[8'h2D][12];
        dataVec_1_waitForward = _RANDOM[8'h2D][14];
        dataVec_1_blockBackward = _RANDOM[8'h2D][15];
        dataVec_1_flushPipe = _RANDOM[8'h2D][16];
        dataVec_1_selImm = _RANDOM[8'h2D][21:18];
        dataVec_1_imm = {_RANDOM[8'h2D][31:22], _RANDOM[8'h2E][21:0]};
        dataVec_1_fpu_typeTagOut = _RANDOM[8'h2E][24];
        dataVec_1_fpu_wflags = _RANDOM[8'h2E][26];
        dataVec_1_fpu_typ = _RANDOM[8'h2F][2:1];
        dataVec_1_fpu_rm = _RANDOM[8'h2F][8:6];
        dataVec_1_vpu_vill = _RANDOM[8'h2F][9];
        dataVec_1_vpu_vma = _RANDOM[8'h2F][10];
        dataVec_1_vpu_vta = _RANDOM[8'h2F][11];
        dataVec_1_vpu_vsew = _RANDOM[8'h2F][13:12];
        dataVec_1_vpu_vlmul = _RANDOM[8'h2F][16:14];
        dataVec_1_vpu_specVill = _RANDOM[8'h2F][17];
        dataVec_1_vpu_specVma = _RANDOM[8'h2F][18];
        dataVec_1_vpu_specVta = _RANDOM[8'h2F][19];
        dataVec_1_vpu_specVsew = _RANDOM[8'h2F][21:20];
        dataVec_1_vpu_specVlmul = _RANDOM[8'h2F][24:22];
        dataVec_1_vpu_vm = _RANDOM[8'h2F][25];
        dataVec_1_vpu_vstart = {_RANDOM[8'h2F][31:26], _RANDOM[8'h30][1:0]};
        dataVec_1_vpu_fpu_isFoldTo1_2 = _RANDOM[8'h30][9];
        dataVec_1_vpu_fpu_isFoldTo1_4 = _RANDOM[8'h30][10];
        dataVec_1_vpu_fpu_isFoldTo1_8 = _RANDOM[8'h30][11];
        dataVec_1_vpu_vmask =
          {_RANDOM[8'h30][31:22],
           _RANDOM[8'h31],
           _RANDOM[8'h32],
           _RANDOM[8'h33],
           _RANDOM[8'h34][21:0]};
        dataVec_1_vpu_nf = {_RANDOM[8'h34][31:30], _RANDOM[8'h35][0]};
        dataVec_1_vpu_veew = _RANDOM[8'h35][2:1];
        dataVec_1_vpu_isExt = _RANDOM[8'h35][4];
        dataVec_1_vpu_isNarrow = _RANDOM[8'h35][5];
        dataVec_1_vpu_isDstMask = _RANDOM[8'h35][6];
        dataVec_1_vpu_isOpMask = _RANDOM[8'h35][7];
        dataVec_1_vpu_isDependOldvd = _RANDOM[8'h35][9];
        dataVec_1_vpu_isWritePartVd = _RANDOM[8'h35][10];
        dataVec_1_vlsInstr = _RANDOM[8'h35][11];
        dataVec_1_wfflags = _RANDOM[8'h35][12];
        dataVec_1_isMove = _RANDOM[8'h35][13];
        dataVec_1_uopIdx = _RANDOM[8'h35][20:14];
        dataVec_1_isVset = _RANDOM[8'h35][21];
        dataVec_1_firstUop = _RANDOM[8'h35][22];
        dataVec_1_lastUop = _RANDOM[8'h35][23];
        dataVec_1_numWB = {_RANDOM[8'h35][31], _RANDOM[8'h36][5:0]};
        dataVec_1_commitType = _RANDOM[8'h36][8:6];
        dataVec_1_psrc_0 = _RANDOM[8'h37][19:12];
        dataVec_1_psrc_1 = _RANDOM[8'h37][27:20];
        dataVec_1_psrc_2 = {_RANDOM[8'h37][31:28], _RANDOM[8'h38][3:0]};
        dataVec_1_psrc_3 = _RANDOM[8'h38][11:4];
        dataVec_1_psrc_4 = _RANDOM[8'h38][19:12];
        dataVec_1_pdest = _RANDOM[8'h38][27:20];
        dataVec_1_robIdx_flag = _RANDOM[8'h39][8];
        dataVec_1_robIdx_value = _RANDOM[8'h39][16:9];
        dataVec_1_instrSize = _RANDOM[8'h39][19:17];
        dataVec_1_dirtyFs = _RANDOM[8'h39][20];
        dataVec_1_dirtyVs = _RANDOM[8'h39][21];
        dataVec_1_eliminatedMove = _RANDOM[8'h39][22];
        dataVec_1_storeSetHit = _RANDOM[8'h4B][25];
        dataVec_1_loadWaitStrict = _RANDOM[8'h4C][4];
        dataVec_1_ssid = _RANDOM[8'h4C][9:5];
        dataVec_1_numLsElem = _RANDOM[8'h4C][31:27];
        dataVec_2_instr = _RANDOM[8'h4D];
        dataVec_2_exceptionVec_0 = _RANDOM[8'h4F][19];
        dataVec_2_exceptionVec_1 = _RANDOM[8'h4F][20];
        dataVec_2_exceptionVec_2 = _RANDOM[8'h4F][21];
        dataVec_2_exceptionVec_3 = _RANDOM[8'h4F][22];
        dataVec_2_exceptionVec_4 = _RANDOM[8'h4F][23];
        dataVec_2_exceptionVec_5 = _RANDOM[8'h4F][24];
        dataVec_2_exceptionVec_6 = _RANDOM[8'h4F][25];
        dataVec_2_exceptionVec_7 = _RANDOM[8'h4F][26];
        dataVec_2_exceptionVec_8 = _RANDOM[8'h4F][27];
        dataVec_2_exceptionVec_9 = _RANDOM[8'h4F][28];
        dataVec_2_exceptionVec_10 = _RANDOM[8'h4F][29];
        dataVec_2_exceptionVec_11 = _RANDOM[8'h4F][30];
        dataVec_2_exceptionVec_12 = _RANDOM[8'h4F][31];
        dataVec_2_exceptionVec_13 = _RANDOM[8'h50][0];
        dataVec_2_exceptionVec_14 = _RANDOM[8'h50][1];
        dataVec_2_exceptionVec_15 = _RANDOM[8'h50][2];
        dataVec_2_exceptionVec_16 = _RANDOM[8'h50][3];
        dataVec_2_exceptionVec_17 = _RANDOM[8'h50][4];
        dataVec_2_exceptionVec_18 = _RANDOM[8'h50][5];
        dataVec_2_exceptionVec_19 = _RANDOM[8'h50][6];
        dataVec_2_exceptionVec_20 = _RANDOM[8'h50][7];
        dataVec_2_exceptionVec_21 = _RANDOM[8'h50][8];
        dataVec_2_exceptionVec_22 = _RANDOM[8'h50][9];
        dataVec_2_exceptionVec_23 = _RANDOM[8'h50][10];
        dataVec_2_hasException = _RANDOM[8'h50][11];
        dataVec_2_trigger_frontendHit_0 = _RANDOM[8'h50][12];
        dataVec_2_trigger_frontendHit_1 = _RANDOM[8'h50][13];
        dataVec_2_trigger_frontendHit_2 = _RANDOM[8'h50][14];
        dataVec_2_trigger_frontendHit_3 = _RANDOM[8'h50][15];
        dataVec_2_trigger_frontendCanFire_0 = _RANDOM[8'h50][16];
        dataVec_2_trigger_frontendCanFire_1 = _RANDOM[8'h50][17];
        dataVec_2_trigger_frontendCanFire_2 = _RANDOM[8'h50][18];
        dataVec_2_trigger_frontendCanFire_3 = _RANDOM[8'h50][19];
        dataVec_2_preDecodeInfo_valid = _RANDOM[8'h50][28];
        dataVec_2_preDecodeInfo_isRVC = _RANDOM[8'h50][29];
        dataVec_2_preDecodeInfo_brType = _RANDOM[8'h50][31:30];
        dataVec_2_preDecodeInfo_isCall = _RANDOM[8'h51][0];
        dataVec_2_preDecodeInfo_isRet = _RANDOM[8'h51][1];
        dataVec_2_pred_taken = _RANDOM[8'h51][2];
        dataVec_2_crossPageIPFFix = _RANDOM[8'h51][3];
        dataVec_2_ftqPtr_flag = _RANDOM[8'h51][4];
        dataVec_2_ftqPtr_value = _RANDOM[8'h51][10:5];
        dataVec_2_ftqOffset = _RANDOM[8'h51][14:11];
        dataVec_2_srcType_0 = _RANDOM[8'h51][18:15];
        dataVec_2_srcType_1 = _RANDOM[8'h51][22:19];
        dataVec_2_srcType_2 = _RANDOM[8'h51][26:23];
        dataVec_2_srcType_3 = _RANDOM[8'h51][30:27];
        dataVec_2_srcType_4 = {_RANDOM[8'h51][31], _RANDOM[8'h52][2:0]};
        dataVec_2_ldest = _RANDOM[8'h52][8:3];
        dataVec_2_fuType = {_RANDOM[8'h52][31:9], _RANDOM[8'h53][11:0]};
        dataVec_2_fuOpType = _RANDOM[8'h53][20:12];
        dataVec_2_rfWen = _RANDOM[8'h53][21];
        dataVec_2_fpWen = _RANDOM[8'h53][22];
        dataVec_2_vecWen = _RANDOM[8'h53][23];
        dataVec_2_v0Wen = _RANDOM[8'h53][24];
        dataVec_2_vlWen = _RANDOM[8'h53][25];
        dataVec_2_waitForward = _RANDOM[8'h53][27];
        dataVec_2_blockBackward = _RANDOM[8'h53][28];
        dataVec_2_flushPipe = _RANDOM[8'h53][29];
        dataVec_2_selImm = {_RANDOM[8'h53][31], _RANDOM[8'h54][2:0]};
        dataVec_2_imm = {_RANDOM[8'h54][31:3], _RANDOM[8'h55][2:0]};
        dataVec_2_fpu_typeTagOut = _RANDOM[8'h55][5];
        dataVec_2_fpu_wflags = _RANDOM[8'h55][7];
        dataVec_2_fpu_typ = _RANDOM[8'h55][15:14];
        dataVec_2_fpu_rm = _RANDOM[8'h55][21:19];
        dataVec_2_vpu_vill = _RANDOM[8'h55][22];
        dataVec_2_vpu_vma = _RANDOM[8'h55][23];
        dataVec_2_vpu_vta = _RANDOM[8'h55][24];
        dataVec_2_vpu_vsew = _RANDOM[8'h55][26:25];
        dataVec_2_vpu_vlmul = _RANDOM[8'h55][29:27];
        dataVec_2_vpu_specVill = _RANDOM[8'h55][30];
        dataVec_2_vpu_specVma = _RANDOM[8'h55][31];
        dataVec_2_vpu_specVta = _RANDOM[8'h56][0];
        dataVec_2_vpu_specVsew = _RANDOM[8'h56][2:1];
        dataVec_2_vpu_specVlmul = _RANDOM[8'h56][5:3];
        dataVec_2_vpu_vm = _RANDOM[8'h56][6];
        dataVec_2_vpu_vstart = _RANDOM[8'h56][14:7];
        dataVec_2_vpu_fpu_isFoldTo1_2 = _RANDOM[8'h56][22];
        dataVec_2_vpu_fpu_isFoldTo1_4 = _RANDOM[8'h56][23];
        dataVec_2_vpu_fpu_isFoldTo1_8 = _RANDOM[8'h56][24];
        dataVec_2_vpu_vmask =
          {_RANDOM[8'h57][31:3],
           _RANDOM[8'h58],
           _RANDOM[8'h59],
           _RANDOM[8'h5A],
           _RANDOM[8'h5B][2:0]};
        dataVec_2_vpu_nf = _RANDOM[8'h5B][13:11];
        dataVec_2_vpu_veew = _RANDOM[8'h5B][15:14];
        dataVec_2_vpu_isExt = _RANDOM[8'h5B][17];
        dataVec_2_vpu_isNarrow = _RANDOM[8'h5B][18];
        dataVec_2_vpu_isDstMask = _RANDOM[8'h5B][19];
        dataVec_2_vpu_isOpMask = _RANDOM[8'h5B][20];
        dataVec_2_vpu_isDependOldvd = _RANDOM[8'h5B][22];
        dataVec_2_vpu_isWritePartVd = _RANDOM[8'h5B][23];
        dataVec_2_vlsInstr = _RANDOM[8'h5B][24];
        dataVec_2_wfflags = _RANDOM[8'h5B][25];
        dataVec_2_isMove = _RANDOM[8'h5B][26];
        dataVec_2_uopIdx = {_RANDOM[8'h5B][31:27], _RANDOM[8'h5C][1:0]};
        dataVec_2_isVset = _RANDOM[8'h5C][2];
        dataVec_2_firstUop = _RANDOM[8'h5C][3];
        dataVec_2_lastUop = _RANDOM[8'h5C][4];
        dataVec_2_numWB = _RANDOM[8'h5C][18:12];
        dataVec_2_commitType = _RANDOM[8'h5C][21:19];
        dataVec_2_psrc_0 = {_RANDOM[8'h5D][31:25], _RANDOM[8'h5E][0]};
        dataVec_2_psrc_1 = _RANDOM[8'h5E][8:1];
        dataVec_2_psrc_2 = _RANDOM[8'h5E][16:9];
        dataVec_2_psrc_3 = _RANDOM[8'h5E][24:17];
        dataVec_2_psrc_4 = {_RANDOM[8'h5E][31:25], _RANDOM[8'h5F][0]};
        dataVec_2_pdest = _RANDOM[8'h5F][8:1];
        dataVec_2_robIdx_flag = _RANDOM[8'h5F][21];
        dataVec_2_robIdx_value = _RANDOM[8'h5F][29:22];
        dataVec_2_instrSize = {_RANDOM[8'h5F][31:30], _RANDOM[8'h60][0]};
        dataVec_2_dirtyFs = _RANDOM[8'h60][1];
        dataVec_2_dirtyVs = _RANDOM[8'h60][2];
        dataVec_2_eliminatedMove = _RANDOM[8'h60][3];
        dataVec_2_storeSetHit = _RANDOM[8'h72][6];
        dataVec_2_loadWaitStrict = _RANDOM[8'h72][17];
        dataVec_2_ssid = _RANDOM[8'h72][22:18];
        dataVec_2_numLsElem = _RANDOM[8'h73][12:8];
        dataVec_3_instr = {_RANDOM[8'h73][31:13], _RANDOM[8'h74][12:0]};
        dataVec_3_exceptionVec_0 = _RANDOM[8'h76][0];
        dataVec_3_exceptionVec_1 = _RANDOM[8'h76][1];
        dataVec_3_exceptionVec_2 = _RANDOM[8'h76][2];
        dataVec_3_exceptionVec_3 = _RANDOM[8'h76][3];
        dataVec_3_exceptionVec_4 = _RANDOM[8'h76][4];
        dataVec_3_exceptionVec_5 = _RANDOM[8'h76][5];
        dataVec_3_exceptionVec_6 = _RANDOM[8'h76][6];
        dataVec_3_exceptionVec_7 = _RANDOM[8'h76][7];
        dataVec_3_exceptionVec_8 = _RANDOM[8'h76][8];
        dataVec_3_exceptionVec_9 = _RANDOM[8'h76][9];
        dataVec_3_exceptionVec_10 = _RANDOM[8'h76][10];
        dataVec_3_exceptionVec_11 = _RANDOM[8'h76][11];
        dataVec_3_exceptionVec_12 = _RANDOM[8'h76][12];
        dataVec_3_exceptionVec_13 = _RANDOM[8'h76][13];
        dataVec_3_exceptionVec_14 = _RANDOM[8'h76][14];
        dataVec_3_exceptionVec_15 = _RANDOM[8'h76][15];
        dataVec_3_exceptionVec_16 = _RANDOM[8'h76][16];
        dataVec_3_exceptionVec_17 = _RANDOM[8'h76][17];
        dataVec_3_exceptionVec_18 = _RANDOM[8'h76][18];
        dataVec_3_exceptionVec_19 = _RANDOM[8'h76][19];
        dataVec_3_exceptionVec_20 = _RANDOM[8'h76][20];
        dataVec_3_exceptionVec_21 = _RANDOM[8'h76][21];
        dataVec_3_exceptionVec_22 = _RANDOM[8'h76][22];
        dataVec_3_exceptionVec_23 = _RANDOM[8'h76][23];
        dataVec_3_hasException = _RANDOM[8'h76][24];
        dataVec_3_trigger_frontendHit_0 = _RANDOM[8'h76][25];
        dataVec_3_trigger_frontendHit_1 = _RANDOM[8'h76][26];
        dataVec_3_trigger_frontendHit_2 = _RANDOM[8'h76][27];
        dataVec_3_trigger_frontendHit_3 = _RANDOM[8'h76][28];
        dataVec_3_trigger_frontendCanFire_0 = _RANDOM[8'h76][29];
        dataVec_3_trigger_frontendCanFire_1 = _RANDOM[8'h76][30];
        dataVec_3_trigger_frontendCanFire_2 = _RANDOM[8'h76][31];
        dataVec_3_trigger_frontendCanFire_3 = _RANDOM[8'h77][0];
        dataVec_3_preDecodeInfo_valid = _RANDOM[8'h77][9];
        dataVec_3_preDecodeInfo_isRVC = _RANDOM[8'h77][10];
        dataVec_3_preDecodeInfo_brType = _RANDOM[8'h77][12:11];
        dataVec_3_preDecodeInfo_isCall = _RANDOM[8'h77][13];
        dataVec_3_preDecodeInfo_isRet = _RANDOM[8'h77][14];
        dataVec_3_pred_taken = _RANDOM[8'h77][15];
        dataVec_3_crossPageIPFFix = _RANDOM[8'h77][16];
        dataVec_3_ftqPtr_flag = _RANDOM[8'h77][17];
        dataVec_3_ftqPtr_value = _RANDOM[8'h77][23:18];
        dataVec_3_ftqOffset = _RANDOM[8'h77][27:24];
        dataVec_3_srcType_0 = _RANDOM[8'h77][31:28];
        dataVec_3_srcType_1 = _RANDOM[8'h78][3:0];
        dataVec_3_srcType_2 = _RANDOM[8'h78][7:4];
        dataVec_3_srcType_3 = _RANDOM[8'h78][11:8];
        dataVec_3_srcType_4 = _RANDOM[8'h78][15:12];
        dataVec_3_ldest = _RANDOM[8'h78][21:16];
        dataVec_3_fuType = {_RANDOM[8'h78][31:22], _RANDOM[8'h79][24:0]};
        dataVec_3_fuOpType = {_RANDOM[8'h79][31:25], _RANDOM[8'h7A][1:0]};
        dataVec_3_rfWen = _RANDOM[8'h7A][2];
        dataVec_3_fpWen = _RANDOM[8'h7A][3];
        dataVec_3_vecWen = _RANDOM[8'h7A][4];
        dataVec_3_v0Wen = _RANDOM[8'h7A][5];
        dataVec_3_vlWen = _RANDOM[8'h7A][6];
        dataVec_3_waitForward = _RANDOM[8'h7A][8];
        dataVec_3_blockBackward = _RANDOM[8'h7A][9];
        dataVec_3_flushPipe = _RANDOM[8'h7A][10];
        dataVec_3_selImm = _RANDOM[8'h7A][15:12];
        dataVec_3_imm = {_RANDOM[8'h7A][31:16], _RANDOM[8'h7B][15:0]};
        dataVec_3_fpu_typeTagOut = _RANDOM[8'h7B][18];
        dataVec_3_fpu_wflags = _RANDOM[8'h7B][20];
        dataVec_3_fpu_typ = _RANDOM[8'h7B][28:27];
        dataVec_3_fpu_rm = _RANDOM[8'h7C][2:0];
        dataVec_3_vpu_vill = _RANDOM[8'h7C][3];
        dataVec_3_vpu_vma = _RANDOM[8'h7C][4];
        dataVec_3_vpu_vta = _RANDOM[8'h7C][5];
        dataVec_3_vpu_vsew = _RANDOM[8'h7C][7:6];
        dataVec_3_vpu_vlmul = _RANDOM[8'h7C][10:8];
        dataVec_3_vpu_specVill = _RANDOM[8'h7C][11];
        dataVec_3_vpu_specVma = _RANDOM[8'h7C][12];
        dataVec_3_vpu_specVta = _RANDOM[8'h7C][13];
        dataVec_3_vpu_specVsew = _RANDOM[8'h7C][15:14];
        dataVec_3_vpu_specVlmul = _RANDOM[8'h7C][18:16];
        dataVec_3_vpu_vm = _RANDOM[8'h7C][19];
        dataVec_3_vpu_vstart = _RANDOM[8'h7C][27:20];
        dataVec_3_vpu_fpu_isFoldTo1_2 = _RANDOM[8'h7D][3];
        dataVec_3_vpu_fpu_isFoldTo1_4 = _RANDOM[8'h7D][4];
        dataVec_3_vpu_fpu_isFoldTo1_8 = _RANDOM[8'h7D][5];
        dataVec_3_vpu_vmask =
          {_RANDOM[8'h7D][31:16],
           _RANDOM[8'h7E],
           _RANDOM[8'h7F],
           _RANDOM[8'h80],
           _RANDOM[8'h81][15:0]};
        dataVec_3_vpu_nf = _RANDOM[8'h81][26:24];
        dataVec_3_vpu_veew = _RANDOM[8'h81][28:27];
        dataVec_3_vpu_isExt = _RANDOM[8'h81][30];
        dataVec_3_vpu_isNarrow = _RANDOM[8'h81][31];
        dataVec_3_vpu_isDstMask = _RANDOM[8'h82][0];
        dataVec_3_vpu_isOpMask = _RANDOM[8'h82][1];
        dataVec_3_vpu_isDependOldvd = _RANDOM[8'h82][3];
        dataVec_3_vpu_isWritePartVd = _RANDOM[8'h82][4];
        dataVec_3_vlsInstr = _RANDOM[8'h82][5];
        dataVec_3_wfflags = _RANDOM[8'h82][6];
        dataVec_3_isMove = _RANDOM[8'h82][7];
        dataVec_3_uopIdx = _RANDOM[8'h82][14:8];
        dataVec_3_isVset = _RANDOM[8'h82][15];
        dataVec_3_firstUop = _RANDOM[8'h82][16];
        dataVec_3_lastUop = _RANDOM[8'h82][17];
        dataVec_3_numWB = _RANDOM[8'h82][31:25];
        dataVec_3_commitType = _RANDOM[8'h83][2:0];
        dataVec_3_psrc_0 = _RANDOM[8'h84][13:6];
        dataVec_3_psrc_1 = _RANDOM[8'h84][21:14];
        dataVec_3_psrc_2 = _RANDOM[8'h84][29:22];
        dataVec_3_psrc_3 = {_RANDOM[8'h84][31:30], _RANDOM[8'h85][5:0]};
        dataVec_3_psrc_4 = _RANDOM[8'h85][13:6];
        dataVec_3_pdest = _RANDOM[8'h85][21:14];
        dataVec_3_robIdx_flag = _RANDOM[8'h86][2];
        dataVec_3_robIdx_value = _RANDOM[8'h86][10:3];
        dataVec_3_instrSize = _RANDOM[8'h86][13:11];
        dataVec_3_dirtyFs = _RANDOM[8'h86][14];
        dataVec_3_dirtyVs = _RANDOM[8'h86][15];
        dataVec_3_eliminatedMove = _RANDOM[8'h86][16];
        dataVec_3_storeSetHit = _RANDOM[8'h98][19];
        dataVec_3_loadWaitStrict = _RANDOM[8'h98][30];
        dataVec_3_ssid = {_RANDOM[8'h98][31], _RANDOM[8'h99][3:0]};
        dataVec_3_numLsElem = _RANDOM[8'h99][25:21];
        dataVec_4_instr = {_RANDOM[8'h99][31:26], _RANDOM[8'h9A][25:0]};
        dataVec_4_exceptionVec_0 = _RANDOM[8'h9C][13];
        dataVec_4_exceptionVec_1 = _RANDOM[8'h9C][14];
        dataVec_4_exceptionVec_2 = _RANDOM[8'h9C][15];
        dataVec_4_exceptionVec_3 = _RANDOM[8'h9C][16];
        dataVec_4_exceptionVec_4 = _RANDOM[8'h9C][17];
        dataVec_4_exceptionVec_5 = _RANDOM[8'h9C][18];
        dataVec_4_exceptionVec_6 = _RANDOM[8'h9C][19];
        dataVec_4_exceptionVec_7 = _RANDOM[8'h9C][20];
        dataVec_4_exceptionVec_8 = _RANDOM[8'h9C][21];
        dataVec_4_exceptionVec_9 = _RANDOM[8'h9C][22];
        dataVec_4_exceptionVec_10 = _RANDOM[8'h9C][23];
        dataVec_4_exceptionVec_11 = _RANDOM[8'h9C][24];
        dataVec_4_exceptionVec_12 = _RANDOM[8'h9C][25];
        dataVec_4_exceptionVec_13 = _RANDOM[8'h9C][26];
        dataVec_4_exceptionVec_14 = _RANDOM[8'h9C][27];
        dataVec_4_exceptionVec_15 = _RANDOM[8'h9C][28];
        dataVec_4_exceptionVec_16 = _RANDOM[8'h9C][29];
        dataVec_4_exceptionVec_17 = _RANDOM[8'h9C][30];
        dataVec_4_exceptionVec_18 = _RANDOM[8'h9C][31];
        dataVec_4_exceptionVec_19 = _RANDOM[8'h9D][0];
        dataVec_4_exceptionVec_20 = _RANDOM[8'h9D][1];
        dataVec_4_exceptionVec_21 = _RANDOM[8'h9D][2];
        dataVec_4_exceptionVec_22 = _RANDOM[8'h9D][3];
        dataVec_4_exceptionVec_23 = _RANDOM[8'h9D][4];
        dataVec_4_hasException = _RANDOM[8'h9D][5];
        dataVec_4_trigger_frontendHit_0 = _RANDOM[8'h9D][6];
        dataVec_4_trigger_frontendHit_1 = _RANDOM[8'h9D][7];
        dataVec_4_trigger_frontendHit_2 = _RANDOM[8'h9D][8];
        dataVec_4_trigger_frontendHit_3 = _RANDOM[8'h9D][9];
        dataVec_4_trigger_frontendCanFire_0 = _RANDOM[8'h9D][10];
        dataVec_4_trigger_frontendCanFire_1 = _RANDOM[8'h9D][11];
        dataVec_4_trigger_frontendCanFire_2 = _RANDOM[8'h9D][12];
        dataVec_4_trigger_frontendCanFire_3 = _RANDOM[8'h9D][13];
        dataVec_4_preDecodeInfo_valid = _RANDOM[8'h9D][22];
        dataVec_4_preDecodeInfo_isRVC = _RANDOM[8'h9D][23];
        dataVec_4_preDecodeInfo_brType = _RANDOM[8'h9D][25:24];
        dataVec_4_preDecodeInfo_isCall = _RANDOM[8'h9D][26];
        dataVec_4_preDecodeInfo_isRet = _RANDOM[8'h9D][27];
        dataVec_4_pred_taken = _RANDOM[8'h9D][28];
        dataVec_4_crossPageIPFFix = _RANDOM[8'h9D][29];
        dataVec_4_ftqPtr_flag = _RANDOM[8'h9D][30];
        dataVec_4_ftqPtr_value = {_RANDOM[8'h9D][31], _RANDOM[8'h9E][4:0]};
        dataVec_4_ftqOffset = _RANDOM[8'h9E][8:5];
        dataVec_4_srcType_0 = _RANDOM[8'h9E][12:9];
        dataVec_4_srcType_1 = _RANDOM[8'h9E][16:13];
        dataVec_4_srcType_2 = _RANDOM[8'h9E][20:17];
        dataVec_4_srcType_3 = _RANDOM[8'h9E][24:21];
        dataVec_4_srcType_4 = _RANDOM[8'h9E][28:25];
        dataVec_4_ldest = {_RANDOM[8'h9E][31:29], _RANDOM[8'h9F][2:0]};
        dataVec_4_fuType = {_RANDOM[8'h9F][31:3], _RANDOM[8'hA0][5:0]};
        dataVec_4_fuOpType = _RANDOM[8'hA0][14:6];
        dataVec_4_rfWen = _RANDOM[8'hA0][15];
        dataVec_4_fpWen = _RANDOM[8'hA0][16];
        dataVec_4_vecWen = _RANDOM[8'hA0][17];
        dataVec_4_v0Wen = _RANDOM[8'hA0][18];
        dataVec_4_vlWen = _RANDOM[8'hA0][19];
        dataVec_4_waitForward = _RANDOM[8'hA0][21];
        dataVec_4_blockBackward = _RANDOM[8'hA0][22];
        dataVec_4_flushPipe = _RANDOM[8'hA0][23];
        dataVec_4_selImm = _RANDOM[8'hA0][28:25];
        dataVec_4_imm = {_RANDOM[8'hA0][31:29], _RANDOM[8'hA1][28:0]};
        dataVec_4_fpu_typeTagOut = _RANDOM[8'hA1][31];
        dataVec_4_fpu_wflags = _RANDOM[8'hA2][1];
        dataVec_4_fpu_typ = _RANDOM[8'hA2][9:8];
        dataVec_4_fpu_rm = _RANDOM[8'hA2][15:13];
        dataVec_4_vpu_vill = _RANDOM[8'hA2][16];
        dataVec_4_vpu_vma = _RANDOM[8'hA2][17];
        dataVec_4_vpu_vta = _RANDOM[8'hA2][18];
        dataVec_4_vpu_vsew = _RANDOM[8'hA2][20:19];
        dataVec_4_vpu_vlmul = _RANDOM[8'hA2][23:21];
        dataVec_4_vpu_specVill = _RANDOM[8'hA2][24];
        dataVec_4_vpu_specVma = _RANDOM[8'hA2][25];
        dataVec_4_vpu_specVta = _RANDOM[8'hA2][26];
        dataVec_4_vpu_specVsew = _RANDOM[8'hA2][28:27];
        dataVec_4_vpu_specVlmul = _RANDOM[8'hA2][31:29];
        dataVec_4_vpu_vm = _RANDOM[8'hA3][0];
        dataVec_4_vpu_vstart = _RANDOM[8'hA3][8:1];
        dataVec_4_vpu_fpu_isFoldTo1_2 = _RANDOM[8'hA3][16];
        dataVec_4_vpu_fpu_isFoldTo1_4 = _RANDOM[8'hA3][17];
        dataVec_4_vpu_fpu_isFoldTo1_8 = _RANDOM[8'hA3][18];
        dataVec_4_vpu_vmask =
          {_RANDOM[8'hA3][31:29],
           _RANDOM[8'hA4],
           _RANDOM[8'hA5],
           _RANDOM[8'hA6],
           _RANDOM[8'hA7][28:0]};
        dataVec_4_vpu_nf = _RANDOM[8'hA8][7:5];
        dataVec_4_vpu_veew = _RANDOM[8'hA8][9:8];
        dataVec_4_vpu_isExt = _RANDOM[8'hA8][11];
        dataVec_4_vpu_isNarrow = _RANDOM[8'hA8][12];
        dataVec_4_vpu_isDstMask = _RANDOM[8'hA8][13];
        dataVec_4_vpu_isOpMask = _RANDOM[8'hA8][14];
        dataVec_4_vpu_isDependOldvd = _RANDOM[8'hA8][16];
        dataVec_4_vpu_isWritePartVd = _RANDOM[8'hA8][17];
        dataVec_4_vlsInstr = _RANDOM[8'hA8][18];
        dataVec_4_wfflags = _RANDOM[8'hA8][19];
        dataVec_4_isMove = _RANDOM[8'hA8][20];
        dataVec_4_uopIdx = _RANDOM[8'hA8][27:21];
        dataVec_4_isVset = _RANDOM[8'hA8][28];
        dataVec_4_firstUop = _RANDOM[8'hA8][29];
        dataVec_4_lastUop = _RANDOM[8'hA8][30];
        dataVec_4_numWB = _RANDOM[8'hA9][12:6];
        dataVec_4_commitType = _RANDOM[8'hA9][15:13];
        dataVec_4_psrc_0 = _RANDOM[8'hAA][26:19];
        dataVec_4_psrc_1 = {_RANDOM[8'hAA][31:27], _RANDOM[8'hAB][2:0]};
        dataVec_4_psrc_2 = _RANDOM[8'hAB][10:3];
        dataVec_4_psrc_3 = _RANDOM[8'hAB][18:11];
        dataVec_4_psrc_4 = _RANDOM[8'hAB][26:19];
        dataVec_4_pdest = {_RANDOM[8'hAB][31:27], _RANDOM[8'hAC][2:0]};
        dataVec_4_robIdx_flag = _RANDOM[8'hAC][15];
        dataVec_4_robIdx_value = _RANDOM[8'hAC][23:16];
        dataVec_4_instrSize = _RANDOM[8'hAC][26:24];
        dataVec_4_dirtyFs = _RANDOM[8'hAC][27];
        dataVec_4_dirtyVs = _RANDOM[8'hAC][28];
        dataVec_4_eliminatedMove = _RANDOM[8'hAC][29];
        dataVec_4_storeSetHit = _RANDOM[8'hBF][0];
        dataVec_4_loadWaitStrict = _RANDOM[8'hBF][11];
        dataVec_4_ssid = _RANDOM[8'hBF][16:12];
        dataVec_4_numLsElem = _RANDOM[8'hC0][6:2];
        dataVec_5_instr = {_RANDOM[8'hC0][31:7], _RANDOM[8'hC1][6:0]};
        dataVec_5_exceptionVec_0 = _RANDOM[8'hC2][26];
        dataVec_5_exceptionVec_1 = _RANDOM[8'hC2][27];
        dataVec_5_exceptionVec_2 = _RANDOM[8'hC2][28];
        dataVec_5_exceptionVec_3 = _RANDOM[8'hC2][29];
        dataVec_5_exceptionVec_4 = _RANDOM[8'hC2][30];
        dataVec_5_exceptionVec_5 = _RANDOM[8'hC2][31];
        dataVec_5_exceptionVec_6 = _RANDOM[8'hC3][0];
        dataVec_5_exceptionVec_7 = _RANDOM[8'hC3][1];
        dataVec_5_exceptionVec_8 = _RANDOM[8'hC3][2];
        dataVec_5_exceptionVec_9 = _RANDOM[8'hC3][3];
        dataVec_5_exceptionVec_10 = _RANDOM[8'hC3][4];
        dataVec_5_exceptionVec_11 = _RANDOM[8'hC3][5];
        dataVec_5_exceptionVec_12 = _RANDOM[8'hC3][6];
        dataVec_5_exceptionVec_13 = _RANDOM[8'hC3][7];
        dataVec_5_exceptionVec_14 = _RANDOM[8'hC3][8];
        dataVec_5_exceptionVec_15 = _RANDOM[8'hC3][9];
        dataVec_5_exceptionVec_16 = _RANDOM[8'hC3][10];
        dataVec_5_exceptionVec_17 = _RANDOM[8'hC3][11];
        dataVec_5_exceptionVec_18 = _RANDOM[8'hC3][12];
        dataVec_5_exceptionVec_19 = _RANDOM[8'hC3][13];
        dataVec_5_exceptionVec_20 = _RANDOM[8'hC3][14];
        dataVec_5_exceptionVec_21 = _RANDOM[8'hC3][15];
        dataVec_5_exceptionVec_22 = _RANDOM[8'hC3][16];
        dataVec_5_exceptionVec_23 = _RANDOM[8'hC3][17];
        dataVec_5_hasException = _RANDOM[8'hC3][18];
        dataVec_5_trigger_frontendHit_0 = _RANDOM[8'hC3][19];
        dataVec_5_trigger_frontendHit_1 = _RANDOM[8'hC3][20];
        dataVec_5_trigger_frontendHit_2 = _RANDOM[8'hC3][21];
        dataVec_5_trigger_frontendHit_3 = _RANDOM[8'hC3][22];
        dataVec_5_trigger_frontendCanFire_0 = _RANDOM[8'hC3][23];
        dataVec_5_trigger_frontendCanFire_1 = _RANDOM[8'hC3][24];
        dataVec_5_trigger_frontendCanFire_2 = _RANDOM[8'hC3][25];
        dataVec_5_trigger_frontendCanFire_3 = _RANDOM[8'hC3][26];
        dataVec_5_preDecodeInfo_valid = _RANDOM[8'hC4][3];
        dataVec_5_preDecodeInfo_isRVC = _RANDOM[8'hC4][4];
        dataVec_5_preDecodeInfo_brType = _RANDOM[8'hC4][6:5];
        dataVec_5_preDecodeInfo_isCall = _RANDOM[8'hC4][7];
        dataVec_5_preDecodeInfo_isRet = _RANDOM[8'hC4][8];
        dataVec_5_pred_taken = _RANDOM[8'hC4][9];
        dataVec_5_crossPageIPFFix = _RANDOM[8'hC4][10];
        dataVec_5_ftqPtr_flag = _RANDOM[8'hC4][11];
        dataVec_5_ftqPtr_value = _RANDOM[8'hC4][17:12];
        dataVec_5_ftqOffset = _RANDOM[8'hC4][21:18];
        dataVec_5_srcType_0 = _RANDOM[8'hC4][25:22];
        dataVec_5_srcType_1 = _RANDOM[8'hC4][29:26];
        dataVec_5_srcType_2 = {_RANDOM[8'hC4][31:30], _RANDOM[8'hC5][1:0]};
        dataVec_5_srcType_3 = _RANDOM[8'hC5][5:2];
        dataVec_5_srcType_4 = _RANDOM[8'hC5][9:6];
        dataVec_5_ldest = _RANDOM[8'hC5][15:10];
        dataVec_5_fuType = {_RANDOM[8'hC5][31:16], _RANDOM[8'hC6][18:0]};
        dataVec_5_fuOpType = _RANDOM[8'hC6][27:19];
        dataVec_5_rfWen = _RANDOM[8'hC6][28];
        dataVec_5_fpWen = _RANDOM[8'hC6][29];
        dataVec_5_vecWen = _RANDOM[8'hC6][30];
        dataVec_5_v0Wen = _RANDOM[8'hC6][31];
        dataVec_5_vlWen = _RANDOM[8'hC7][0];
        dataVec_5_waitForward = _RANDOM[8'hC7][2];
        dataVec_5_blockBackward = _RANDOM[8'hC7][3];
        dataVec_5_flushPipe = _RANDOM[8'hC7][4];
        dataVec_5_selImm = _RANDOM[8'hC7][9:6];
        dataVec_5_imm = {_RANDOM[8'hC7][31:10], _RANDOM[8'hC8][9:0]};
        dataVec_5_fpu_typeTagOut = _RANDOM[8'hC8][12];
        dataVec_5_fpu_wflags = _RANDOM[8'hC8][14];
        dataVec_5_fpu_typ = _RANDOM[8'hC8][22:21];
        dataVec_5_fpu_rm = _RANDOM[8'hC8][28:26];
        dataVec_5_vpu_vill = _RANDOM[8'hC8][29];
        dataVec_5_vpu_vma = _RANDOM[8'hC8][30];
        dataVec_5_vpu_vta = _RANDOM[8'hC8][31];
        dataVec_5_vpu_vsew = _RANDOM[8'hC9][1:0];
        dataVec_5_vpu_vlmul = _RANDOM[8'hC9][4:2];
        dataVec_5_vpu_specVill = _RANDOM[8'hC9][5];
        dataVec_5_vpu_specVma = _RANDOM[8'hC9][6];
        dataVec_5_vpu_specVta = _RANDOM[8'hC9][7];
        dataVec_5_vpu_specVsew = _RANDOM[8'hC9][9:8];
        dataVec_5_vpu_specVlmul = _RANDOM[8'hC9][12:10];
        dataVec_5_vpu_vm = _RANDOM[8'hC9][13];
        dataVec_5_vpu_vstart = _RANDOM[8'hC9][21:14];
        dataVec_5_vpu_fpu_isFoldTo1_2 = _RANDOM[8'hC9][29];
        dataVec_5_vpu_fpu_isFoldTo1_4 = _RANDOM[8'hC9][30];
        dataVec_5_vpu_fpu_isFoldTo1_8 = _RANDOM[8'hC9][31];
        dataVec_5_vpu_vmask =
          {_RANDOM[8'hCA][31:10],
           _RANDOM[8'hCB],
           _RANDOM[8'hCC],
           _RANDOM[8'hCD],
           _RANDOM[8'hCE][9:0]};
        dataVec_5_vpu_nf = _RANDOM[8'hCE][20:18];
        dataVec_5_vpu_veew = _RANDOM[8'hCE][22:21];
        dataVec_5_vpu_isExt = _RANDOM[8'hCE][24];
        dataVec_5_vpu_isNarrow = _RANDOM[8'hCE][25];
        dataVec_5_vpu_isDstMask = _RANDOM[8'hCE][26];
        dataVec_5_vpu_isOpMask = _RANDOM[8'hCE][27];
        dataVec_5_vpu_isDependOldvd = _RANDOM[8'hCE][29];
        dataVec_5_vpu_isWritePartVd = _RANDOM[8'hCE][30];
        dataVec_5_vlsInstr = _RANDOM[8'hCE][31];
        dataVec_5_wfflags = _RANDOM[8'hCF][0];
        dataVec_5_isMove = _RANDOM[8'hCF][1];
        dataVec_5_uopIdx = _RANDOM[8'hCF][8:2];
        dataVec_5_isVset = _RANDOM[8'hCF][9];
        dataVec_5_firstUop = _RANDOM[8'hCF][10];
        dataVec_5_lastUop = _RANDOM[8'hCF][11];
        dataVec_5_numWB = _RANDOM[8'hCF][25:19];
        dataVec_5_commitType = _RANDOM[8'hCF][28:26];
        dataVec_5_psrc_0 = _RANDOM[8'hD1][7:0];
        dataVec_5_psrc_1 = _RANDOM[8'hD1][15:8];
        dataVec_5_psrc_2 = _RANDOM[8'hD1][23:16];
        dataVec_5_psrc_3 = _RANDOM[8'hD1][31:24];
        dataVec_5_psrc_4 = _RANDOM[8'hD2][7:0];
        dataVec_5_pdest = _RANDOM[8'hD2][15:8];
        dataVec_5_robIdx_flag = _RANDOM[8'hD2][28];
        dataVec_5_robIdx_value = {_RANDOM[8'hD2][31:29], _RANDOM[8'hD3][4:0]};
        dataVec_5_instrSize = _RANDOM[8'hD3][7:5];
        dataVec_5_dirtyFs = _RANDOM[8'hD3][8];
        dataVec_5_dirtyVs = _RANDOM[8'hD3][9];
        dataVec_5_eliminatedMove = _RANDOM[8'hD3][10];
        dataVec_5_storeSetHit = _RANDOM[8'hE5][13];
        dataVec_5_loadWaitStrict = _RANDOM[8'hE5][24];
        dataVec_5_ssid = _RANDOM[8'hE5][29:25];

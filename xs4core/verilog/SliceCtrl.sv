...
module SliceCtrl(
  ...
  output [1:0]   io_s_dir_w_bits_data_clientStates_1,
  output [1:0]   io_s_dir_w_bits_data_clientStates_2,
  output [1:0]   io_s_dir_w_bits_data_clientStates_3,
  output         io_s_dir_w_bits_data_prefetch,
  input          io_c_dir_w_ready,
  output         io_c_dir_w_valid,
  output [11:0]  io_c_dir_w_bits_set,
  output [3:0]   io_c_dir_w_bits_way,
  output [1:0]   io_c_dir_w_bits_data_0_state,
  output [1:0]   io_c_dir_w_bits_data_1_state,
  output [1:0]   io_c_dir_w_bits_data_2_state,
  output [1:0]   io_c_dir_w_bits_data_3_state,
  input          io_s_tag_w_ready,
  output         io_s_tag_w_valid,
  output [11:0]  io_s_tag_w_bits_set,
  output [3:0]   io_s_tag_w_bits_way,
  output [15:0]  io_s_tag_w_bits_tag,
  input          io_c_tag_w_ready,
  output         io_c_tag_w_valid,
  output [11:0]  io_c_tag_w_bits_set,
  output [3:0]   io_c_tag_w_bits_way,
  output [15:0]  io_c_tag_w_bits_tag,
  ...
  input  [1:0]   io_dir_result_bits_self_clientStates_1,
  input  [1:0]   io_dir_result_bits_self_clientStates_2,
  input  [1:0]   io_dir_result_bits_self_clientStates_3,
  ...
  input  [1:0]   io_dir_result_bits_clients_states_1_state,
  input          io_dir_result_bits_clients_states_1_hit,
  input  [1:0]   io_dir_result_bits_clients_states_2_state,
  input          io_dir_result_bits_clients_states_2_hit,
  input  [1:0]   io_dir_result_bits_clients_states_3_state,
  input          io_dir_result_bits_clients_states_3_hit,
  input  [15:0]  io_dir_result_bits_clients_tag,
  ...
  always @(posedge clock) begin
    if (_GEN) begin
      ...
      req_reg_tag <= {48'h0, io_req_bits_tag[17:2]};
    ...
    if (data_wen & ~w_counter) begin
      ...
      if (io_dir_result_valid) begin
        if (req_reg_cmd == 8'h3)
          req_reg_data_0 <=
            {52'h0, io_dir_result_bits_self_tag[10:0], io_dir_result_bits_self_error};
          ...
          req_reg_data_0 <= {48'h0, io_dir_result_bits_self_tag};
        else if (req_reg_cmd == 8'h1)
          req_reg_data_0 <= {48'h0, io_dir_result_bits_clients_tag};
        else if (_GEN)
  ...
  assign io_s_dir_w_bits_data_dirty = req_reg_dir[11];
  assign io_s_dir_w_bits_data_state = req_reg_dir[10:9];
  assign io_s_dir_w_bits_data_clientStates_0 = req_reg_dir[2:1];
  assign io_s_dir_w_bits_data_clientStates_1 = req_reg_dir[4:3];
  assign io_s_dir_w_bits_data_clientStates_2 = req_reg_dir[6:5];
  assign io_s_dir_w_bits_data_clientStates_3 = req_reg_dir[8:7];
  assign io_s_dir_w_bits_data_prefetch = req_reg_dir[0];
  assign io_c_dir_w_valid = s_wb_client_dir;
  assign io_c_dir_w_bits_set = req_reg_set[11:0];
  assign io_c_dir_w_bits_way = req_reg_way[3:0];
  assign io_c_dir_w_bits_data_0_state = req_reg_dir[1:0];
  assign io_c_dir_w_bits_data_1_state = req_reg_dir[3:2];
  assign io_c_dir_w_bits_data_2_state = req_reg_dir[5:4];
  assign io_c_dir_w_bits_data_3_state = req_reg_dir[7:6];
  ...
  assign io_s_tag_w_bits_tag = req_reg_tag[15:0];
  assign io_c_tag_w_valid = s_wb_client_tag;
  assign io_c_tag_w_bits_set = req_reg_set[11:0];
  assign io_c_tag_w_bits_way = req_reg_way[3:0];
  assign io_c_tag_w_bits_tag = req_reg_tag[15:0];
  ...
  assign io_dir_read_bits_tag = req_reg_tag[15:0];
  ...
  assign io_cmo_req_bits_tag = io_req_bits_tag[15:0];
endmodule

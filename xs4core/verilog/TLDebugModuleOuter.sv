...
module TLDebugModuleOuter(
  ...
  output        io_innerCtrl_bits_hamask_2,
  output        io_innerCtrl_bits_hamask_3,
  output        io_innerCtrl_bits_hrmask_0,
  output        io_innerCtrl_bits_hrmask_1,
  output        io_innerCtrl_bits_hrmask_2,
  output        io_innerCtrl_bits_hrmask_3,
  input         io_hgDebugInt_0,
  input         io_hgDebugInt_1,
  input         io_hgDebugInt_2,
  input         io_hgDebugInt_3
);
  ...
  wire             hamask_2 = _GEN_0 ? auto_dmi_in_a_bits_data[2] : HAMASKReg_maskdata[2];
  wire             hamask_3 = _GEN_0 ? auto_dmi_in_a_bits_data[3] : HAMASKReg_maskdata[3];
  reg              hrmaskReg_0;
  reg              hrmaskReg_1;
  reg              hrmaskReg_2;
  reg              hrmaskReg_3;
  ...
  wire             _GEN_5 =
    io_innerCtrl_bits_hartsel_0 == 10'h2 | io_innerCtrl_bits_hasel_0 & hamask_2;
  wire             hrmaskNxt_2 =
    ~(~DMCONTROLReg_dmactive | _GEN_1 & _GEN_5) & (_GEN_3 & _GEN_5 | hrmaskReg_2);
  wire             _GEN_6 =
    io_innerCtrl_bits_hartsel_0 == 10'h3 | io_innerCtrl_bits_hasel_0 & hamask_3;
  wire             hrmaskNxt_3 =
    ~(~DMCONTROLReg_dmactive | _GEN_1 & _GEN_6) & (_GEN_3 & _GEN_6 | hrmaskReg_3);
  ...
  wire [3:0][31:0] _GEN_8 =
    {{32'h0},
     {{28'h0, _GEN ? HAMASKReg_maskdata[3:0] : 4'h0}},
     {32'h0},
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (DMCONTROLReg_dmactive) begin
        if (_GEN_0)
          HAMASKReg_maskdata <= {28'h0, auto_dmi_in_a_bits_data[3:0]};
      end
      else begin
        HAWINDOWSELReg_hawindowsel <= 15'h0;
        HAMASKReg_maskdata <= 32'h0;
      ...
      hrmaskReg_2 <= hrmaskNxt_2;
      hrmaskReg_3 <= hrmaskNxt_3;
      debugIntRegs_0 <=
        DMCONTROLReg_dmactive
        & (out_woready_9
      ...
      debugIntRegs_2 <=
        DMCONTROLReg_dmactive
        & (out_woready_9
           & (auto_dmi_in_a_bits_data[21:16] == 6'h2 | auto_dmi_in_a_bits_data[26]
              & hamask_2)
             ? auto_dmi_in_a_bits_data[31]
             : debugIntRegs_2);
      debugIntRegs_3 <=
        DMCONTROLReg_dmactive
        & (out_woready_9
           & (auto_dmi_in_a_bits_data[21:16] == 6'h3 | auto_dmi_in_a_bits_data[26]
              & hamask_3)
             ? auto_dmi_in_a_bits_data[31]
             : debugIntRegs_3);
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        hrmaskReg_2 = _RANDOM[2'h3][2];
        hrmaskReg_3 = _RANDOM[2'h3][3];
        debugIntRegs_0 = _RANDOM[2'h3][4];
        debugIntRegs_1 = _RANDOM[2'h3][5];
        debugIntRegs_2 = _RANDOM[2'h3][6];
        debugIntRegs_3 = _RANDOM[2'h3][7];
        innerCtrlValidReg = _RANDOM[2'h3][8];
        innerCtrlResumeReqReg = _RANDOM[2'h3][9];
        innerCtrlAckHaveResetReg = _RANDOM[2'h3][10];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        DMCONTROLReg_haltreq = 1'h0;
        DMCONTROLReg_hartreset = 1'h0;
  ...
  assign auto_dmi_in_d_bits_data =
    _GEN_7[auto_dmi_in_a_bits_address[4:3]]
      ? _GEN_8[auto_dmi_in_a_bits_address[4:3]]
      : 32'h0;
  assign auto_int_out_3_0 = debugIntRegs_3 | io_hgDebugInt_3;
  assign auto_int_out_2_0 = debugIntRegs_2 | io_hgDebugInt_2;
  ...
  assign io_innerCtrl_bits_hamask_2 = hamask_2;
  assign io_innerCtrl_bits_hamask_3 = hamask_3;
  assign io_innerCtrl_bits_hrmask_0 = hrmaskNxt_0;
  assign io_innerCtrl_bits_hrmask_1 = hrmaskNxt_1;
  assign io_innerCtrl_bits_hrmask_2 = hrmaskNxt_2;
  assign io_innerCtrl_bits_hrmask_3 = hrmaskNxt_3;
endmodule

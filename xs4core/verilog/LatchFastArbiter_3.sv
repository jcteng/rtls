...
module LatchFastArbiter_3(
  ...
  input         io_in_0_valid,
  input  [12:0] io_in_0_bits_sourceId,
  ...
  input         io_in_1_valid,
  input  [12:0] io_in_1_bits_sourceId,
  ...
  input         io_in_2_valid,
  input  [12:0] io_in_2_bits_sourceId,
  ...
  input         io_in_3_valid,
  input  [12:0] io_in_3_bits_sourceId,
  ...
  input         io_in_4_valid,
  input  [12:0] io_in_4_bits_sourceId,
  ...
  input         io_in_5_valid,
  input  [12:0] io_in_5_bits_sourceId,
  ...
  input         io_in_6_valid,
  input  [12:0] io_in_6_bits_sourceId,
  ...
  input         io_in_7_valid,
  input  [12:0] io_in_7_bits_sourceId,
  ...
  input         io_in_8_valid,
  input  [12:0] io_in_8_bits_sourceId,
  ...
  input         io_in_9_valid,
  input  [12:0] io_in_9_bits_sourceId,
  ...
  input  [12:0] io_in_10_bits_sourceId,
  ...
  input  [12:0] io_in_11_bits_sourceId,
  ...
  input  [12:0] io_in_12_bits_sourceId,
  ...
  input  [12:0] io_in_13_bits_sourceId,
  ...
  input         io_out_ready,
  output        io_out_valid,
  output [12:0] io_out_bits_sourceId,
  ...
  reg         out_valid_reg;
  reg  [12:0] out_bits_reg_sourceId;
    ...
    if (reset) begin
      ...
      if (latch_result) begin
        out_bits_reg_sourceId <=
          (chosenOH[0] ? io_in_0_bits_sourceId : 13'h0)
          | (chosenOH[1] ? io_in_1_bits_sourceId : 13'h0)
          | (chosenOH[2] ? io_in_2_bits_sourceId : 13'h0)
          | (chosenOH[3] ? io_in_3_bits_sourceId : 13'h0)
          | (chosenOH[4] ? io_in_4_bits_sourceId : 13'h0)
          | (chosenOH[5] ? io_in_5_bits_sourceId : 13'h0)
          | (chosenOH[6] ? io_in_6_bits_sourceId : 13'h0)
          | (chosenOH[7] ? io_in_7_bits_sourceId : 13'h0)
          | (chosenOH[8] ? io_in_8_bits_sourceId : 13'h0)
          | (chosenOH[9] ? io_in_9_bits_sourceId : 13'h0)
          | (chosenOH[10] ? io_in_10_bits_sourceId : 13'h0)
          | (chosenOH[11] ? io_in_11_bits_sourceId : 13'h0)
          | (chosenOH[12] ? io_in_12_bits_sourceId : 13'h0)
          | (chosenOH[13] ? io_in_13_bits_sourceId : 13'h0);
        out_bits_reg_set <=
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        out_bits_reg_sourceId = _RANDOM[2'h0][13:1];
        out_bits_reg_set = _RANDOM[2'h0][25:14];
        out_bits_reg_tag = {_RANDOM[2'h0][31:26], _RANDOM[2'h1][9:0]};
        out_bits_reg_channel = _RANDOM[2'h1][12:10];
        out_bits_reg_opcode = _RANDOM[2'h1][15:13];
        out_bits_reg_param = _RANDOM[2'h1][18:16];
        out_bits_reg_size = _RANDOM[2'h1][21:19];
        out_bits_reg_way = _RANDOM[2'h1][25:22];
        out_bits_reg_off = _RANDOM[2'h1][31:26];
        out_bits_reg_useBypass = _RANDOM[2'h2][0];
        out_bits_reg_bufIdx = _RANDOM[2'h2][4:1];
        out_bits_reg_denied = _RANDOM[2'h2][5];
        out_bits_reg_sinkId = _RANDOM[2'h2][9:6];
        out_bits_reg_bypassPut = _RANDOM[2'h2][10];
        out_bits_reg_dirty = _RANDOM[2'h2][11];
        out_bits_reg_isHit = _RANDOM[2'h2][12];
        chosen_reg = _RANDOM[2'h2][26:13];
        pendingMask = {_RANDOM[2'h2][31:27], _RANDOM[2'h3][8:0]};
        rrGrantMask = _RANDOM[2'h3][22:9];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        out_valid_reg = 1'h0;
        out_bits_reg_sourceId = 13'h0;

...
module DebugModule(
  ...
  output         auto_debug_dmOuter_dmOuter_int_out_3_0,
  output         auto_debug_dmOuter_dmOuter_int_out_2_0,
  output         auto_debug_dmOuter_dmOuter_int_out_1_0,
  output         auto_debug_dmOuter_dmOuter_int_out_0_0,
  input          io_resetCtrl_hartIsInReset_0,
  input          io_resetCtrl_hartIsInReset_1,
  input          io_resetCtrl_hartIsInReset_2,
  input          io_resetCtrl_hartIsInReset_3,
  ...
  always @(posedge io_clock) begin
    ...
    REG_1 <= io_resetCtrl_hartIsInReset_1;
    REG_2 <= io_resetCtrl_hartIsInReset_2;
    REG_3 <= io_resetCtrl_hartIsInReset_3;
  end // always @(posedge)
  ...
  TLDebugModule debug (
    ...
    .auto_dmOuter_dmOuter_int_out_3_0
      (auto_debug_dmOuter_dmOuter_int_out_3_0),
    .auto_dmOuter_dmOuter_int_out_2_0
      (auto_debug_dmOuter_dmOuter_int_out_2_0),
    .auto_dmOuter_dmOuter_int_out_1_0
      (auto_debug_dmOuter_dmOuter_int_out_1_0),
    .auto_dmOuter_dmOuter_int_out_0_0
    ...
    .io_hartIsInReset_1                               (REG_1),
    .io_hartIsInReset_2                               (REG_2),
    .io_hartIsInReset_3                               (REG_3)
  );

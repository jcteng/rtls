...
module DispatchQueue_1(
  ...
  wire             nextStepData_2_flushPipe =
    enqBypassEn_2 ? _enqBypassData_T_5598 : deqData_2_flushPipe;
  ...
  wire             nextStepData_3_flushPipe =
    enqBypassEn_3 ? _enqBypassData_T_7721 : deqData_3_flushPipe;
    ...
    if (io_redirect_valid) begin
      ...
      if (deqEnable_n_0) begin
        ...
        if (enqBypassEn_1) begin
          ...
          deqData_1_flushPipe <= _enqBypassData_T_3475;
        ...
        if (enqBypassEn_2) begin
          ...
          deqData_2_flushPipe <= _enqBypassData_T_5598;
        ...
        if (enqBypassEn_3) begin
          ...
          deqData_3_flushPipe <= _enqBypassData_T_7721;
        ...
        deqData_0_fpWen <= enqBypassEn_1 ? _enqBypassData_T_3552 : deqData_1_fpWen;
        deqData_0_vecWen <= enqBypassEn_1 ? _enqBypassData_T_3541 : deqData_1_vecWen;
        deqData_0_v0Wen <= enqBypassEn_1 ? _enqBypassData_T_3530 : deqData_1_v0Wen;
        deqData_0_vlWen <= enqBypassEn_1 ? _enqBypassData_T_3519 : deqData_1_vlWen;
        deqData_0_flushPipe <=
          enqBypassEn_1 ? _enqBypassData_T_3475 : deqData_1_flushPipe;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        deqData_1_fpWen = _RANDOM[8'h36][17];
        deqData_1_vecWen = _RANDOM[8'h36][18];
        deqData_1_v0Wen = _RANDOM[8'h36][19];
        deqData_1_vlWen = _RANDOM[8'h36][20];
        deqData_1_flushPipe = _RANDOM[8'h36][24];
        ...
        deqData_2_fpWen = _RANDOM[8'h5C][30];
        deqData_2_vecWen = _RANDOM[8'h5C][31];
        deqData_2_v0Wen = _RANDOM[8'h5D][0];
        deqData_2_vlWen = _RANDOM[8'h5D][1];
        deqData_2_flushPipe = _RANDOM[8'h5D][5];
        ...
        deqData_3_fpWen = _RANDOM[8'h83][11];
        deqData_3_vecWen = _RANDOM[8'h83][12];
        deqData_3_v0Wen = _RANDOM[8'h83][13];
        deqData_3_vlWen = _RANDOM[8'h83][14];
        deqData_3_flushPipe = _RANDOM[8'h83][18];

...
module AsyncQueueSink_2(
  ...
  output       io_deq_bits_hamask_1,
  output       io_deq_bits_hamask_2,
  output       io_deq_bits_hamask_3,
  output       io_deq_bits_hrmask_0,
  output       io_deq_bits_hrmask_1,
  output       io_deq_bits_hrmask_2,
  output       io_deq_bits_hrmask_3,
  ...
  input        io_async_mem_0_hamask_1,
  input        io_async_mem_0_hamask_2,
  input        io_async_mem_0_hamask_3,
  input        io_async_mem_0_hrmask_0,
  input        io_async_mem_0_hrmask_1,
  input        io_async_mem_0_hrmask_2,
  input        io_async_mem_0_hrmask_3,
  output       io_async_ridx,
  input        io_async_widx
);

  reg         valid_reg;
  wire [20:0] _io_deq_bits_deq_bits_reg_io_q;
  ...
  assign io_deq_bits_resumereq = _io_deq_bits_deq_bits_reg_io_q[20];
  assign io_deq_bits_hartsel = _io_deq_bits_deq_bits_reg_io_q[19:10];
  assign io_deq_bits_ackhavereset = _io_deq_bits_deq_bits_reg_io_q[9];
  assign io_deq_bits_hasel = _io_deq_bits_deq_bits_reg_io_q[8];
  assign io_deq_bits_hamask_0 = _io_deq_bits_deq_bits_reg_io_q[4];
  assign io_deq_bits_hamask_1 = _io_deq_bits_deq_bits_reg_io_q[5];
  assign io_deq_bits_hamask_2 = _io_deq_bits_deq_bits_reg_io_q[6];
  assign io_deq_bits_hamask_3 = _io_deq_bits_deq_bits_reg_io_q[7];
  assign io_deq_bits_hrmask_0 = _io_deq_bits_deq_bits_reg_io_q[0];
  assign io_deq_bits_hrmask_1 = _io_deq_bits_deq_bits_reg_io_q[1];
  assign io_deq_bits_hrmask_2 = _io_deq_bits_deq_bits_reg_io_q[2];
  assign io_deq_bits_hrmask_3 = _io_deq_bits_deq_bits_reg_io_q[3];

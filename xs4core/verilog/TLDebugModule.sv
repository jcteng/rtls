...
module TLDebugModule(
  ...
  output         auto_dmOuter_dmOuter_int_out_3_0,
  output         auto_dmOuter_dmOuter_int_out_2_0,
  output         auto_dmOuter_dmOuter_int_out_1_0,
  output         auto_dmOuter_dmOuter_int_out_0_0,
  ...
  wire        _dmInner_io_hgDebugInt_2;
  wire        _dmInner_io_hgDebugInt_3;
  ...
  wire        _dmOuter_io_innerCtrl_mem_0_hamask_2;
  wire        _dmOuter_io_innerCtrl_mem_0_hamask_3;
  wire        _dmOuter_io_innerCtrl_mem_0_hrmask_0;
  wire        _dmOuter_io_innerCtrl_mem_0_hrmask_1;
  wire        _dmOuter_io_innerCtrl_mem_0_hrmask_2;
  wire        _dmOuter_io_innerCtrl_mem_0_hrmask_3;
  ...
  TLDebugModuleOuterAsync dmOuter (
    ...
    .auto_dmOuter_int_out_3_0         (auto_dmOuter_dmOuter_int_out_3_0),
    .auto_dmOuter_int_out_2_0         (auto_dmOuter_dmOuter_int_out_2_0),
    .auto_dmOuter_int_out_1_0         (auto_dmOuter_dmOuter_int_out_1_0),
    .auto_dmOuter_int_out_0_0         (auto_dmOuter_dmOuter_int_out_0_0),

...
module TLToAXI4_1(
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      count <=
        1'(1'(count + (_GEN[auto_in_a_bits_source] == 5'h0 & _inc_T_19))
           - (d_sel_shiftAmount == 5'h0 & d_last & _dec_T_39));
      count_1 <=
        1'(1'(count_1 + (_GEN[auto_in_a_bits_source] == 5'h1 & _inc_T_19))
           - (d_sel_shiftAmount == 5'h1 & d_last & _dec_T_39));
      count_2 <=
        1'(1'(count_2 + (_GEN[auto_in_a_bits_source] == 5'h2 & _inc_T_19))
           - (d_sel_shiftAmount == 5'h2 & d_last & _dec_T_39));
      count_3 <=
        1'(1'(count_3 + (_GEN[auto_in_a_bits_source] == 5'h3 & _inc_T_19))
           - (d_sel_shiftAmount == 5'h3 & d_last & _dec_T_39));
      count_4 <=
        1'(1'(count_4 + (_GEN[auto_in_a_bits_source] == 5'h4 & _inc_T_19))
           - (d_sel_shiftAmount == 5'h4 & d_last & _dec_T_39));
      count_5 <=
        1'(1'(count_5 + (_GEN[auto_in_a_bits_source] == 5'h5 & _inc_T_19))
           - (d_sel_shiftAmount == 5'h5 & d_last & _dec_T_39));
      count_6 <=
        1'(1'(count_6 + (_GEN[auto_in_a_bits_source] == 5'h6 & _inc_T_19))
           - (d_sel_shiftAmount == 5'h6 & d_last & _dec_T_39));
      count_7 <=
        1'(1'(count_7 + (_GEN[auto_in_a_bits_source] == 5'h7 & _inc_T_19))
           - (d_sel_shiftAmount == 5'h7 & d_last & _dec_T_39));
      count_8 <=
        1'(1'(count_8 + (_GEN[auto_in_a_bits_source] == 5'h8 & _inc_T_19))
           - (d_sel_shiftAmount == 5'h8 & d_last & _dec_T_39));
      count_9 <=
        1'(1'(count_9 + (_GEN[auto_in_a_bits_source] == 5'h9 & _inc_T_19))
           - (d_sel_shiftAmount == 5'h9 & d_last & _dec_T_39));
      count_10 <=
        1'(1'(count_10 + (_GEN[auto_in_a_bits_source] == 5'hA & _inc_T_19))
           - (d_sel_shiftAmount == 5'hA & d_last & _dec_T_39));
      count_11 <=
        1'(1'(count_11 + (_GEN[auto_in_a_bits_source] == 5'hB & _inc_T_19))
           - (d_sel_shiftAmount == 5'hB & d_last & _dec_T_39));
      count_12 <=
        1'(1'(count_12 + (_GEN[auto_in_a_bits_source] == 5'hC & _inc_T_19))
           - (d_sel_shiftAmount == 5'hC & d_last & _dec_T_39));
      count_13 <=
        1'(1'(count_13 + (_GEN[auto_in_a_bits_source] == 5'hD & _inc_T_19))
           - (d_sel_shiftAmount == 5'hD & d_last & _dec_T_39));
      count_14 <=
        1'(1'(count_14 + (_GEN[auto_in_a_bits_source] == 5'hE & _inc_T_19))
           - (d_sel_shiftAmount == 5'hE & d_last & _dec_T_39));
      count_15 <=
        1'(1'(count_15 + (_GEN[auto_in_a_bits_source] == 5'hF & _inc_T_19))
           - (d_sel_shiftAmount == 5'hF & d_last & _dec_T_39));
      count_16 <=
        1'(1'(count_16 + (_GEN[auto_in_a_bits_source] == 5'h10 & _inc_T_19))
           - (d_sel_shiftAmount == 5'h10 & d_last & _dec_T_39));
      count_17 <=
        1'(1'(count_17 + (_GEN[auto_in_a_bits_source] == 5'h11 & _inc_T_19))
           - (d_sel_shiftAmount == 5'h11 & d_last & _dec_T_39));
      count_18 <=
        1'(1'(count_18 + (_GEN[auto_in_a_bits_source] == 5'h12 & _inc_T_19))
           - (d_sel_shiftAmount == 5'h12 & d_last & _dec_T_39));
      count_19 <=
        1'(1'(count_19 + (_GEN[auto_in_a_bits_source] == 5'h13 & _inc_T_19))
           - (d_sel_shiftAmount == 5'h13 & d_last & _dec_T_39));
    end
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        count_17 = _RANDOM[1'h1][11];
        count_18 = _RANDOM[1'h1][13];
        count_19 = _RANDOM[1'h1][15];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        r_counter = 2'h0;
        doneAW = 1'h0;

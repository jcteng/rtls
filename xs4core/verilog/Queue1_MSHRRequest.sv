...
module Queue1_MSHRRequest(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = {_RANDOM[2'h0][31:1], _RANDOM[2'h1], _RANDOM[2'h2], _RANDOM[2'h3][12:0]};
        full = _RANDOM[2'h0][0];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        full = 1'h0;
  ...
  assign io_deq_bits_source = ram[24:12];
  assign io_deq_bits_set = ram[36:25];
  assign io_deq_bits_tag = ram[52:37];
  assign io_deq_bits_off = ram[58:53];
  assign io_deq_bits_mask = ram[90:59];
  assign io_deq_bits_bufIdx = ram[94:91];
  assign io_deq_bits_needHint = ram[95];
  assign io_deq_bits_isPrefetch = ram[96];
  assign io_deq_bits_isBop = ram[97];
  assign io_deq_bits_preferCache = ram[98];
  assign io_deq_bits_dirty = ram[99];
  assign io_deq_bits_fromProbeHelper = ram[101];
  assign io_deq_bits_fromCmoHelper = ram[102];
  assign io_deq_bits_needProbeAckData = ram[103];
  assign io_deq_bits_reqSource = ram[107:104];
endmodule

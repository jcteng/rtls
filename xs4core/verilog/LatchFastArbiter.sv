  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        out_bits_reg_tag = _RANDOM[3'h0][16:1];
        out_bits_reg_set = _RANDOM[3'h0][28:17];
        out_bits_reg_off = {_RANDOM[3'h0][31:29], _RANDOM[3'h1][2:0]};
        out_bits_reg_opcode = _RANDOM[3'h2][5:3];
        out_bits_reg_param = _RANDOM[3'h2][8:6];
        out_bits_reg_source = _RANDOM[3'h2][12:9];
        out_bits_reg_bufIdx = _RANDOM[3'h2][16:13];
        out_bits_reg_size = _RANDOM[3'h2][19:17];
        out_bits_reg_putData = _RANDOM[3'h2][21];
        chosen_reg = {_RANDOM[3'h2][31:26], _RANDOM[3'h3][7:0]};
        pendingMask = _RANDOM[3'h3][21:8];
        rrGrantMask = {_RANDOM[3'h3][31:22], _RANDOM[3'h4][3:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        out_valid_reg = 1'h0;
        out_bits_reg_tag = 16'h0;

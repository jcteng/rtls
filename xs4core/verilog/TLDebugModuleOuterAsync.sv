...
module TLDebugModuleOuterAsync(
  ...
  output        auto_dmOuter_int_out_3_0,
  output        auto_dmOuter_int_out_2_0,
  output        auto_dmOuter_int_out_1_0,
  output        auto_dmOuter_int_out_0_0,
  input         io_dmi_clock,
  input         io_dmi_reset,
  ...
  output        io_innerCtrl_mem_0_hamask_1,
  output        io_innerCtrl_mem_0_hamask_2,
  output        io_innerCtrl_mem_0_hamask_3,
  output        io_innerCtrl_mem_0_hrmask_0,
  output        io_innerCtrl_mem_0_hrmask_1,
  output        io_innerCtrl_mem_0_hrmask_2,
  output        io_innerCtrl_mem_0_hrmask_3,
  ...
  wire        _dmOuter_io_innerCtrl_bits_hamask_2;
  wire        _dmOuter_io_innerCtrl_bits_hamask_3;
  wire        _dmOuter_io_innerCtrl_bits_hrmask_0;
  wire        _dmOuter_io_innerCtrl_bits_hrmask_1;
  wire        _dmOuter_io_innerCtrl_bits_hrmask_2;
  wire        _dmOuter_io_innerCtrl_bits_hrmask_3;
  ...
  TLDebugModuleOuter dmOuter (
    ...
    .auto_int_out_3_0               (auto_dmOuter_int_out_3_0),
    .auto_int_out_2_0               (auto_dmOuter_int_out_2_0),
    .auto_int_out_1_0               (auto_dmOuter_int_out_1_0),
    .auto_int_out_0_0               (auto_dmOuter_int_out_0_0),
  ...
  AsyncQueueSource_1 io_innerCtrl_source (
    ...
    .io_enq_bits_hamask_2        (_dmOuter_io_innerCtrl_bits_hamask_2),
    .io_enq_bits_hamask_3        (_dmOuter_io_innerCtrl_bits_hamask_3),
    .io_enq_bits_hrmask_0        (_dmOuter_io_innerCtrl_bits_hrmask_0),
    .io_enq_bits_hrmask_1        (_dmOuter_io_innerCtrl_bits_hrmask_1),
    .io_enq_bits_hrmask_2        (_dmOuter_io_innerCtrl_bits_hrmask_2),
    .io_enq_bits_hrmask_3        (_dmOuter_io_innerCtrl_bits_hrmask_3),

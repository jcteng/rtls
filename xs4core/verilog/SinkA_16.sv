...
module SinkA_16(
  ...
  assign io_alloc_bits_opcode = io_a_bits_opcode;
  ...
  assign io_alloc_bits_tag = io_a_bits_address[35:20];
  ...
  assign io_alloc_bits_isPrefetch = io_a_bits_opcode == 3'h5;

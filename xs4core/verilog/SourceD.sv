...
module SourceD(
  ...
  input          io_task_valid,
  input  [12:0]  io_task_bits_sourceId,
  ...
  wire [12:0]  _pipe_io_out_bits_req_sourceId;
  ...
  reg  [12:0]  s1_req_reg_sourceId;
  reg  [11:0]  s1_req_reg_set;
  reg  [15:0]  s1_req_reg_tag;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_req_reg_sourceId = _RANDOM[5'h0][14:2];
        s1_req_reg_set = _RANDOM[5'h0][26:15];
        s1_req_reg_tag = {_RANDOM[5'h0][31:27], _RANDOM[5'h1][10:0]};
        s1_req_reg_channel = _RANDOM[5'h1][13:11];
        s1_req_reg_opcode = _RANDOM[5'h1][16:14];
        s1_req_reg_param = _RANDOM[5'h1][19:17];
        s1_req_reg_size = _RANDOM[5'h1][22:20];
        s1_req_reg_way = _RANDOM[5'h1][26:23];
        s1_req_reg_off = {_RANDOM[5'h1][31:27], _RANDOM[5'h2][0]};
        s1_req_reg_useBypass = _RANDOM[5'h2][1];
        s1_req_reg_bufIdx = _RANDOM[5'h2][5:2];
        s1_req_reg_denied = _RANDOM[5'h2][6];
        s1_req_reg_sinkId = _RANDOM[5'h2][10:7];
        s1_req_reg_bypassPut = _RANDOM[5'h2][11];
        s1_req_reg_dirty = _RANDOM[5'h2][12];
        s1_req_reg_isHit = _RANDOM[5'h2][13];
        s1_counter = _RANDOM[5'h2][14];
        s2_req_sourceId = _RANDOM[5'h2][27:15];
        s2_req_set = {_RANDOM[5'h2][31:28], _RANDOM[5'h3][7:0]};
        s2_req_tag = _RANDOM[5'h3][23:8];
        s2_req_channel = _RANDOM[5'h3][26:24];
        s2_req_opcode = _RANDOM[5'h3][29:27];
        s2_req_param = {_RANDOM[5'h3][31:30], _RANDOM[5'h4][0]};
        s2_req_size = _RANDOM[5'h4][3:1];
        s2_req_way = _RANDOM[5'h4][7:4];
        s2_req_off = _RANDOM[5'h4][13:8];
        s2_req_useBypass = _RANDOM[5'h4][14];
        s2_req_bufIdx = _RANDOM[5'h4][18:15];
        s2_req_denied = _RANDOM[5'h4][19];
        s2_req_sinkId = _RANDOM[5'h4][23:20];
        s2_req_bypassPut = _RANDOM[5'h4][24];
        s2_req_dirty = _RANDOM[5'h4][25];
        s2_req_isHit = _RANDOM[5'h4][26];
        s2_needData = _RANDOM[5'h4][27];
        s2_beat = _RANDOM[5'h4][28];
        s2_last = _RANDOM[5'h4][29];
        s2_counter = _RANDOM[5'h4][30];
        s2_full = _RANDOM[5'h4][31];
        s2_need_pb = _RANDOM[5'h5][0];
        s2_need_d = _RANDOM[5'h5][1];
        s2_valid_pb = _RANDOM[5'h5][2];
        pbQueue_io_enq_valid_REG = _RANDOM[5'h5][3];
        s3_queue_io_enq_valid_REG = _RANDOM[5'h5][4];
        s3_queue_io_enq_valid_REG_1 = _RANDOM[5'h5][5];
        s3_queue_io_enq_valid_REG_2 = _RANDOM[5'h5][6];
        s3_queue_io_enq_valid_REG_3 = _RANDOM[5'h5][7];
        s3_queue_io_enq_valid_REG_4 = _RANDOM[5'h5][8];
        s4_req_set = {_RANDOM[5'h5][31:22], _RANDOM[5'h6][1:0]};
        s4_req_way = {_RANDOM[5'h6][31:30], _RANDOM[5'h7][1:0]};
        s4_req_sinkId = _RANDOM[5'h7][17:14];
        s4_rdata =
          {_RANDOM[5'h7][31:21],
           _RANDOM[5'h8],
           _RANDOM[5'h9],
        ...
        s4_pbdata_data =
          {_RANDOM[5'hF][31:21],
           ...
           _RANDOM[5'h16],
           _RANDOM[5'h17][20:0]};
        s4_pbdata_mask = {_RANDOM[5'h17][31:21], _RANDOM[5'h18][20:0]};
        s4_need_pb = _RANDOM[5'h18][22];
        s4_beat = _RANDOM[5'h18][23];
        s4_last = _RANDOM[5'h18][24];
        s4_full = _RANDOM[5'h18][25];
        beatsLeft = _RANDOM[5'h18][26];
        state_0 = _RANDOM[5'h18][27];
        state_1 = _RANDOM[5'h18][28];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        busy = 1'h0;
        s1_block_r = 1'h0;
  ...
  assign io_d_bits_opcode =
    (muxState_0 ? _pipe_io_out_bits_req_opcode : 3'h0)
    | (muxState_1 ? s2_req_opcode : 3'h0);
  ...
  assign io_d_bits_source =
    (muxState_0 ? _pipe_io_out_bits_req_sourceId : 13'h0)
    | (muxState_1 ? s2_req_sourceId : 13'h0);

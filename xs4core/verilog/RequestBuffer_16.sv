...
module RequestBuffer_16(
  ...
  output [12:0] io_out_bits_source,
  ...
  wire [12:0]  _output_pipe_q_io_deq_bits_source;
  wire [11:0]  _output_pipe_q_io_deq_bits_set;
  wire [15:0]  _output_pipe_q_io_deq_bits_tag;
  ...
  wire [12:0]  _issue_arb_io_out_bits_source;
  wire [11:0]  _issue_arb_io_out_bits_set;
  wire [15:0]  _issue_arb_io_out_bits_tag;
  ...
  wire [107:0] _buffer_ext_R0_data;
  wire [107:0] _buffer_ext_R1_data;
  wire [107:0] _buffer_ext_R2_data;
  wire [107:0] _buffer_ext_R3_data;
  reg          valids_0;
  reg          valids_1;
  reg          valids_2;
  reg          valids_3;
  ...
  wire [27:0]  _dup_mask_T_10 = {io_in_bits_tag, io_in_bits_set};
  wire         req_deps_0 = valids_0 & _buffer_ext_R3_data[33:25] == io_in_bits_set[8:0];
  wire         req_deps_1 = valids_1 & _buffer_ext_R2_data[33:25] == io_in_bits_set[8:0];
  wire         req_deps_2 = valids_2 & _buffer_ext_R1_data[33:25] == io_in_bits_set[8:0];
  wire         req_deps_3 = valids_3 & _buffer_ext_R0_data[33:25] == io_in_bits_set[8:0];
  ...
  wire         alloc =
    ...
    & ~(io_in_valid & io_in_bits_isPrefetch
        & (|{valids_0 & _buffer_ext_R3_data[52:25] == _dup_mask_T_10,
             valids_1 & _buffer_ext_R2_data[52:25] == _dup_mask_T_10,
             valids_2 & _buffer_ext_R1_data[52:25] == _dup_mask_T_10,
             valids_3 & _buffer_ext_R0_data[52:25] == _dup_mask_T_10}));
  ...
  FastArbiter_95 issue_arb (
    ...
    .io_in_0_bits_source           (_buffer_ext_R3_data[24:12]),
    .io_in_0_bits_set              (_buffer_ext_R3_data[36:25]),
    .io_in_0_bits_tag              (_buffer_ext_R3_data[52:37]),
    .io_in_0_bits_off              (_buffer_ext_R3_data[58:53]),
    .io_in_0_bits_mask             (_buffer_ext_R3_data[90:59]),
    .io_in_0_bits_bufIdx           (_buffer_ext_R3_data[94:91]),
    .io_in_0_bits_needHint         (_buffer_ext_R3_data[95]),
    .io_in_0_bits_isPrefetch       (_buffer_ext_R3_data[96]),
    .io_in_0_bits_isBop            (_buffer_ext_R3_data[97]),
    .io_in_0_bits_preferCache      (_buffer_ext_R3_data[98]),
    .io_in_0_bits_dirty            (_buffer_ext_R3_data[99]),
    .io_in_0_bits_isHit            (_buffer_ext_R3_data[100]),
    .io_in_0_bits_fromProbeHelper  (_buffer_ext_R3_data[101]),
    .io_in_0_bits_fromCmoHelper    (_buffer_ext_R3_data[102]),
    .io_in_0_bits_needProbeAckData (_buffer_ext_R3_data[103]),
    .io_in_0_bits_reqSource        (_buffer_ext_R3_data[107:104]),
    ...
    .io_in_1_bits_source           (_buffer_ext_R2_data[24:12]),
    .io_in_1_bits_set              (_buffer_ext_R2_data[36:25]),
    .io_in_1_bits_tag              (_buffer_ext_R2_data[52:37]),
    .io_in_1_bits_off              (_buffer_ext_R2_data[58:53]),
    .io_in_1_bits_mask             (_buffer_ext_R2_data[90:59]),
    .io_in_1_bits_bufIdx           (_buffer_ext_R2_data[94:91]),
    .io_in_1_bits_needHint         (_buffer_ext_R2_data[95]),
    .io_in_1_bits_isPrefetch       (_buffer_ext_R2_data[96]),
    .io_in_1_bits_isBop            (_buffer_ext_R2_data[97]),
    .io_in_1_bits_preferCache      (_buffer_ext_R2_data[98]),
    .io_in_1_bits_dirty            (_buffer_ext_R2_data[99]),
    .io_in_1_bits_isHit            (_buffer_ext_R2_data[100]),
    .io_in_1_bits_fromProbeHelper  (_buffer_ext_R2_data[101]),
    .io_in_1_bits_fromCmoHelper    (_buffer_ext_R2_data[102]),
    .io_in_1_bits_needProbeAckData (_buffer_ext_R2_data[103]),
    .io_in_1_bits_reqSource        (_buffer_ext_R2_data[107:104]),
    ...
    .io_in_2_bits_source           (_buffer_ext_R1_data[24:12]),
    .io_in_2_bits_set              (_buffer_ext_R1_data[36:25]),
    .io_in_2_bits_tag              (_buffer_ext_R1_data[52:37]),
    .io_in_2_bits_off              (_buffer_ext_R1_data[58:53]),
    .io_in_2_bits_mask             (_buffer_ext_R1_data[90:59]),
    .io_in_2_bits_bufIdx           (_buffer_ext_R1_data[94:91]),
    .io_in_2_bits_needHint         (_buffer_ext_R1_data[95]),
    .io_in_2_bits_isPrefetch       (_buffer_ext_R1_data[96]),
    .io_in_2_bits_isBop            (_buffer_ext_R1_data[97]),
    .io_in_2_bits_preferCache      (_buffer_ext_R1_data[98]),
    .io_in_2_bits_dirty            (_buffer_ext_R1_data[99]),
    .io_in_2_bits_isHit            (_buffer_ext_R1_data[100]),
    .io_in_2_bits_fromProbeHelper  (_buffer_ext_R1_data[101]),
    .io_in_2_bits_fromCmoHelper    (_buffer_ext_R1_data[102]),
    .io_in_2_bits_needProbeAckData (_buffer_ext_R1_data[103]),
    .io_in_2_bits_reqSource        (_buffer_ext_R1_data[107:104]),
    ...
    .io_in_3_bits_source           (_buffer_ext_R0_data[24:12]),
    .io_in_3_bits_set              (_buffer_ext_R0_data[36:25]),
    .io_in_3_bits_tag              (_buffer_ext_R0_data[52:37]),
    .io_in_3_bits_off              (_buffer_ext_R0_data[58:53]),
    .io_in_3_bits_mask             (_buffer_ext_R0_data[90:59]),
    .io_in_3_bits_bufIdx           (_buffer_ext_R0_data[94:91]),
    .io_in_3_bits_needHint         (_buffer_ext_R0_data[95]),
    .io_in_3_bits_isPrefetch       (_buffer_ext_R0_data[96]),
    .io_in_3_bits_isBop            (_buffer_ext_R0_data[97]),
    .io_in_3_bits_preferCache      (_buffer_ext_R0_data[98]),
    .io_in_3_bits_dirty            (_buffer_ext_R0_data[99]),
    .io_in_3_bits_isHit            (_buffer_ext_R0_data[100]),
    .io_in_3_bits_fromProbeHelper  (_buffer_ext_R0_data[101]),
    .io_in_3_bits_fromCmoHelper    (_buffer_ext_R0_data[102]),
    .io_in_3_bits_needProbeAckData (_buffer_ext_R0_data[103]),
    .io_in_3_bits_reqSource        (_buffer_ext_R0_data[107:104]),

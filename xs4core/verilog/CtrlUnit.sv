...
module CtrlUnit(
  ...
  reg  [63:0]  core_reset_1;
  reg  [63:0]  core_reset_2;
  reg  [63:0]  core_reset_3;
  reg          cmd_in_valid;
  reg          cmd_out_valid;
  wire         in_bits_read = auto_ctl_in_a_bits_opcode == 3'h4;
  wire [5:0]   _GEN =
  ...
  wire         _out_out_bits_data_T_20 = out_oindex == 7'h0;
  wire         io_ecc_ready_0 = ecc_code == 64'h0;
  wire         out_f_wivalid_21 =
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (out_f_wivalid_21 & ~cmd_in_valid)
      ...
      if (_out_wofireMux_T_2 & _GEN_1 == 7'h41 & ~(|_GEN_0) & (&out_backMask))
        core_reset_1 <= {63'h0, _out_back_q_io_deq_bits_data[0]};
      if (_out_wofireMux_T_2 & _GEN_1 == 7'h42 & ~(|_GEN_0) & (&out_backMask))
        core_reset_2 <= {63'h0, _out_back_q_io_deq_bits_data[0]};
      if (_out_wofireMux_T_2 & _GEN_1 == 7'h43 & ~(|_GEN_0) & (&out_backMask))
        core_reset_3 <= {63'h0, _out_back_q_io_deq_bits_data[0]};
      cmd_in_valid <= out_f_wivalid_21 | ~io_req_ready & cmd_in_valid;
      cmd_out_valid <=
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        core_reset_1 = {_RANDOM[6'h20], _RANDOM[6'h21]};
        core_reset_2 = {_RANDOM[6'h22], _RANDOM[6'h23]};
        core_reset_3 = {_RANDOM[6'h24], _RANDOM[6'h25]};
        cmd_in_valid = _RANDOM[6'h26][0];
        cmd_out_valid = _RANDOM[6'h26][1];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        ctl_tag = 64'h0;
        ctl_set = 64'h0;
  ...
  assign auto_ctl_in_d_bits_opcode = {2'h0, _out_back_q_io_deq_bits_read};
  assign auto_ctl_in_d_bits_data =
    (_out_out_bits_data_T_20 | out_oindex == 7'h10 | out_oindex == 7'h11
     ...
     | out_oindex == 7'h20 | out_oindex == 7'h40 | out_oindex == 7'h41
     | out_oindex == 7'h42 | out_oindex == 7'h43) & (|_GEN_0)
      ? 64'h0
      : _out_out_bits_data_T_20
          ? 64'hA0C1004
          : out_oindex == 7'h10
              ? ctl_tag
              : out_oindex == 7'h11

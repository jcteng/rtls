...
module LatchFastArbiter_1(
  ...
  input  [3:0]  io_in_0_bits_clients,
  ...
  input  [3:0]  io_in_1_bits_clients,
  ...
  input  [3:0]  io_in_2_bits_clients,
  ...
  input  [3:0]  io_in_3_bits_clients,
  ...
  input  [3:0]  io_in_4_bits_clients,
  ...
  input  [3:0]  io_in_5_bits_clients,
  ...
  input  [3:0]  io_in_6_bits_clients,
  ...
  input  [3:0]  io_in_7_bits_clients,
  ...
  input  [3:0]  io_in_8_bits_clients,
  ...
  input  [3:0]  io_in_9_bits_clients,
  ...
  input  [3:0]  io_in_10_bits_clients,
  ...
  input  [3:0]  io_in_11_bits_clients,
  ...
  input  [3:0]  io_in_12_bits_clients,
  ...
  input  [3:0]  io_in_13_bits_clients,
  ...
  output [3:0]  io_out_bits_clients,
    ...
    if (reset) begin
      ...
      if (latch_result) begin
        ...
        out_bits_reg_clients <=
          (chosenOH[0] ? io_in_0_bits_clients : 4'h0)
          | (chosenOH[1] ? io_in_1_bits_clients : 4'h0)
          | (chosenOH[2] ? io_in_2_bits_clients : 4'h0)
          | (chosenOH[3] ? io_in_3_bits_clients : 4'h0)
          | (chosenOH[4] ? io_in_4_bits_clients : 4'h0)
          | (chosenOH[5] ? io_in_5_bits_clients : 4'h0)
          | (chosenOH[6] ? io_in_6_bits_clients : 4'h0)
          | (chosenOH[7] ? io_in_7_bits_clients : 4'h0)
          | (chosenOH[8] ? io_in_8_bits_clients : 4'h0)
          | (chosenOH[9] ? io_in_9_bits_clients : 4'h0)
          | (chosenOH[10] ? io_in_10_bits_clients : 4'h0)
          | (chosenOH[11] ? io_in_11_bits_clients : 4'h0)
          | (chosenOH[12] ? io_in_12_bits_clients : 4'h0)
          | (chosenOH[13] ? io_in_13_bits_clients : 4'h0);
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        out_bits_reg_tag = _RANDOM[2'h0][28:13];
        out_bits_reg_param = _RANDOM[2'h0][31:29];
        out_bits_reg_clients = _RANDOM[2'h1][3:0];
        out_bits_reg_needData = _RANDOM[2'h1][4];
        chosen_reg = _RANDOM[2'h1][18:5];
        pendingMask = {_RANDOM[2'h1][31:19], _RANDOM[2'h2][0]};
        rrGrantMask = _RANDOM[2'h2][14:1];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        out_valid_reg = 1'h0;
        out_bits_reg_set = 12'h0;

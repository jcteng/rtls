...
module ProbeHelper(
  ...
  input  [12:0] io_dirResult_bits_sourceId,
  ...
  output [12:0] io_probe_bits_source,
  ...
  Queue5_MSHRRequest queue (
    ...
    .io_enq_bits_set              (io_dirResult_bits_set),
    .io_enq_bits_tag              (io_dirResult_bits_clients_tag),

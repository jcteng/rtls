...
module RASStack(
  ...
  wire [2:0]        _GEN_24 = _GEN_5[nsp];
  wire [2:0]        _commit_stack_ctr_T = 3'(_GEN_24 - 3'h1);
  ...
  wire              _GEN_56 =
    _GEN_24 != 3'h7 & _GEN_3[nsp] == _GEN_0[io_commit_meta_TOSW_value];
  ...
  wire [5:0]        _GEN_73 = {io_redirect_meta_TOSW_flag, io_redirect_meta_TOSW_value};
  wire              _GEN_74 =
    io_redirect_valid & io_redirect_isCall & 6'(_GEN_73 + 6'h1) == {BOS_flag, BOS_value};
  wire [2:0]        _commit_stack_ctr_T_2 = 3'(_GEN_24 + 3'h1);
  wire [5:0]        _GEN_75 = 6'(_GEN_73 + 6'h1);
  ...
  wire [5:0]        _GEN_77 = 6'(_GEN_22 + 6'h1);
  wire              _GEN_78 = _s3_missPushEntry_ctr_T & io_s3_meta_sctr != 3'h7;
  wire              inflightValid_4 =
    _GEN_16 & (topNos_flag ^ TOSW_flag ^ topNos_value < TOSW_value);
  wire [5:0]        _GEN_79 = 6'(_GEN_19 + 6'h1);
  wire [5:0]        _BOS_new_ptr_T_11 = 6'(_GEN_20 + 6'h1);
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (io_redirect_valid) begin
        ...
        TOSW_flag <= io_redirect_isCall ? _GEN_75[5] : io_redirect_meta_TOSW_flag;
        TOSW_value <= io_redirect_isCall ? _GEN_75[4:0] : io_redirect_meta_TOSW_value;
      end
      else if (io_s3_cancel) begin
        ssp <=
          ~io_s3_missed_push | _GEN_78
        ...
        TOSW_flag <= io_s3_missed_push ? _GEN_77[5] : io_s3_meta_TOSW_flag;
        TOSW_value <= io_s3_missed_push ? _GEN_77[4:0] : io_s3_meta_TOSW_value;
      end
      else begin

...
module Directory_16(
  ...
  input  [12:0] io_read_bits_source,
  ...
  output [1:0]  io_result_bits_self_clientStates_2,
  output [1:0]  io_result_bits_self_clientStates_3,
  ...
  output [1:0]  io_result_bits_clients_states_2_state,
  output        io_result_bits_clients_states_2_hit,
  output [1:0]  io_result_bits_clients_states_3_state,
  output        io_result_bits_clients_states_3_hit,
  output        io_result_bits_clients_tag_match,
  output [15:0] io_result_bits_clients_tag,
  output [3:0]  io_result_bits_clients_way,
  output        io_result_bits_clients_error,
  output [12:0] io_result_bits_sourceId,
  ...
  input  [1:0]  io_dirWReq_bits_data_clientStates_2,
  input  [1:0]  io_dirWReq_bits_data_clientStates_3,
  ...
  input  [11:0] io_clientDirWReq_bits_set,
  ...
  input  [1:0]  io_clientDirWReq_bits_data_2_state,
  input  [1:0]  io_clientDirWReq_bits_data_3_state,
  output        io_clientTagWreq_ready,
  input         io_clientTagWreq_valid,
  input  [11:0] io_clientTagWreq_bits_set,
  input  [3:0]  io_clientTagWreq_bits_way,
  input  [15:0] io_clientTagWreq_bits_tag
);

  wire        io_result_bits_clients_states_3_hit_0;
  wire        io_result_bits_clients_states_2_hit_0;
  wire        io_result_bits_clients_states_1_hit_0;
  ...
  wire [1:0]  _clientDir_io_resp_bits_dir_1_state;
  wire [1:0]  _clientDir_io_resp_bits_dir_2_state;
  wire [1:0]  _clientDir_io_resp_bits_dir_3_state;
  ...
  reg         reqValidReg;
  reg  [15:0] reqIdOHReg;
  reg  [12:0] sourceIdReg_r;
  reg  [12:0] sourceIdReg;
  reg  [11:0] setReg_r;
  reg  [11:0] setReg;
  ...
  assign io_result_bits_clients_states_1_hit_0 =
    _clientDir_io_resp_bits_hit & (|_clientDir_io_resp_bits_dir_1_state);
  assign io_result_bits_clients_states_2_hit_0 =
    _clientDir_io_resp_bits_hit & (|_clientDir_io_resp_bits_dir_2_state);
  assign io_result_bits_clients_states_3_hit_0 =
    _clientDir_io_resp_bits_hit & (|_clientDir_io_resp_bits_dir_3_state);
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        sourceIdReg_r = _RANDOM[3'h2][30:18];
        sourceIdReg = {_RANDOM[3'h2][31], _RANDOM[3'h3][11:0]};
        setReg_r = _RANDOM[3'h3][23:12];
        setReg = {_RANDOM[3'h3][31:24], _RANDOM[3'h4][3:0]};
        replacerInfoReg_r_channel = _RANDOM[3'h4][6:4];
        replacerInfoReg_r_opcode = _RANDOM[3'h4][9:7];
        replacerInfoReg_channel = _RANDOM[3'h4][16:14];
        replacerInfoReg_opcode = _RANDOM[3'h4][19:17];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        readyMask = 1'h0;
        reqValidReg = 1'h0;
  ...
  SubDirectory clientDir (
    ...
    .io_resp_bits_dir_1_state  (_clientDir_io_resp_bits_dir_1_state),
    .io_resp_bits_dir_2_state  (_clientDir_io_resp_bits_dir_2_state),
    .io_resp_bits_dir_3_state  (_clientDir_io_resp_bits_dir_3_state),
    ...
    .io_dir_w_bits_dir_1_state (io_clientDirWReq_bits_data_1_state),
    .io_dir_w_bits_dir_2_state (io_clientDirWReq_bits_data_2_state),
    .io_dir_w_bits_dir_3_state (io_clientDirWReq_bits_data_3_state)
  );
  Directory_Anon selfDir (
    ...
    .io_resp_bits_dir_clientStates_1   (io_result_bits_self_clientStates_1),
    .io_resp_bits_dir_clientStates_2   (io_result_bits_self_clientStates_2),
    .io_resp_bits_dir_clientStates_3   (io_result_bits_self_clientStates_3),
    ...
    .io_dir_w_bits_dir_clientStates_1  (io_dirWReq_bits_data_clientStates_1),
    .io_dir_w_bits_dir_clientStates_2  (io_dirWReq_bits_data_clientStates_2),
    .io_dir_w_bits_dir_clientStates_3  (io_dirWReq_bits_data_clientStates_3),
  ...
  assign io_result_bits_clients_states_1_state = _clientDir_io_resp_bits_dir_1_state;
  assign io_result_bits_clients_states_1_hit = io_result_bits_clients_states_1_hit_0;
  assign io_result_bits_clients_states_2_state = _clientDir_io_resp_bits_dir_2_state;
  assign io_result_bits_clients_states_2_hit = io_result_bits_clients_states_2_hit_0;
  assign io_result_bits_clients_states_3_state = _clientDir_io_resp_bits_dir_3_state;
  assign io_result_bits_clients_states_3_hit = io_result_bits_clients_states_3_hit_0;
  assign io_result_bits_clients_tag_match = _clientDir_io_resp_bits_hit;
  assign io_result_bits_clients_error =
    (|{io_result_bits_clients_states_0_hit_0,
       io_result_bits_clients_states_1_hit_0,
       io_result_bits_clients_states_2_hit_0,
       io_result_bits_clients_states_3_hit_0}) & _clientDir_io_resp_bits_error;

  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        out_bits_reg_tag = _RANDOM[2'h0][19:4];
        out_bits_reg_set = _RANDOM[2'h0][31:20];
        out_bits_reg_param = _RANDOM[2'h1][2:0];
        out_bits_reg_source = _RANDOM[2'h1][6:3];
        out_bits_reg_way = _RANDOM[2'h1][10:7];
        chosen_reg = _RANDOM[2'h1][25:12];
        pendingMask = {_RANDOM[2'h1][31:26], _RANDOM[2'h2][7:0]};
        rrGrantMask = _RANDOM[2'h2][21:8];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        out_valid_reg = 1'h0;
        out_bits_reg_opcode = 3'h0;

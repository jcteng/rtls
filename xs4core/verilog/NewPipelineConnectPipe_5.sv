...
module NewPipelineConnectPipe_5(
  ...
  input  [40:0] io_in_bits_predictInfo_target,
  ...
  output [40:0] io_out_bits_predictInfo_target,
  ...
  reg [40:0] data_predictInfo_target;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_pc = {_RANDOM[4'h7][31:27], _RANDOM[4'h8], _RANDOM[4'h9][3:0]};
        data_preDecode_valid = _RANDOM[4'h9][4];
        data_preDecode_isRVC = _RANDOM[4'h9][5];
        data_preDecode_brType = _RANDOM[4'h9][7:6];
        data_preDecode_isCall = _RANDOM[4'h9][8];
        data_preDecode_isRet = _RANDOM[4'h9][9];
        data_ftqIdx_flag = _RANDOM[4'h9][10];
        data_ftqIdx_value = _RANDOM[4'h9][16:11];
        data_ftqOffset = _RANDOM[4'h9][20:17];
        data_predictInfo_target = {_RANDOM[4'h9][31:21], _RANDOM[4'hA][29:0]};
        data_predictInfo_taken = _RANDOM[4'hA][30];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        valid = 1'h0;
    end // initial

...
module TLXbar_7(
  ...
  wire [13:0] _GEN = auto_in_0_a_bits_address[29:16] ^ 14'h3801;
  wire        requestAIO_0_0 =
    {auto_in_0_a_bits_address[35:30], _GEN[13:10], _GEN[0]} == 11'h0;
  wire        requestAIO_0_1 =
    ...
    | {auto_in_0_a_bits_address[35:30],
       auto_in_0_a_bits_address[29:26] ^ 4'hE,
       auto_in_0_a_bits_address[16]} == 11'h0
  ...
  wire [13:0] _GEN_0 = auto_in_1_a_bits_address[29:16] ^ 14'h3801;
  wire        requestAIO_1_0 =
    {auto_in_1_a_bits_address[35:30], _GEN_0[13:10], _GEN_0[0]} == 11'h0;
  wire        requestAIO_1_1 =
    ...
    | {auto_in_1_a_bits_address[35:30],
       auto_in_1_a_bits_address[29:26] ^ 4'hE,
       auto_in_1_a_bits_address[16]} == 11'h0
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (latch_2)
        beatsLeft_2 <=
          winner_2_1 & auto_out_1_d_bits_opcode[0] ? ~(_beatsDO_decode_T_3[5:3]) : 3'h0;
      else
        beatsLeft_2 <= 3'(beatsLeft_2 - {2'h0, auto_in_0_d_ready & in_0_d_valid});
      ...
      if (latch_3)
        beatsLeft_3 <=
          winner_3_1 & auto_out_1_d_bits_opcode[0] ? ~(_beatsDO_decode_T_3[5:3]) : 3'h0;
      else
        beatsLeft_3 <= 3'(beatsLeft_3 - {2'h0, auto_in_1_d_ready & in_1_d_valid});
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        beatsLeft_1 = _RANDOM[/*Zero width*/ 1'b0][9:7];
        readys_mask_1 = _RANDOM[/*Zero width*/ 1'b0][11:10];
        state_1_0 = _RANDOM[/*Zero width*/ 1'b0][12];
        state_1_1 = _RANDOM[/*Zero width*/ 1'b0][13];
        beatsLeft_2 = _RANDOM[/*Zero width*/ 1'b0][16:14];
        readys_mask_2 = _RANDOM[/*Zero width*/ 1'b0][18:17];
        state_2_0 = _RANDOM[/*Zero width*/ 1'b0][19];
        state_2_1 = _RANDOM[/*Zero width*/ 1'b0][20];
        beatsLeft_3 = _RANDOM[/*Zero width*/ 1'b0][23:21];
        readys_mask_3 = _RANDOM[/*Zero width*/ 1'b0][25:24];
        state_3_0 = _RANDOM[/*Zero width*/ 1'b0][26];
        state_3_1 = _RANDOM[/*Zero width*/ 1'b0][27];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        beatsLeft = 3'h0;
        readys_mask = 2'h3;
  ...
  assign auto_in_1_d_bits_size =
    (muxState_3_0 ? out_0_d_bits_size : 3'h0)
  ...
  assign auto_in_0_d_bits_size =
    (muxState_2_0 ? out_0_d_bits_size : 3'h0)

...
module TLWidthWidget(
  ...
  reg  [1:0]       repeat_sel_sel_sources_17;
  reg  [1:0]       repeat_sel_sel_sources_18;
  reg  [1:0]       repeat_sel_sel_sources_19;
  reg  [1:0]       repeat_sel_sel_sources_20;
  reg  [1:0]       repeat_sel_sel_sources_24;
  reg  [1:0]       repeat_sel_sel_sources_25;
  reg  [1:0]       repeat_sel_sel_sources_26;
  reg  [1:0]       repeat_sel_sel_sources_27;
  reg  [1:0]       repeat_sel_sel_sources_28;
  ...
  always @(posedge clock) begin
    ...
    if (_repeat_sel_sel_T & auto_in_a_bits_source == 5'h11)
      repeat_sel_sel_sources_17 <= auto_in_a_bits_address[4:3];
    if (_repeat_sel_sel_T & auto_in_a_bits_source == 5'h12)
      repeat_sel_sel_sources_18 <= auto_in_a_bits_address[4:3];
    if (_repeat_sel_sel_T & auto_in_a_bits_source == 5'h13)
      repeat_sel_sel_sources_19 <= auto_in_a_bits_address[4:3];
    if (_repeat_sel_sel_T & auto_in_a_bits_source == 5'h14)
      repeat_sel_sel_sources_20 <= auto_in_a_bits_address[4:3];
    if (_repeat_sel_sel_T & auto_in_a_bits_source == 5'h18)
      repeat_sel_sel_sources_24 <= auto_in_a_bits_address[4:3];
    if (_repeat_sel_sel_T & auto_in_a_bits_source == 5'h19)
      repeat_sel_sel_sources_25 <= auto_in_a_bits_address[4:3];
    if (_repeat_sel_sel_T & auto_in_a_bits_source == 5'h1A)
      repeat_sel_sel_sources_26 <= auto_in_a_bits_address[4:3];
    if (_repeat_sel_sel_T & auto_in_a_bits_source == 5'h1B)
      repeat_sel_sel_sources_27 <= auto_in_a_bits_address[4:3];
    if (_repeat_sel_sel_T & auto_in_a_bits_source == 5'h1C)
      repeat_sel_sel_sources_28 <= auto_in_a_bits_address[4:3];
    if (repeat_first)
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        repeat_sel_sel_sources_17 = _RANDOM[4'h8][2:1];
        repeat_sel_sel_sources_18 = _RANDOM[4'h8][4:3];
        repeat_sel_sel_sources_19 = _RANDOM[4'h8][6:5];
        repeat_sel_sel_sources_20 = _RANDOM[4'h8][8:7];
        repeat_sel_sel_sources_24 = _RANDOM[4'h8][16:15];
        repeat_sel_sel_sources_25 = _RANDOM[4'h8][18:17];
        repeat_sel_sel_sources_26 = _RANDOM[4'h8][20:19];
        repeat_sel_sel_sources_27 = _RANDOM[4'h8][22:21];
        repeat_sel_sel_sources_28 = _RANDOM[4'h8][24:23];
        repeat_sel_hold_r = _RANDOM[4'h8][26:25];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        count = 2'h0;
        corrupt_reg = 1'h0;

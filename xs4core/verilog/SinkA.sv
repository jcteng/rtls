...
module SinkA(
  ...
  assign io_task_bits_tag =
    io_a_valid ? io_a_bits_address[35:17] : io_prefetchReq_bits_tag[20:2];
  ...
  assign io_task_bits_vaddr =
    io_a_valid ? io_a_bits_user_vaddr[32:0] : io_prefetchReq_bits_vaddr;
  assign io_task_bits_isKeyword = io_a_valid & io_a_bits_echo_isKeyword;
  assign io_task_bits_opcode = io_a_valid ? io_a_bits_opcode : 3'h5;

  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        out_bits_reg_way = _RANDOM[2'h1][16:13];
        out_bits_reg_bufIdx = _RANDOM[2'h1][26:23];
        out_bits_reg_opcode = _RANDOM[2'h1][29:27];
        out_bits_reg_param = {_RANDOM[2'h1][31:30], _RANDOM[2'h2][0]};
        out_bits_reg_source = _RANDOM[2'h2][4:1];
        out_bits_reg_save = _RANDOM[2'h2][5];
        out_bits_reg_drop = _RANDOM[2'h2][6];
        out_bits_reg_release = _RANDOM[2'h2][7];
        chosen_reg = _RANDOM[2'h2][22:9];
        pendingMask = {_RANDOM[2'h2][31:23], _RANDOM[2'h3][4:0]};
        rrGrantMask = _RANDOM[2'h3][18:5];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        out_valid_reg = 1'h0;
        out_bits_reg_set = 12'h0;

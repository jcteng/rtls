  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        entryReg_imm = {_RANDOM[6'h3][31:12], _RANDOM[6'h4][11:0]};
        entryReg_payload_preDecodeInfo_isRVC = _RANDOM[6'h8][9];
        entryReg_payload_ftqPtr_flag = _RANDOM[6'h8][16];
        entryReg_payload_ftqPtr_value = _RANDOM[6'h8][22:17];
        entryReg_payload_ftqOffset = _RANDOM[6'h8][26:23];
        entryReg_payload_fuOpType = {_RANDOM[6'hA][31:24], _RANDOM[6'hB][0]};
        entryReg_payload_rfWen = _RANDOM[6'hB][1];
        entryReg_payload_fpWen = _RANDOM[6'hB][2];
        entryReg_payload_pdest = _RANDOM[6'h16][20:13];
        entryReg_payload_storeSetHit = _RANDOM[6'h29][18];
        entryReg_payload_waitForRobIdx_flag = _RANDOM[6'h29][19];
        entryReg_payload_waitForRobIdx_value = _RANDOM[6'h29][27:20];
        entryReg_payload_loadWaitBit = _RANDOM[6'h29][28];
        entryReg_payload_loadWaitStrict = _RANDOM[6'h29][29];
        entryReg_payload_lqIdx_flag = _RANDOM[6'h2A][3];
        entryReg_payload_lqIdx_value = _RANDOM[6'h2A][10:4];
        entryReg_payload_sqIdx_flag = _RANDOM[6'h2A][11];
        entryReg_payload_sqIdx_value = _RANDOM[6'h2A][17:12];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        validReg_last_REG = 1'h0;
    end // initial

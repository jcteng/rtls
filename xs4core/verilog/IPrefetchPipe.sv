  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_req_vaddr_0 = {_RANDOM[4'h0][31:1], _RANDOM[4'h1][9:0]};
        s1_req_vaddr_1 = {_RANDOM[4'h1][31:10], _RANDOM[4'h2][18:0]};
        s1_doubleline = _RANDOM[4'h2][19];
        s1_req_ftqIdx_flag = _RANDOM[4'h2][20];
        s1_req_ftqIdx_value = _RANDOM[4'h2][26:21];
        state = _RANDOM[4'h2][29:27];
        s0_fire_r = _RANDOM[4'h2][30];
        s1_wait_itlb_0 = _RANDOM[4'h2][31];
        s1_wait_itlb_1 = _RANDOM[4'h3][0];
        REG = _RANDOM[4'h3][1];
        REG_1 = _RANDOM[4'h3][2];
        s1_need_itlb_REG = _RANDOM[4'h3][3];
        s1_need_itlb_REG_1 = _RANDOM[4'h3][4];
        tlb_valid_pulse_REG = _RANDOM[4'h3][5];
        tlb_valid_pulse_REG_1 = _RANDOM[4'h3][6];
        tlb_valid_latch_valid = _RANDOM[4'h3][7];
        tlb_valid_latch_valid_1 = _RANDOM[4'h3][8];
        s1_req_paddr_reg_r = {_RANDOM[4'h3][31:9], _RANDOM[4'h4][12:0]};
        s1_req_paddr_reg_r_1 = {_RANDOM[4'h4][31:13], _RANDOM[4'h5][16:0]};
        s1_req_gpaddr_tmp_r = {_RANDOM[4'h5][31:17], _RANDOM[4'h6][25:0]};
        s1_req_gpaddr_tmp_r_1 = {_RANDOM[4'h6][31:26], _RANDOM[4'h7], _RANDOM[4'h8][2:0]};
        s1_itlb_exception_r = _RANDOM[4'h8][4:3];
        s1_itlb_exception_r_1 = _RANDOM[4'h8][6:5];
        s1_SRAM_valid_REG = _RANDOM[4'h8][7];
        s1_waymasks_r_0 = _RANDOM[4'h8][11:8];
        s1_waymasks_r_1 = _RANDOM[4'h8][15:12];
        s2_valid = _RANDOM[4'h8][16];
        s2_req_vaddr_0 = {_RANDOM[4'h8][31:17], _RANDOM[4'h9][25:0]};
        s2_req_vaddr_1 = {_RANDOM[4'h9][31:26], _RANDOM[4'hA], _RANDOM[4'hB][2:0]};
        s2_doubleline = _RANDOM[4'hB][3];
        s2_req_paddr_0 = {_RANDOM[4'hB][31:4], _RANDOM[4'hC][7:0]};
        s2_req_paddr_1 = {_RANDOM[4'hC][31:8], _RANDOM[4'hD][11:0]};
        s2_exception_0 = _RANDOM[4'hD][13:12];
        s2_exception_1 = _RANDOM[4'hD][15:14];
        s2_mmio_0 = _RANDOM[4'hD][16];
        s2_mmio_1 = _RANDOM[4'hD][17];
        s2_waymasks_0 = _RANDOM[4'hD][21:18];
        s2_waymasks_1 = _RANDOM[4'hD][25:22];
        s2_MSHR_hits_valid = _RANDOM[4'hD][26];
        s2_MSHR_hits_valid_1 = _RANDOM[4'hD][27];
        has_send_0 = _RANDOM[4'hD][28];
        has_send_1 = _RANDOM[4'hD][29];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        s1_valid = 1'h0;
        s1_req_vaddr_0 = 41'h0;
